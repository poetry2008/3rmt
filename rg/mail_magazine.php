...
<div class="body_shadow" align="center"> 
  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border" summary="box"> 
    <tr> 
      ...
      <div class="pageHeading"><img align="top" src="images/menu_ico.gif" alt=""><h1 class="pageHeading"><?php echo HEADING_TITLE ; ?></h1></div>
      <div class="comment">
            	<table width="100%"  border="0" cellspacing="0" cellpadding="2" summary="table"> 
                      <tr> 
                        <td colspan="2" valign="top" class="formAreaTitle"><br><?php echo HEADING_MAGAZINE_TITLE_ACCOUNT; ?></td> 
                      </tr> 
                            <tr> 
                              <td>
                        ...
                        <tr> 
                          ...
                          <form method="post" action="<?php echo tep_href_link(FILENAME_MAGAZINE, 'action=regist', 'NONSSL'); ?>"> 
                         	 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="formArea" summary="table"> 
                                    ...
                                    <tr> 
                                      <td class="main" width="22%"><?php echo TEXT_MAGAZINE_TITLE_NAME_REG; ?></td> 
                        ...
                        <tr> 
                          ...
                          <form method="post" action="<?php echo tep_href_link(FILENAME_MAGAZINE, 'action=stop', 'NONSSL'); ?>"> 
                          	<table width="100%" border="0" cellpadding="2" cellspacing="2" class="formArea" summary="table"> 
                                    ...
                                    <tr> 
                                      <td class="main" width="22%"><?php echo TEXT_MAGAZINE_TITLE_MAIL_STP; ?></td> 
                                      <td class="main"><input type="text" name="email" value="<?php echo $mag_mail; ?>" class="input_text"></td> 
                                    </tr> 
                                 	<tr>
