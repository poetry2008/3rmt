...
?>
    <div class="pageHeading_long"><img align="top" alt="" src="images/menu_ico_a.gif"><h1><span><?php
  ...
  <?php
      if (isset($cPath_array)) {
        if ($seo_category['seo_description']) {
          echo '<div class="pageHeading_long"><img align="top" src="images/menu_ico_a.gif" alt=""><h2><span>'.$seo_category['seo_name'].'について</span></h2></div>'; 
