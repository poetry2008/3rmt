...
<div class="body_shadow" align="center"> 
  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
      ...
      <!-- body_text //--> 
      <td valign="top" id="contents"> <h1 class="pageHeading"><img align="top" src="images/menu_ico.gif" alt=""><?php echo HEADING_TITLE ; ?></h1> 
        ...
        <?php echo tep_draw_form('password_forgotten', tep_href_link('password_token.php', 'action=process&pud='.$_GET['pud'])); ?>
          ...
          <tr>
            <td class="main" style="width:100px;"><?php echo UPDATE_ENTRY_PASSWORD_TEXT;?></td>
