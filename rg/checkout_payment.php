...
<body><div class="body_shadow" align="center"> 
  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
      ...
      <!-- body_text //--> 
      <td valign="top" id="contents"><?php echo tep_draw_form('checkout_payment', tep_href_link(FILENAME_CHECKOUT_CONFIRMATION, '', 'SSL'), 'post', 'onsubmit="return check_form();"'); ?><div class="pageHeading"><img align="top" alt="" src="images/menu_ico.gif"><h1><span><?php echo HEADING_TITLE ; ?></span></h1></div> 
...
お手数ではございますが、商品をカートに追加していただくか、ポイン トでの返金になります。
      ...
      <tr>
        <td>
                    <table border="0" width="100%" cellspacing="0" cellpadding="2" class="infoBox" style="background-color:#fff;"> 
                        <?php
  $selection = $payment_modules->selection();
