...
define('GUEST_SUCCESS_INFO_COMMENT', '*メールが届かない場合は上記送信フォームより再度メールを送信してください<br><br>'.STORE_NAME.'をご利用いただくには、メール認証を行う必要があります。<br>メール内に記載してあるURLをクリックしメール認証を完了させてから'.STORE_NAME.'を利用することが出来ます。<br><br><br><b>正常に受信できる場合：</b>「送信」後5分以内で'.STORE_NAME.'からの確認メールが届きます。<br><b>受信できない場合：</b>「送信」後5分以上経過しても受信できない場合は、スパムフィルター等で受け取りを拒否されている可能性が高いです。<br><br><br>メール受信の設定に関しては、 「<a href="'.tep_href_link('email_trouble.php').'">メールが届かない場合は上記送信フォームより再度メールを送信してください</a>」 をご参考ください。');
