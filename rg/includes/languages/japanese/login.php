...
define('TEXT_LOGIN_IP_ERROR','<font color="#ff0000">一定の回数以上ログインに失敗されますと、セキュリティ上の配慮から、しばらくログインができなくなります。</font><br>お急ぎの場合は、<a href="/contact_us.php">サポートセンター</a>へご連絡ください。また、「<a href="/password_forgotten.php">パスワード再発行手続き</a>」ページよりお手続きいただくことでロックが自動的に解除されます。');
