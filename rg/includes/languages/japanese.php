...
define('ENTRY_STREET_ADDRESS_TEXT', '&nbsp;(例. 1-15-6) <font color="red">必須</font>');
...
define('ENTRY_POST_CODE_TEXT', '&nbsp;(例. 331-0814) <font color="red">必須</font>');
define('ENTRY_CITY', '市区町村:');
define('ENTRY_CITY_ERROR', '&nbsp;<small><font color="#FF0000">少なくても ' . ENTRY_CITY_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_CITY_TEXT', '&nbsp;(例. さいたま市) <font color="red">必須</font>');
...
define('ENTRY_TELEPHONE_NUMBER_TEXT', '&nbsp;(例. 012-345-6789) <font color="red">必須</font>');
...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;(例. abcd1234) <font color="#FC0000">必須</font></span>');
define('ENTRY_PASSWORD_ERROR', '<small><font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;(例. abcd1234) <font color="#FC0000">必須</font></span>');
