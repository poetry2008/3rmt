...
define('SENDMAIL_READ_TEXT', '会員登録をしていただく前に'.STORE_NAME.'からメールが正常に受信できるか、テストしていただきます。<br>会員登録は受信されましたメール内に記載してあるURLから行ってください。<br>正常に受信できる場合：「送信」後5分以内で'.STORE_NAME.'からの確認メールが届きます。<br>受信できない場合：「送信」後5分以上経過しても受信できない場合は、スパムフィルター等で受け取りを拒否されている可能性が高いです。');
