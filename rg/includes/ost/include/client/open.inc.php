...
<table cellpadding=2 cellspacing=1 width="100%" class="open_users">
    ...
    <tr>
        <th>件名</th>
        <td>
            <input class="input_text" type="text" name="subject" size="35" value="<?=isset($info['subject'])?$info['subject']:(isset($_GET['products'])?$_GET['products'].'について':(isset($_GET['pname'])?$_GET['pname'].'の確保期限について':''))?>">
