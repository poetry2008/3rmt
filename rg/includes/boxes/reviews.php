...
<?php
  if(basename($PHP_SELF) == FILENAME_PRODUCT_INFO){
    ...
    if(tep_db_num_rows($reviews_query)) {
      echo  '<div class="pageHeading_long"><img align="top" src="images/menu_ico.gif" alt=""><h3>'.$product_info['products_name'] .BOX_REVIEWS_LINK_TEXT.'</h3></div>'."\n" . '<div class="comment_long">'."\n" ;
...
// display random review box
    ...
    echo '<p class="reviews_top"><a href="' .
      ...
      tep_image(DIR_WS_IMAGES . 'products/' . $img_array[0], $random_product['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a><br>'. tep_image(DIR_WS_IMAGES . 'stars_' . $random_product['reviews_rating'] . '.gif' , sprintf(BOX_REVIEWS_TEXT_OF_5_STARS, $random_product['reviews_rating']), 88, 16) . "\n".'</p>
