...
<?php
  if(basename($PHP_SELF) == FILENAME_PRODUCT_INFO){
    ...
    if(tep_db_num_rows($reviews_query)) {
      echo  '<div class="pageHeading_long"><img align="top" src="images/menu_ico.gif" alt=""><h3><span>'.$product_info['products_name'] .'のレビュー</span></h3></div>'."\n" . '<div class="comment_long">'."\n" ;
...
<br>' . nl2br($reviews['reviews_text'],false) . "\n" . '</p></div>';
...
// display random review box
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="reviews_bottom"><tr><td><a href="' .  tep_href_link(FILENAME_PRODUCT_REVIEWS_INFO, 'products_id=' .  $random_product['products_id'] . '&reviews_id=' .  $random_product['reviews_id']) . '">' . tep_show_review_des($review) . ' ...</a></td></tr></table>'; } elseif (isset($_GET['products_id'])) {
