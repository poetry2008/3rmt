...
//  define('HTTP_SERVER', 'http://3xy.szn.200.com'); // eg, http://localhost - should not be empty for productive servers
  define('HTTP_SERVER', 'http://rg.hm1004.200.com'); // eg, http://localhost - should not be empty for productive servers
  define('HTTPS_SERVER', 'http://rg.hm1004.200.com'); // eg, https://localhost - should not be empty for productive servers
  ...
  define('DIR_FS_DOCUMENT_ROOT', '/home/hm1004/project/rmt/rg/');
