...
//  define('HTTP_SERVER', 'http://3xy.szn.200.com'); // eg, http://localhost - should not be empty for productive servers
  define('HTTP_SERVER', 'http://3rg.kthiz.200.com'); // eg, http://localhost - should not be empty for productive servers
  define('HTTPS_SERVER', 'https://https.200.com/3rg.kthiz.200.com'); // eg, https://localhost - should not be empty for productive servers
  ...
  define('DIR_FS_DOCUMENT_ROOT', '/home/kthiz/project/OSC_3RMT/rg/');
