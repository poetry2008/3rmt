                ...
                <td valign="top">
                    ...
                    <tr>
                      ...
                      <tr class="infoBoxContents">
                        <td class="main"><font color="#CC0000"><?php echo str_replace('${RATE}',tep_display_attention_1_3($product_info['products_exchange_rate']),$top_array[0]); ?></font></td>
                      ...
                      ?>
                      <tr class="infoBoxContents">
                        <td class="main"><font color="#CC0000"><?php echo str_replace('${RATE}',tep_display_attention_1_3($product_info['products_exchange_rate']),$under_array[0]); ?></font></td>
