  ...
  if ($customers_res) {
    ...
    if ($_GET['action'] == 'send') {
      if (empty($_POST['cemail'])) {
        ...
        $email_text = str_replace('${URL}', HTTP_SERVER.'/m_token.php?aid='.base64_encode(tep_get_random_ac_code(8).','.$customers_res['customers_id'].','.tep_get_random_ac_code(10)), ACTIVE_ACCOUNT_EMAIL_CONTENT);  
