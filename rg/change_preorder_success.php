  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
      ...
      <td valign="top" id="contents"> 
        <h1 class="pageHeading"><img align="top" alt="img" src="images/menu_ico.gif"><?php echo CPREORDER_SUCCESS_HEADING_TITLE ; ?></h1> 
        <div class="comment">
          ...
          <tr>
            <td align="right">
            <?php echo '<a href="' .tep_href_link(FILENAME_DEFAULT). '">' .  tep_image_button('button_continue02.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?>
            </td>
          </tr>
          <tr>
            <td>
