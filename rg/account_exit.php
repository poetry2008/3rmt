...
//$customers_firstname       = $customers_info_array['customers_firstname'];
...
<div class="comment">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" summary="table">
               ...
               <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%" summary="table">
                        <tr>
              <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="0" summary="table">

                <tr>
                  <td class="main"><table border="0" cellspacing="0" cellpadding="2" width="100%" summary="table">
<?php
if(isset($_GET['action']) && $_GET['action']=="quit_success" && isset($_GET['check_flag']) && $_GET['check_flag']!=""){
	  ?>
<tr>
