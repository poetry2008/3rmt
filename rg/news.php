  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border">
    <tr>
      ...
      <td valign="top" id="contents">
        <div class="pageHeading"><img align="top" alt="img" src="images/menu_ico.gif"><h1><?php if (isset($_GET['news_id']) && $_GET['news_id']) { echo replace_store_name($latest_news['headline']); } else { echo HEADING_TITLE; } ?></h1></div>
                <div class="comment">
