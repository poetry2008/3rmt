            ...
            <td>
                    <table border="0" width="100%" cellspacing="0" cellpadding="0" class="c_pay_info"> 
                      <tr> 
                        ...
                        <td align="right"><a href="javascript:void(0);" onClick="check_option_change();"><?php echo tep_image_button('button_continue_02.gif', IMAGE_BUTTON_CONTINUE); ?></a>
<?php
          //触发弹出层的条件
          $check_products_info = tep_check_less_product_option(); 
          if (!empty($check_products_info)) {
                ...
                <tr> 
                  <td>
                    ...
                    <tr>
                      ...
                      <td class="main" colspan="2"><input type="radio" name="billing_select" value="1"<?php echo isset($_POST['billing_select']) && $_POST['billing_select'] == 1 ? ' checked="checked"' : (isset($_SESSION['billing_select']) && $_SESSION['billing_select'] == 1 ? ' checked="checked"' : (!isset($_POST['billing_select']) && !isset($_SESSION['billing_select']) ? ' checked="checked"' : ''));?>><?php echo TEXT_BILLING_SELECT_TRUE;?><input type="radio" name="billing_select" value="0"<?php echo isset($_POST['billing_select']) && $_POST['billing_select'] == 0 ? ' checked="checked"' : (isset($_SESSION['billing_select']) && $_SESSION['billing_select'] == 0 ? ' checked="checked"' : '');?>><?php echo TEXT_BILLING_SELECT_FALSE;?></td>
                    </tr>
                    </table>
                  </td>
                </tr>
