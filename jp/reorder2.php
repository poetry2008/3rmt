      ...
      <td id="contents" valign="top">
        ...
        <?php if($_POST){
          ...
          if ($date && $hour && $minute && ($time < (time() - MINUTES * 60) or $time > (time() + (7*86400)))) {
            ...
            echo '<div class="comment">'.TEXT_CHANGE_ORDER_CONFIRM_EMAIL.' <div align="right"><a href="/"><img src="includes/languages/japanese/images/buttons/button_back_home.gif" alt="'.TEXT_TOP_CON.'"></a></div></div>';
...
<td><textarea name='comment' id='comment' rows="6" cols="40"><?php 
...
<input type='image' src="includes/languages/japanese/images/buttons/button_submit2.gif" alt="<?php echo TEXT_REORDER_INFO_CONFIRM;?>" >
