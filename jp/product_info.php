...
?>
                <tr>
                  ...
                  . 'products/'.  $product_info['products_image'].'\") href="javascript:void(0)" >' . tep_image3(DIR_WS_IMAGES . 'products/'. $product_info['products_image'], addslashes($product_info['products_name']), PRODUCT_INFO_IMAGE_WIDTH, PRODUCT_INFO_IMAGE_HEIGHT, 'name="lrgproduct" id="lrgproduct"') . '<br>' . TEXT_CLICK_TO_ENLARGE . '<\'+\'/a>'; ?>');
--> </script>
                    <noscript>
                    ...
                    <table align="right" width="100%" cellspacing="1" cellpadding="3" border="0">
                      ...
                      <td class="main" width="85"><?php echo TEXT_PRODUCTS_QTY;?></td>
                        ...
                        <a style="display:block;" href="javascript:void(0)" onclick="change_num('quantity','down',1,<?php echo $p_a_quan;?>);return false;"><img src="images/ndown.gif" style="vertical-align:top;"></a>
                              ...
                              <td class="main">
                              &nbsp;<?php echo TEXT_UNIT;?>&nbsp;<span id="quantity_error"><?php echo $quantity_error == true ? TEXT_PRODUCT_QUANTITY_ERROR : '';?></span>
                            </td>
                        </tr>
                        </table>
                      </tr>
...
?>
  ...
  <?php echo tep_draw_form('open',tep_href_link('open.php', '', 'SSL'),'get');?><input type="image" style="vertical-align:bottom;" src="<?php echo DIR_WS_IMAGES;?>design/button/botton_question.jpg"><?php echo tep_draw_hidden_field('products', $product_info['products_name']) ; ?></form>
   </div>   
  </td>
                </tr>
...
if(tep_db_num_rows($tag_query)){
?>
<h3 class="pageHeading_long"><?php echo $product_info['products_name'].TEXT_KEYWORD;?></h3>        
