...
?>
  ...
  <?php echo tep_draw_form('open',tep_href_link('open.php'),'get');?><?php echo tep_draw_hidden_field('products_name', $product_info['products_name']) ; ?><input type="image" style="vertical-align:bottom;" src="<?php echo DIR_WS_IMAGES;?>design/button/botton_question.jpg"></form>
     </td>
                </tr>
              </table></td>
          </tr>
