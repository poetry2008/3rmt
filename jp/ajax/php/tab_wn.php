...
<?php
    ...
    $info_box_contents[] = array('text' => '<a href="' . tep_href_link(FILENAME_PRODUCTS_NEW, '', 'NONSSL') . '" style="color:#FFFFFF;text-decoration: none;">'.BOX_HEADING_WHATS_NEW.'</a>');
	...
	<table border="0" cellspacing="4" cellpadding="0">
      ...
      <tr>
        <td colspan="2" align="right"><small><a href="'.tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']).'">詳しく見る<img src="images/design/right.gif" width="13" height="13" hspace="3" align="absmiddle" border="0"></a></small></td>
        </tr>
		</table>
	</div>';
?>
