...
<table border="0" width="100%" cellspacing="0" cellpadding="0" > 
  ...
  <tr>  
    <td align="center" class="checkoutBarCurrent">
      <?php echo CHECKOUT_BAR_PAYMENT; ?>
    </td> 
    <td align="center" class="checkoutBarTo">
...
<tr><td>
      <?php echo tep_draw_form('preorder_product', tep_href_link(FILENAME_PREORDER_PAYMENT, 'check=1'), 'post', '') .  tep_draw_hidden_field('products_id', $product_info['products_id']).tep_draw_hidden_field('products_name', $product_info['products_name']).tep_draw_hidden_field('action', 'process'); 
              $op_info_array = array(); 
...
<tr><td> 
    	  <table>
        	...
        	<tr>
                <td class="main">
                <b><?php echo PREORDER_EXPECT_CTITLE;?></b> 
                </td> 
                </tr>
        	<tr><td><img height="10" width="100%" alt="" src="images/pixel_trans.gif"></td></tr>
          </table>
      ...
      <table width="100%" cellpadding="2" cellspacing="0" border="0">
        <tr><td class="main"><?php echo tep_draw_textarea_field('yourmessage', 'soft', 60, 5, $_POST['yourmessage']);?></td></tr>
      </table>
      </td></tr>
      </table>
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
