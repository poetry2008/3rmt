...
// define the database table names used in the contribution
  define('TABLE_AFFILIATE', 'iimy_affiliate_affiliate');
  define('TABLE_AFFILIATE_NEWS', 'iimy_affiliate_news');

// if you change this -> affiliate_show_banner must be changed too
  define('TABLE_AFFILIATE_BANNERS', 'iimy_affiliate_banners');
  define('TABLE_AFFILIATE_BANNERS_HISTORY', 'iimy_affiliate_banners_history');
  define('TABLE_AFFILIATE_CLICKTHROUGHS', 'iimy_affiliate_clickthroughs');
  define('TABLE_AFFILIATE_SALES', 'iimy_affiliate_sales');
  define('TABLE_AFFILIATE_PAYMENT', 'iimy_affiliate_payment');
  define('TABLE_AFFILIATE_PAYMENT_STATUS', 'iimy_affiliate_payment_status');
  define('TABLE_AFFILIATE_PAYMENT_STATUS_HISTORY', 'iimy_affiliate_payment_status_history');

// define the filenames used in the project
  define('FILENAME_AFFILIATE', 'affiliate_affiliate.php'); 
  define('FILENAME_AFFILIATE_ACCOUNT', 'affiliate_details.php');
  define('FILENAME_AFFILIATE_API', 'affiliate_api.php');
  ...
  define('FILENAME_AFFILIATE_TEMPLATE','affiliate_template.php');
