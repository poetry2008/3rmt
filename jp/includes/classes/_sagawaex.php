 ...
 */
/*
    $rate = new _SagawaEx('sagawaex','ƒÃæÔ ÿ');
    $rate->SetOrigin('01', 'JP');   // ÀÃ≥§∆ª§´§È
    $rate->SetDest('13', 'JP');     // ≈Ïµ˛≈‘§ﬁ§«
...
class _SagawaEx {
    ...
    // 3    140•µ•§•∫ 140cm§ﬁ§« 20kg§ﬁ§«
    // 4    160•µ•§•∫ 160cm§ﬁ§« 30kg§ﬁ§«
    // 9    µ¨≥ ≥∞    
    ...
    function GetQuote() {
        // µ˜Œ• Ã§Œ≤¡≥ •È•Û•Ø: •È•Û•Ø•≥°º•… => ≤¡≥ (60,80,100,140,160)
        $a_pricerank = array(
        'N01'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(01) ∂·µ˜Œ•
        'N02'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(02)   ¢¨
        'N03'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(03)
        'N04'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(04)
        'N05'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(05)
        'N06'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(06)
        'N07'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(07)
        'N08'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(08)
        'N09'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(09)
        'N10'=>array(630, 630,630,630,630), // ƒÃæÔ ÿ(10)   ¢≠
        'N11'=>array(630, 630,630,630,630)  // ƒÃæÔ ÿ(11) ±Ûµ˜Œ•
        );
        // √œ¬” - √œ¬”¥÷§Œ≤¡≥ •È•Û•Ø
        // (ª≤æ») http://www.sagawa-exp.co.jp/business/budjetserch-j.html
