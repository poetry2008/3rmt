...
//  define('HTTP_SERVER', 'http://3jp.bobhero.200.com'); // eg, http://localhost - should not be empty for productive servers
  define('HTTP_SERVER', 'http://rr.zy.200.com'); // eg, http://localhost - should not be empty for productive servers

  define('HTTPS_SERVER', 'http://rr.zy.200.com'); // eg, https://localhost - should not be empty for productive servers
  ...
  define('DIR_FS_DOCUMENT_ROOT', '/home/hm1001/rr/jp/');
  define('DIR_FS_CATALOG', '/home/hm1001/rr/jp/');
