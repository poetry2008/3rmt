<?php
/*
  $Id: languages.php,v 1.1.1.1 2003/02/20 01:03:53 ptosh Exp $
...
<!-- clender_eof //-->
<?php if ($banner = tep_banner_exists('dynamic', 'left0')) { echo '<div align="center" style="margin-top:5;margin-bottom:5;">'.tep_display_banner('static', $banner).'</div>'; } ?>