...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  if ($random_reviews_num > 0) {
    ...
    echo tep_image(DIR_WS_IMAGES .'products/'. $ran_value['products_image'], $ran_value['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '<br> <a style="display:block;width:169px;word-wrap:break-word;overflow:hidden;" href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_INFO, 'products_id=' .
    $ran_value['products_id'] . '&reviews_id=' . $ran_key) . '">' . $review . ' ...</a><br>
    ' . tep_image(DIR_WS_IMAGES . 'stars_' . $ran_value['reviews_rating'] . '.gif' , sprintf(BOX_REVIEWS_TEXT_OF_5_STARS, $ran_value['reviews_rating'])) . "\n";
    }  
