...
define('PRODUCTS_WEIGHT_ERROR', STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' 総重量が規定の範囲を超えました。商品を削除するか、または個数を変更して（'.$max_weight_count.'）kg以内にしてください。<br><b>予約注文を承っておりますので、お問い合わせをお願いいたします。</b>');
