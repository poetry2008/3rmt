...
define('PREORDER_ACTIVE_SUCCESS_READ_INFO', '今すぐ電子メールをご確認ください。「予約注文受付」メールが届いていない場合は、受付が完了しておりません。<br> メールアドレスをご確認の上、再度お申し込みをお願いいたします。<br> 10分経過してもメールが届かない場合は、再送いたしますのでご連絡ください。<br> <br> 注意：メールが届かないときは、以下のことを必ずご確認ください。<br> ＜迷惑メールフォルダの確認＞<br> 弊社のメールが 「迷惑メールフォルダ」や「ゴミ箱」に振り分けされ見落としていませんか？<br> ＜メールドメインの受信制限を設定している＞<br> '.STORE_DOMAIN.'のメールドメインを受信するように設定をお願いいたします。<br> ＜それでも届かないときは、メールアドレス変更＞<br> お手数ではございますが、別のメールアドレスをご用意いただき、再度お手続きをお願いいたします。<br>');
...
define('TEXT_NOTIFY_PRODUCTS', '本日ご注文いただいた商品の最新情報を 電子メールでお届けしております。ご希望の方は、商品ごとにチェックして <b>[次に進む]</b> を押してください。');
