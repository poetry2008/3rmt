...
define('ACTIVE_INFO_EMAIL_READ', '<b>メールが受信できない場合</b><br> Yahoo!メール、Hotmail、Gmail等のフリーメールをご利用の際は迷惑メールフォルダーに振り分けられる場合がございますので、届かない場合は迷惑メールフォルダーをご確認ください。<br> <br> ※ メールが届かない場合には、「@domain」からのメールを受信できる設定であることをご確認ください。<br> ※ フリーメールをご利用の場合、メールの受信までにお時間がかかる場合がございます。<br> <br> それでも届かない場合は上記フォームよりメールアドレスを変更してください。「送信」ボタンをクリックするとメールが送信されます。');
?>
