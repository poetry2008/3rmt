...
define('SUB_HEADING_TEXT_1', '初めて ' . STORE_NAME . ' をご利用いただくお客様も、メンバー（登録されたお客様）と同様に [ショッピングカート] へ商品を入れていただくことができますが、メンバー登録されずに ' . STORE_NAME . ' から離れると、 [ショッピングカート] 内の商品は、保存されずに消えてしまいます。');
