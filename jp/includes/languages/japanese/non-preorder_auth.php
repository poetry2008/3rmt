...
define('PREORDER_NOTICE_SEND_TO_EMAIL_TEXT', '<b>%sに確認メールを送信しました</b>');
define('PREORDER_ACTIVE_INFO_FRONT_COMMENT', '<font color="red">メールアドレスに間違いがあった場合は、下記フォームより正しいメールアドレスに修正後「送信」ボタンをクリックしてください。</font>');
define('PREORDER_ACTIVE_INFO_END_COMMENT', 'メールが届きましたら、メールの本文の「メール認証URL」をクリックしてください。<br>URLをクリックしても、画面が正しく表示されないときは、メール内のURLをコピーしブラウザのアドレス入力欄に貼り付けてください。');
define('PREORDER_ACTIVE_INFO_EMAIL_READ', '<b>メールが受信できない場合</b><br> Yahoo!メール、Hotmail、Gmail等のフリーメールをご利用の際は迷惑メールフォルダーに振り分けられる場合がございますので、届かない場合は迷惑メールフォルダーをご確認ください。<br> <br> ※ メールが届かない場合には、「@domain」からのメールを受信できる設定であることをご確認ください。<br> ※ フリーメールをご利用の場合、メールの受信までにお時間がかかる場合がございます。<br> <br> それでも届かない場合は上記フォームよりメールアドレスを変更してください。「送信」ボタンをクリックするとメールが送信されます。');
