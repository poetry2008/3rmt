...
define('ENTRY_GENDER_ERROR', '&nbsp;<small><font color="#FF0000">が必要です。</font></small>');
define('ENTRY_GENDER_TEXT', '&nbsp;<small><font color="#FF0000">必須</font></small>');
define('ENTRY_FIRST_NAME', '名:');
define('ENTRY_FIRST_NAME_ERROR', '<font color="#FF0000">少なくても ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' 文字</font>');
define('ENTRY_FIRST_NAME_TEXT', '&nbsp;(例. 太郎) <font color="#FF0000">必須</font>');
define('ENTRY_LAST_NAME', '姓:');
define('ENTRY_LAST_NAME_ERROR', '<font color="#FF0000">少なくても ' . ENTRY_LAST_NAME_MIN_LENGTH . ' 文字</font>');
define('ENTRY_LAST_NAME_TEXT', '&nbsp;(例. 田中) <font color="#FF0000">必須</font>');
...
define('ENTRY_EMAIL_ADDRESS_TEXT', '&nbsp;(例. sample@example.com) <font color="#FF0000">必須</font>');
...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;(例. abcd1234) <font color="#FF0000">必須</font>');
define('ENTRY_PASSWORD_ERROR', '<font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;(例. abcd1234) <font color="#FF0000">必須</font>');
...
define('TEXT_HEADER_OTHER_TITLE', 'RMT専門店！ %sは安全で安心・信頼できる取り引きを目指していきます。');
define('TEXT_HEADER_SEARCH_IMAGE_ALT', 'RMT検索');
define('TEXT_HEADER_SEARCH_MUST_INPUT', '入力してください');
...
define('TEXT_BILLING_SELECT_TRUE', 'いる');
define('TEXT_BILLING_SELECT_FALSE', 'いらない');
?>
