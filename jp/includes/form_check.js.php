<?php
/*
  $Id: form_check.js.php,v 1.1.1.1 2003/02/20 01:03:53 ptosh Exp $
...
//  var first_name_f = document.account_edit.firstname_f.value;
//  var last_name_f = document.account_edit.lastname_f.value;
...
*/
/*
  if (document.account_edit.elements['lastname_f'].type != "hidden") {
    if (last_name_f == '' || last_name_f.length < <?php echo ENTRY_LAST_NAME_MIN_LENGTH; ?>) {
