...
<?php
  if ( (!isset($new_products_category_id)) || ($new_products_category_id == '0') ) {
    ...
    $new_products_query = tep_db_query("
        ...
        order by site_id DESC) c where site_id = '".SITE_ID."' or site_id = '0'
        group by products_id having c.products_status != '0' order by products_date_added desc 
    ...
    $new_products_query = tep_db_query("
      ...
      group by products_id having products_status != '0' order by products_date_added desc 
      limit " . MAX_DISPLAY_NEW_PRODUCTS
    );
  }
