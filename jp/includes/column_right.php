...
*/
  ...
  if ($banner = tep_banner_exists('dynamic', 'right1')) { echo '<div align="center" style="padding-bottom:5px; border-bottom:1px dashed #ccc; ">'.tep_display_banner('static', $banner).'</div>';  }
