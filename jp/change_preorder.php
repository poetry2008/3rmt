...
<div align="center"> 
  ...
  $work_end_exit = $min_time_end_str;
        ...
        <table width="100%" cellpadding="2" cellspacing="2" border="0">
        <tr> 
          <td class="main" colspan="2"><input type="radio" name="preorders_billing_select" value="1"<?php echo isset($_POST['preorders_billing_select']) && $_POST['preorders_billing_select'] == 1 ? ' checked="checked"' : (isset($_SESSION['preorder_information']['preorders_billing_select']) && $_SESSION['preorder_information']['preorders_billing_select'] == 1 ? ' checked="checked"' : (!isset($_POST['preorders_billing_select']) && !isset($_SESSION['preorder_information']['preorders_billing_select']) ? ' checked="checked"' : ''));?>><?php echo TEXT_BILLING_SELECT_TRUE;?><input type="radio" name="preorders_billing_select" value="0"<?php echo isset($_POST['preorders_billing_select']) && $_POST['preorders_billing_select'] == 0 ? ' checked="checked"' : (isset($_SESSION['preorder_information']['preorders_billing_select']) && $_SESSION['preorder_information']['preorders_billing_select'] == 0 ? ' checked="checked"' : '');?>><?php echo TEXT_BILLING_SELECT_FALSE;?></td>
        </tr>
        </table>
        </td></tr>
        </table>
