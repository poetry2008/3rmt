...
<?php
    ...
    echo '<li class="news_list02"><div class="div01">'.tep_date_short($latest_news['date_added']) . '</div><a class="link01" href="' .tep_href_link(FILENAME_NEWS ,'news_id=' . $latest_news['news_id']).'">' . replace_store_name($latest_news['headline']) . '' . $latest_news_image . $latest_news_new .'</a></li>'."\n";
...
?>
                ...
                <div align="right">
                  <?php echo '<a href="' . tep_href_link(FILENAME_NEWS) .
