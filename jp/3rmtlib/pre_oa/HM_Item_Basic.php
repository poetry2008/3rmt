...
class HM_Item_Basic 
{
  ...
  function updateValue($order_id,$form_id,$group_id,$item_id,$result)
    ...
    tep_db_query($sql);
    $sql = "INSERT INTO ".TABLE_PREORDERS_OA_FORMVALUE ." (`id`, `orders_id`, `form_id`, `item_id`, `group_id`, `name`, `value`) VALUES (NULL,'".$order_id."',".$form_id.",".$item_id.",".$group_id.",'".$this->formname."','".$result."')";
