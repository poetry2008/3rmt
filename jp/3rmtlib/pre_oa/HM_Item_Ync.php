...
require_once DIR_WS_LANGUAGES . $language . '/oa/HM_Item_Ync.php';
...
class HM_Item_Ync extends HM_Item_Basic
{
  ...
  static public function prepareForm($item_id = NULL)
  {
    ...
    $formString  = '';
    $formString .= TEXT_YNC_FIRST_CHAR."<input type='text' name='firstInput'
      value='".(isset($item_value['firstInput'])?$item_value['firstInput']:TEXT_YNC_HAVE)."'/>";
    $formString .= "</br>\n";
    $formString .= TEXT_YNC_SECOND_CHAR."<input type='text' name='afterInput'
      value='".(isset($item_value['afterInput'])?$item_value['afterInput']:TEXT_YNC_NULL)."'/></br>\n";
    $formString .= "</br>\n";
    $formString .= TEXT_YNC_DEFAULT."<input type='text' name='defaultText'
      value='".(isset($item_value['defaultText'])?$item_value['defautlText']:TEXT_YNC_SHOW_TEXT)."'/></br>\n";
    $formString .= "</br>\n";
    return $formString;
  }
