...
?>
  <tr>
    ...
    echo $reviews_array[$i]['review'] . '<br><br><i><div class="text_main">' .  sprintf(TEXT_REVIEW_RATING, tep_image(DIR_WS_IMAGES . 'stars_' .  $reviews_array[$i]['rating'] . '.gif', sprintf(TEXT_OF_FIVE_INFO_STARS, $reviews_array[$i]['rating'])), sprintf(TEXT_OF_FIVE_INFO_STARS, $reviews_array[$i]['rating'])) . '</div></i>'; 
    ?>
    </td>
  </tr>
<?php
