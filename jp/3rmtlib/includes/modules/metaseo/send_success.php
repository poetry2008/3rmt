 ...
 -------------------*/
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title,
        ...
        site_id) values ('タイトル',   'MODULE_METASEO_SEND_SUCCESS_TITLE',
          '',
          'パスワード再発行手続きのタイトル<br>#STORE_NAME#<br>#BREADCRUMB#<br>#PAGE_TITLE#<br>#BREADCRUMB_KEYWORD#<br>#BREADCRUMB_FIRST#',
