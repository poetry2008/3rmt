...
/*--------------------------------
 ...
 -------------------------------*/
  ...
  function install() {
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added,user_added, site_id) values ('買い取りを有効にする', 'MODULE_PAYMENT_FETCH_GOOD_STATUS', 'True', '銀行振込による支払いを受け付けますか?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now(),'".$_SESSION['user_name']."', ".$this->site_id.");");
    ...
    tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, site_id) values ('ポイント', 'MODULE_PAYMENT_FETCH_GOOD_IS_GET_POINT', '1', 'ポイント', '6', '1', 'tep_cfg_payment_new_checkbox(', now(), ".$this->site_id.");");
 ...
 ----------------------------*/
  function keys() {
    return array(
                 ...
                 'MODULE_PAYMENT_FETCH_GOOD_PRINT_MAILSTRING_TITLE',
...
/*-----------------------------
 ...
 ----------------------------*/
  function admin_show_payment_list($pay_info_array){
   ...
   if($bank_kamoku[1] == TS_MODULE_PAYMENT_FETCH_GOOD_NORMAL || $bank_kamoku[1] == ''){
...
/*--------------------------
 ...
 -------------------------*/  
   ...
   {
     return get_configuration_by_site_id_or_default('MODULE_PAYMENT_FETCH_GOOD_IS_GET_POINT', (int)$site_id); 
   }
/*------------------------
 功能：后台获取点率
 参数：$site_id(string) SITE_ID值
 ...
 -----------------------*/  
   ...
   {
     return get_configuration_by_site_id_or_default('MODULE_PAYMENT_FETCH_GOOD_POINT_RATE', (int)$site_id); 
   }
/*----------------------
 功能：后台计算得到的点数
 ...
 -------------------------*/  
   ...
   {
     return MODULE_PAYMENT_FETCH_GOOD_POINT_RATE; 
   }
/*--------------------------
 功能：后台获得评论
