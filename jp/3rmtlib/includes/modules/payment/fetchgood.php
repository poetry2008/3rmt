...
// class methods
    ...
    function confirmation() {
      ...
      if (!empty($this->n_fee)) {
        return array(
            ...
            'fields' => array(array('title' => MODULE_PAYMENT_FETCH_GOOD_TEXT_PROCESS,
                                    'field' => ''),
                              array('title' => $s_message, 'field' => '')  
                       )           
            );
        ...
        if ($this->check_buy_goods()) {
          ...
          return array(
              'title' => MODULE_PAYMENT_FETCH_GOOD_TEXT_DESCRIPTION,
              'fields' => array(
                                array('title' => MODULE_PAYMENT_FETCH_GOOD_TEXT_SHOW, 'field' => ''),  
                                array('title' => $s_message, 'field' => '')  
                         )           
              );
        } else {
    ...
    function keys() {
      return array('MODULE_PAYMENT_FETCH_GOOD_STATUS', 'MODULE_PAYMENT_FETCH_GOOD_LIMIT_SHOW', 'MODULE_PAYMENT_FETCH_GOOD_ORDER_STATUS_ID', 'MODULE_PAYMENT_FETCH_GOOD_SORT_ORDER', 'MODULE_PAYMENT_FETCH_GOOD_MONEY_LIMIT');
    }
  }
?>
