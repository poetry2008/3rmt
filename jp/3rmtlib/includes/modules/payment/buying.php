...
0,3000円に入れると、0円から3000円までの金額が決済可能。設定範囲外の決済は不可。', '6', '0', now(), ".$this->site_id.")");
  ...
  function admin_show_payment_list($pay_info_array){
   ...
   $bank_name[1] = isset($_SESSION['orders_update_products']['bank_name']) ? $_SESSION['orders_update_products']['bank_name'] : $bank_name[1];
   ...
   $bank_shiten[1] = isset($_SESSION['orders_update_products']['bank_shiten']) ? $_SESSION['orders_update_products']['bank_shiten'] : $bank_shiten[1];
   ...
   $bank_kamoku[1] = isset($_SESSION['orders_update_products']['bank_kamoku']) ? $_SESSION['orders_update_products']['bank_kamoku'] : $bank_kamoku[1];
   ...
   $bank_kouza_num[1] = isset($_SESSION['orders_update_products']['bank_kouza_num']) ? $_SESSION['orders_update_products']['bank_kouza_num'] : $bank_kouza_num[1];
   ...
   $bank_kouza_name[1] = isset($_SESSION['orders_update_products']['bank_kouza_name']) ? $_SESSION['orders_update_products']['bank_kouza_name'] : $bank_kouza_name[1];
