  ...
  function fields($theData=false, $back=false){
    ...
    return array(
                 array(
                       ...
                       "title"=>TS_MODULE_PAYMENT_CONVENIENCE_EMAIL_TEXT,
                       "field"=>tep_draw_input_field('convenience_email', strtolower($default_value),'onpaste="return false"'.$style_width.$input_text_id.'').'&nbsp;&nbsp;'.TS_MODULE_PAYMENT_CONVENIENCE_MUST_INPUT, 
                       "rule"=>array(basePayment::RULE_NOT_NULL,basePayment::RULE_EMAIL),
                 ...
                 array(
                       ...
                       "field"=>tep_draw_input_field('convenience_email_again', strtolower($default_again_value),'onpaste="return false"'.$style_width.$input_text_id.'').'&nbsp;&nbsp;'.TS_MODULE_PAYMENT_CONVENIENCE_MUST_INPUT,
...
/*----------------------------
 ...
 ---------------------------*/
  function admin_get_payment_info_comment($customers_email,$site_id,$orders_type,$gray_single){
    ...
    if ($exists_single) {
      $orders_status_history_temp_query = tep_db_query("select payment_method,orders_id from ". $orders_type_str ." where customers_email_address='". $customers_email ."' and site_id='".$site_id."' and payment_method='".TS_MODULE_PAYMENT_CONVENIENCE_STORE_TEXT_TITLE."' and is_gray != '1' and is_guest = '0' and date_purchased >= '".$customers_info['customers_info_date_account_created']."' limit 0,1");
    } else {
      $orders_status_history_temp_query = tep_db_query("select payment_method,orders_id from ". $orders_type_str ." where customers_email_address='". $customers_email ."' and site_id='".$site_id."' and payment_method='".TS_MODULE_PAYMENT_CONVENIENCE_STORE_TEXT_TITLE."' and is_gray != '1' and is_guest = '0' limit 0,1");
    }
    ...
    if($orders_num_rows > 0){
      if ($exists_single) {
        $orders_status_history_query = tep_db_query("select payment_method,orders_id from ". $orders_type_str ." where customers_email_address='". $customers_email ."' and site_id='".$site_id."' and payment_method='".TS_MODULE_PAYMENT_CONVENIENCE_STORE_TEXT_TITLE."' and is_gray != '1' and is_guest = '0' and date_purchased >= '".$customers_info['customers_info_date_account_created']."' order by orders_id desc limit 0,1");
      } else {
        $orders_status_history_query = tep_db_query("select payment_method,orders_id from ". $orders_type_str ." where customers_email_address='". $customers_email ."' and site_id='".$site_id."' and payment_method='".TS_MODULE_PAYMENT_CONVENIENCE_STORE_TEXT_TITLE."' and is_gray != '1' and is_guest = '0' order by orders_id desc limit 0,1");
      }
