...
0,3000円に入れると、0円から3000円までの金額が決済可能。設定範囲外の決済は不可。', '6', '0', now(), ".$this->site_id.")");
    ...
    function keys() {
      return array( 'MODULE_PAYMENT_CONVENIENCE_STORE_STATUS', 'MODULE_PAYMENT_CONVENIENCE_STORE_LIMIT_SHOW', 'MODULE_PAYMENT_CONVENIENCE_STORE_PREORDER_SHOW', 'MODULE_PAYMENT_CONVENIENCE_STORE_IP', 'MODULE_PAYMENT_CONVENIENCE_STORE_URL', 'MODULE_PAYMENT_CONVENIENCE_STORE_COST', 'MODULE_PAYMENT_CONVENIENCE_STORE_SORT_ORDER', 'MODULE_PAYMENT_CONVENIENCE_STORE_ZONE', 'MODULE_PAYMENT_CONVENIENCE_STORE_ORDER_STATUS_ID' , 'MODULE_PAYMENT_CONVENIENCE_STORE_MONEY_LIMIT');
    }
  }
?>
