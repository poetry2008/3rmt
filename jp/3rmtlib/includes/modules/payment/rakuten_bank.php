...
0,3000円に入れると、0円から3000円までの金額が決済可能。設定範囲外の決済は不可。', '6', '0', now(), ".$this->site_id.")");
    ...
    function keys() {
      return array( 'MODULE_PAYMENT_RAKUTEN_BANK_STATUS', 'MODULE_PAYMENT_RAKUTEN_BANK_LIMIT_SHOW', 'MODULE_PAYMENT_RAKUTEN_BANK_PREORDER_SHOW', 'MODULE_PAYMENT_RAKUTEN_BANK_IP', 'MODULE_PAYMENT_RAKUTEN_BANK_URL', 'MODULE_PAYMENT_RAKUTEN_BANK_COST', 'MODULE_PAYMENT_RAKUTEN_BANK_SORT_ORDER', 'MODULE_PAYMENT_RAKUTEN_BANK_ZONE', 'MODULE_PAYMENT_RAKUTEN_BANK_ORDER_STATUS_ID' , 'MODULE_PAYMENT_RAKUTEN_BANK_MONEY_LIMIT');
    }
  }
?>
