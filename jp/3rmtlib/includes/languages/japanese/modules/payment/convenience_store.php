...
// コンビニ決済
  ...
  define('TS_MODULE_PAYMENT_CONVENIENCE_STORE_TEXT_FOOTER', '<p color="#ff0000">※ コンビニ決済用の電子メールは営業時間内（10時00分から24時00分）に送信いたします。<br>※ 注文の混雑状況により、メール送信にお時間をいただく場合がございます。</p><br><img src="images/rmt_cr.gif">');
  /*
