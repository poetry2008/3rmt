...
*/
  ...
  define('TS_MODULE_PAYMENT_CONVENIENCE_STORE_TEXT_FOOTER', '<p color="#ff0000">※ 便利店结算用的电子邮箱在营业时间内（10时00分到24时00分）发送邮件。<br>※ 订单多的时候发送邮件时间也可能不是营业时间。</p><br><img src="images/rmt_cr.gif">');
