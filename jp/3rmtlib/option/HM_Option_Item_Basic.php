  ...
  public function prepareFormWithParent($item_id){
    ...
    if ($this->has_radio) {
      if (!isset($item_value['radio_image'])) {
        for($i=1; $i<=5; $i++) {
          $formString .= "<tr><td align='left'>".TEXT_ITEM_SELECT_HEAD."</td><td align='left'><input type='text' name='ro_".$i."' value='' style='width:35%;'><a href=\"javascript:void(0);\" onclick=\"delete_radio(this, ".$i.");\">".tep_html_element_button(TEXT_ITEM_DEL_LINK)."</a></td></tr>"; 
        ...
        if (!empty($item_value['radio_image'])) {
          ...
          foreach ($item_value['radio_image'] as $ri_key => $ri_value) {
            $formString .= "<tr><td align='left'>".TEXT_ITEM_SELECT_HEAD."</td><td align='left'><input type='text' name='ro_".$i."' value='".$ri_value['title']."' style='width:35%;'><a href=\"javascript:void(0);\" onclick=\"delete_radio(this, ".$i.");\">".tep_html_element_button(TEXT_ITEM_DEL_LINK)."</a></td></tr>"; 
