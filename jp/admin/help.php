...
<title>
<?php 
if(isset($_GET['info_romaji']) && $_GET['info_romaji']) echo $info_array['title']=="" ? HELP_INFO_NO_INFO : $info_array['title'];
elseif(isset($_GET['keyword']) && $_GET['keyword']!="") echo $keyword.HELP_INFO_SEARCH;
else echo HELP_INFO_HEADER;
?>
