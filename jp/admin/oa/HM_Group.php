...
class HM_Group extends DbRecord
{
  ...
  {
    echo "<tr>";
    echo "<td class='main' valign='top' width='30%'>";
    echo $this->name;
    ...
    echo "</table>";
    echo "</td>";    
    echo "<td class='main' align='right' valign='top'><img class='clean' src='images/icons/icon_cancel.gif' onclick='cleanthisrow(this)'></td>";
    echo "</tr>";
  }
}
