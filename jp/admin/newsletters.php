...
<script type="text/javascript">
	var js_newsletters_mail_text = '<?php echo NOTICE_SEND_ZERO_MAIL_TEXT;?>';
	var js_newsletters_self = '<?php echo $_SERVER['PHP_SELF']?>';
	var js_onetime_pwd = '<?php echo JS_TEXT_INPUT_ONETIME_PWD;?>';
	var js_onetime_error = '<?php echo JS_TEXT_ONETIME_PWD_ERROR;?>';
</script>
<script language="javascript" src="includes/javascript/admin_newsletters.js?v=<?php echo $back_rand_info?>"></script>
<?php 
