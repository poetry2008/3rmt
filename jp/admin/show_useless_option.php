...
$option_group_sql="SELECT *  FROM ".TABLE_OPTION_GROUP." WHERE `id` NOT IN (".$not_in.") ORDER BY sort_num,name asc";
...
<table width="100%">
<tr>
<td class="smallText" valign="top"><?php echo $group_split->display_count($num_rows,
    MAX_DISPLAY_SEARCH_RESULTS, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_USELESS_OPTION); ?></td>
...
<table width="100%">
<tr><td align="right">
<button onclick="del();"><?php echo SHOW_USELESS_DEL;?></button>&nbsp;&nbsp;&nbsp;<button onclick="del_all();" ><?php echo SHOW_USELESS_SELECT_ALL;?></button>
 </td></tr>
</table>
</td>
</tr>
