...
if(isset($_GET['action']) && $_GET['action'] == 'check_file_exists'){
 ...
 -----------------------------------------------------*/
  ...
  //内容链接跳转处理
  $latest_messages_query_raw = 'select * from messages where recipient_id = "'.$_POST['sender_id'].'" and messages_status = "0" and trash_status="0" and delete_status in ("0","2") order by time desc';
