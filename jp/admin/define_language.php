...
<script type="text/javascript">
	var js_define_language_self = '<?php echo JS_TEXT_INPUT_ONETIME_PWD;?>';
	var js_onetime_pwd = '<?php echo JS_TEXT_INPUT_ONETIME_PWD;?>';
	var js_onetime_error = '<?php echo JS_TEXT_ONETIME_PWD_ERROR;?>';
</script>
<script language="javascript" src="includes/javascript/admin_define_language.js?v=<?php echo $back_rand_info?>"></script>
<?php 
...
preg_match_all('/filename=[^&]+/',$belong,$belong_temp_array);
