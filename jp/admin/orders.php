...
?>
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
    ...
    <div id="orders_info_box" style="display:none; position:absolute; background:#FFF; margin-left:20px; width:20%; width:55%; padding:5px 15px 4px 15px;/*bottom:0;margin-top:40px;right:0;width:200px;*/">&nbsp;</div>
<?php
  if ($ocertify->npermission == 15) {
