...
<?php } ?>
  ...
  <tr>
    ...
    <td class="main"><?php echo tep_draw_checkbox_field('q_3_1', '1', $oq['q_3_1'], '', 'id="q_3_1" onchange="change_option(this)" onpropertychange="propertychange_option(this)"');?><?php echo tep_draw_input_field('q_3_2_m', $oq['q_3_2'] == '0000-00-00' ? ('') : ($oq['q_3_2'] ? date('m', strtotime($oq['q_3_2'])) : ($pay_time?date('m', strtotime($pay_time)):'')), 'id="q_3_2_m" size="2"');?>月<?php echo tep_draw_input_field('q_3_2_d', $oq['q_3_2'] == '0000-00-00'?'':($oq['q_3_2'] ? date('d', strtotime($oq['q_3_2'])) : ($pay_time?date('d', strtotime($pay_time)):'')), 'id="q_3_2_d" size="2"');?>日 → 金額は<b><?php echo $new_price;?><?php echo tep_draw_hidden_field('q_3_3', $oq['q_3_3']?($oq['q_3_3'] != $new_price ? $new_price : $oq['q_3_3']):$new_price, 'size="10" class="questions_date" readonly style="text-align:right;font-weight:bold;font-size:12px"');?></b>円ですか？→<?php echo tep_draw_checkbox_field('q_3_4', '1', $oq['q_3_4'], '','id="q_3_4" onchange="change_option(this)" onpropertychange="propertychange_option(this)"');?>はい</td>
<?php if (!$oq['q_8_1']) { ?>
