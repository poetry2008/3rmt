...
<br><?php echo TABLE_PROMPT_2;?></td></tr> <tr><td width="30%" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo TABLE_LIST_6;?></td><td> <textarea name="email_comment" id="email_comment" rows="5" cols="30" class="option_text" style="resize:vertical;"><?php echo $email_comment; ?></textarea>
...
?>
&nbsp;<input type="button" name="save" value="<?php echo TABLE_BUTTON_SAVE;?>" onclick="if(check_form()){check_area('save', '<?php echo $ocertify->npermission;?>');}else{return check_form();}">&nbsp;
<?php
if($id != 0){
  if ($ocertify->npermission >= 15) {
?>
  <input type="button" name="del" value="<?php echo TABLE_BUTTON_DEL;?>" onclick="if(confirm('<?php echo TEXT_WANT_DELETE;?>')){check_area('del', '<?php echo $ocertify->npermission;?>');}else{return false;}">
<?php
  }
}else{
?>
