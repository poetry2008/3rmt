...
?>
                  <tr>
                    <td colspan="2" align="right"><?php echo '<a href="' .  tep_href_link(FILENAME_COMPUTERS, 'page=' . $_GET['page'] .  '&action=new') . '">' .  tep_html_element_button(BUTTON_NEW_COMPUTER_TEXT) . '</a>'; ?></td>
                  </tr>
<?php
  }
?>
