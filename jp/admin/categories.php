...
if (isset($_GET['read']) && $_GET['read'] == 'only' && (!isset($_GET['origin']) || !$_GET['origin'])) {
  ...
  if (tep_get_bflag_by_product_id($pInfo->products_id)) { // 如果买取
    ...
    echo '  <td><a href="javascript:void(0)" id="a_1" onclick="change_qt(this)" style="text-decoration : underline;"></a></td>';
    echo '  <td><a href="javascript:void(0)" id="a_2" onclick="change_qt(this)" style="text-decoration : underline;"></a></td>';
    echo '  <td><a href="javascript:void(0)" id="a_3" onclick="change_qt(this)" style="text-decoration : underline;"></a></td>';
    echo '  </tr>';
    echo '  <tr>';
    ...
    echo '  <td><a href="javascript:void(0)" id="b_1" onclick="change_qt(this)" style="text-decoration : underline;"></a></td>';
    echo '  <td><a href="javascript:void(0)" id="b_2" onclick="change_qt(this)" style="text-decoration : underline;"></a></td>';
    echo '  <td><a href="javascript:void(0)" id="b_3" onclick="change_qt(this)" style="text-decoration : underline;"></a></td>';
    echo '  </tr>';
    echo '</table>';
    echo '</td>';
  }
