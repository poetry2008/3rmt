...
<table border="0" width="100%" style="font-family:メイリオ; clear:both;" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td valign="top">
      ...
      <tr><td height="4"></td></tr>
        ...
        <tr><td align="right"><textarea id="data10" type="text" rows="2" value="" style="font-size:14px; overflow-y:visible; width:180px; font-family:メイリオ; text-align:right;" ></textarea></td></tr>
  ...
  <span id="email_display"></span>
        ...
        <tr><td align="right" colspan="4">
          ...
          <tr><td colspan="6" align="center" valign="middle"><textarea id="responsible" type="text" rows="6" value=""  style=" width:100px; font-size:20px; overflow-y:visible; text-align:center; padding:15px 0;" onChange="textarea_change()"></textarea></td></tr>
          </table>
        </td></tr>
      </table>
    </td>
