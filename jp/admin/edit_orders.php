      ...
      if ($customer_guest['customers_guest_chk'] == 0) { //会員
        ...
        echo '  <tr>' . "\n" .
          ...
          if ($campaign_res) {
            ...
            echo "<input type='hidden' id='point_value_temp' value='".(int)$campaign_res['campaign_fee']."'><input name='update_totals[$TotalIndex][value]' id='point_id' onkeyup='clearNoNum(this);price_total(\"".TEXT_MONEY_SYMBOL."\");' size='6' value='" .abs((int)$campaign_res['campaign_fee']) .  "'><b>".TEXT_MONEY_SYMBOL.'</b>';
          } else {
            echo "<input name='update_totals[$TotalIndex][value]' id='point_id' onkeyup='clearNoNum(this);price_total(\"".TEXT_MONEY_SYMBOL."\");' size='6' value='" . $point_session_id . "'><b>".TEXT_MONEY_SYMBOL.'</b>';
          }
