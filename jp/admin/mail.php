...
<script language="javascript" >
	var js_mail_one_search = "<?php echo TEXT_LESS_THAN_ONE_SEARCH;?>";
	var js_mail_no_selected_checkbox = "<?php echo TEXT_NO_SELECTED_CHECKBOX;?>";
</script>
<script language="javascript" src="includes/javascript/admin_mail.js?v=<?php echo $back_rand_info?>"></script>
<?php 
$href_url = str_replace('/admin/','',$_SERVER['SCRIPT_NAME']);
$belong = str_replace('/admin/','',$_SERVER['REQUEST_URI']);
preg_match_all('/mail_sum=[^&]+/',$belong,$belong_mail_array);
if($belong_mail_array[0][0] != ''){
  $belong = $href_url.'?mail_sum';
}else{
  $belong = $href_url;
}
