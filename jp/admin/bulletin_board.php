...
<?php
  ...
  $bulletin_title_row[] = array('params' => 'class="dataTableHeadingContent"', 'text' => TEXT_BULLETIN_BOARD_NUM);
  ...
  $bulletin_title_query = tep_db_query($bulletin_query_raw);
  $bulletin_title_i = 0;
