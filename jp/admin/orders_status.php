...
<script type="text/javascript">
	var js_orders_status_self = '<?php echo $_SERVER['PHP_SELF']?>';
	var js_onetime_pwd = '<?php echo JS_TEXT_INPUT_ONETIME_PWD;?>';
	var js_onetime_error = '<?php echo JS_TEXT_ONETIME_PWD_ERROR;?>';
	var js_orders_status_npermission = '<?php echo $ocertify->npermission;?>';
</script>
<script language="javascript" src="includes/javascript/admin_orders_status.js?v=<?php echo $back_rand_info?>"></script>
<?php 
