...
// for 3rmt {{{
    ...
    if(!in_array($cInfo->configuration_key, array(
            ...
            'JAVA_LIGHT_KEYWORDS',
            'TELNO_KEYWORDS', 
            'ORDER_INFO_ORDER_FROM',
            'ORDER_INFO_ORDER_FETCH_TIME',
            'ORDER_INFO_ORDER_OPTION', 
            'ORDER_INFO_ORDER_ID', 
            'ORDER_INFO_ORDER_DATE', 
            'ORDER_INFO_ORDER_CUSTOMER_TYPE', 
            'ORDER_INFO_ORDER_CUSTOMER_NAME', 
            'ORDER_INFO_ORDER_EMAIL', 
            'ORDER_INFO_ORDER_CREDITCARD_TYPE', 
            'ORDER_INFO_ORDER_CREDITCARD_OWNER', 
            'ORDER_INFO_ORDER_CREDITCARD_ID', 
            'ORDER_INFO_ORDER_CREDITCARD_EXPIRE_TIME', 
            'CUSTOMER_INFO_ORDER_IP', 
            'CUSTOMER_INFO_ORDER_HOST', 
            'CUSTOMER_INFO_ORDER_USER_AGEMT', 
            'CUSTOMER_INFO_ORDER_OS', 
            'CUSTOMER_INFO_ORDER_BROWSE_TYPE', 
            'CUSTOMER_INFO_ORDER_BROWSE_LAN', 
            'CUSTOMER_INFO_ORDER_COMPUTER_LAN', 
            'CUSTOMER_INFO_ORDER_USER_LAN', 
            'CUSTOMER_INFO_ORDER_PIXEL', 
            'CUSTOMER_INFO_ORDER_COLOR', 
            'CUSTOMER_INFO_ORDER_FLASH', 
            'CUSTOMER_INFO_ORDER_FLASH_VERSION', 
            'CUSTOMER_INFO_ORDER_DIRECTOR', 
            'CUSTOMER_INFO_ORDER_QUICK_TIME', 
            'CUSTOMER_INFO_ORDER_REAL_PLAYER', 
            'CUSTOMER_INFO_ORDER_WINDOWS_MEDIA', 
            'CUSTOMER_INFO_ORDER_PDF', 
            'CUSTOMER_INFO_ORDER_JAVA', 
            ))) 
