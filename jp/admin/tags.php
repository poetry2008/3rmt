...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  ...
  <table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr> 
          <td valign="top" align="left">&nbsp;<input type="checkbox" name="all_check" onclick="all_select_products('categories_id[]');all_select_products('products_id[]')"><?php echo TEXT_PRODUCTS_TAGS_ALL_CHECK;?><input type="hidden" name="tags_id_list" value="<?php echo $tags_id_str;?>"><input type="hidden" name="tags_url" value="<?php echo $_POST['tags_url'];?>"><br><td align="right"><input type="button" class="element_button" value="<?php echo IMAGE_SAVE;?>" onclick="products_tags_submit();"><?php echo '<a href="' . tep_href_link(FILENAME_TAGS, $_POST['tags_url']) . '">' . tep_html_element_button(IMAGE_BACK) . '</a>'; ?></td><table width="100%" class="box_ul"><tr>
<?php
  $i = 0;
  $j = 0;
  $temp_array = array();
...
?>
          ...
          <tr>
           ...
           <input type="button" class="element_button" value="<?php echo IMAGE_SAVE;?>" onclick="products_tags_submit();"><?php echo '<a href="' . tep_href_link(FILENAME_TAGS, $_POST['tags_url']) . '">' . tep_html_element_button(IMAGE_BACK) . '</a>'; ?> 
           </td>
          </tr> 
         </table>
         </form>
