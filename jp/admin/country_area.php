...
<tr><td align="right" colspan="9"><div class="td_button"><button onclick="javascript:location.href='country_fee.php';"><?php echo TABLE_HISTROY;?></button>&nbsp;<button onclick="show_text_area(0,this,<?php echo $_GET['fid']; ?>);"><?php echo TABLE_BUTTON;?></button></div></td></tr>
</table>
<?php if(empty($area_fee_array['id'])){
