...
//包含你的全部css文档
include('javascript/jquery.form.js');
include('javascript/jquery_include.js');
include('javascript/one_time_pwd.js');
include('javascript/all_preorder.js');
include('javascript/admin_preorders.js');
