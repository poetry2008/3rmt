if (typeof window.jQuery == "undefined") {
  document.write('<script language="javascript" src="includes/javascript/jquery.js?v=<?php echo $_GET['v'];?>"><\/script>');
}
var left_c_page = '<?php echo urldecode($_GET["other"])?>';
...
function toggle_leftColumn()
{
  ...
  <?php
  if (left_c_page == '/admin/orders.php' || left_c_page == '/admin/preorders.php') {
...
<?php if(left_c_page == '/admin/campaign.php'){ ?>
setTimeout("show_campaign_info_offset()",10); 
<?php } ?>
<?php if(left_c_page == '/admin/orders.php'){ ?>
