...
?>
  ...
  <td class="main"><input type="hidden" name="oID" value="<?php echo $oID;?>">  
        ...
        print '<tr>';
        print '<td width="150">'; 
        print ADDPRODUCT_TEXT_CATEGORY_SELECTION_TITLE; 
        print '</td>'; 
        print '<td>'; 
        ...
        if(($step > 1) && ($add_product_categories_id > 0))
        {
          ...
          print ADDPRODUCT_TEXT_PRODUCT_SELECTION_TITLE."</td>";
          print "<td>";
