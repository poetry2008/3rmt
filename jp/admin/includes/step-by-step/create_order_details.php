...
<tr>
  <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2">
            <tr>
      <td class="main">&nbsp;<?php echo CREATE_ORDER_FETCH_TIME_TITLE_TEXT;?>:</td>
              <td class="main">&nbsp;<?php echo $year_str.'&nbsp;年&nbsp;'.$mon_str.'&nbsp;月&nbsp;'.$day_str.'&nbsp;日&nbsp;'.$hour_str.'&nbsp;時&nbsp;'.$min_str.'&nbsp;分&nbsp;～&nbsp;'.$hour_str_1.'&nbsp;時&nbsp;'.$min_str_1.'&nbsp;分&nbsp;';?></td>
            </tr> 
          </table></td>
      </tr>
    </table>
