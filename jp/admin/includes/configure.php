...
*/
$libpath = "/home/kthiz/project/9rr/jp/3rmtlib/";
ini_set('include_path',ini_get('include_path').':'.$libpath);

// Define the webserver and path parameters
// * DIR_FS_* = Filesystem directories (local/physical)
// * DIR_WS_* = Webserver directories (virtual/URL)
  define('HTTP_SERVER', 'http://3jp.new.200.com'); // eg, http://localhost or - https://localhost should not be empty for productive servers
  define('HTTP_CATALOG_SERVER', 'http://3jp.new.200.com');
  define('HTTPS_CATALOG_SERVER', 'https://3jp.new.200.com');
  define('BACKEND_LAN_URL_ENABLED',false);
  define('ENABLE_SSL_CATALOG', 'false'); // secure webserver for catalog module

  define('DIR_FS_DOCUMENT_ROOT', '/home/kthiz/project/9rr/jp/admin/'); // where the pages are located on the server
  define('DIR_WS_ADMIN', '/admin/'); // absolute path required
  define('DIR_FS_ADMIN', '/home/kthiz/project/9rr/jp/admin/'); // absolute pate required

  define('DIR_WS_CATALOG', '/'); // absolute path required
  define('DIR_FS_CATALOG', '/home/kthiz/project/9rr/jp/admin/'); // absolute path required
