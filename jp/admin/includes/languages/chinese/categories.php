...
define('TEXT_PRODUCTS_LETTERS', 'URL文字:');
define('TEXT_LETTERS_ERROR', '拼音的格式不正确!');
define('TEXT_LETTERS_NOT_NULL', '请输入拼音!');
...
define('CATEGORY_LETTERS_ERROR_NOTICE', '无法注册的罗马字有半角记号。请删除或者换成半角连字符。');
...
define('CATEGORY_PHONETIC_LETTERS', '片假名:');
define('CATEGORY_ALPHA_LETTERS', '英数字:');
...
define('TEXT_CATEGORY_LETTERS', '罗马字:');
