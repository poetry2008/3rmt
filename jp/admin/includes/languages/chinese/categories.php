...
define('TEXT_PRODUCT_INVENTORY_INFO','可以使用的计算符号：+　-　*　/　()<br>可以使用的参数：<br>商品单价：$unit_price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;关联商品单价：$related_unit_price<br>实际库存的平均价格：$stocks_average_cost<br>商品最近的订单数：$recent_ordered_number_of_unit<br>关联商品最近的订单数：$recent_ordered_number_of_related_unit');
?>
