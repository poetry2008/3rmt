...
define('TEXT_ROMAN_EXISTS', ' 拼音存在');
define('TEXT_PRODUCTS_ROMAN', 'URL文字:');
define('TEXT_ROMAN_ERROR', '拼音的格式不正确!');
define('TEXT_ROMAN_NOT_NULL', '请输入拼音!');
...
define('CATEGORY_PIECT_UNIT_TEXT', '个');
