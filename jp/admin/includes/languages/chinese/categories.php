...
define('TEXT_PRODUCTS_VIRTUAL_QUANTITY_TEXT', '虚拟库存:');
define('TEXT_PRODUCTS_REAL_QUANTITY_TEXT', '实际库存');
define('TEXT_PRODUCTS_QUANTITY_TEXT', '库存');
...
define('TEXT_PRODUCTS_NAME_TEXT', '商品名');
...
define('TEXT_ROMAN_CHARACTERS_EXISTS', ' 拼音存在');
define('TEXT_PRODUCTS_URL_WORD', 'URL文字:');
define('TEXT_ROMAN_CHARACTERS_ERROR', '拼音的格式不正确!');
define('TEXT_ROMANIZATION_NOT_NULL', '请输入拼音!');
define('TEXT_MAX','最大库存');
define('TEXT_MIN','最小库存');
define('TEXT_PRODUCT_RATE','商品汇率');
...
define('CATEGORY_ROMAN_CHARACTER_ERROR', '无法注册的罗马字有半角记号。请删除或者换成半角连字符。');
define('CATEGORY_PIC_DEL_SUCCESS_NOTICE', '成功删除图像');
define('IMAGE_REVIEWS', '评论');
define('CATEGORY_PRICE_TEXT', '价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格');
define('URL_WORD_DOUBLE_CHECK','重复检查');
define('IS_SET_ERROR_CHAR','文字列检查');
define('CATEGORY_PHONETIC_CHARACTERS', '片假名:');
define('CATEGORY_ALPHA_ROMAN', '英数字:');
...
define('TEXT_CATEGORY_ROMAN', '罗马字:');
...
define('CATEGORY_BUTTON_WHOLESALER_PRICE', '批发商单价设置');
...
define('TABLE_HEADING_UNIVALENT_TEXT','单价（日元）');
...
define('TEXT_PRODUCT_INVENTORY_INFO','<table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td colspan="2">可以使用的计算符号：+　-　*　/　()</td></tr><tr><td colspan="2">可以使用的参数：</td></tr><tr><td width="52%">商品单价：$unit_price</td><td>关联商品单价：$related_unit_price</td></tr><tr><td>实际库存的平均价格：$stocks_average_cost</td><td>商品最近的订单数：$recent_ordered_number_of_unit</td></tr><tr><td>关联商品最近的订单数：$recent_ordered_number_of_related_unit</td><td>关联商品库存：$related_unit_quantity</td></tr></table>');
