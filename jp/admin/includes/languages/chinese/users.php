...
define('TEXT_ERRINFO_USER_DELETE', '删除客户信息:无法删除用户本人的信息');
define('TEXT_ERRINFO_USER_GRANT', '给予权限:请选择用户');
define('TEXT_ERRINFO_USER_REVOKE', '取消权限:请选择用户');
define('TEXT_ERRINFO_USER_REVOKE_ONESELF', '取消权限:无法取消用户本人的权限');
define('TEXT_ERRINFO_CONFIRM_PASSWORD', '再次输入确认:确认的结果是再次输入的密码有误');
...
define('TEXT_ERRINFO_USER_STAFF', '给予权限:请选择Staff');
define('TEXT_ERRINFO_USER_CHIEF', '取消权限:请选择Chief');
define('TEXT_ERRINFO_USER_ADMIN', '取消权限:请选择Admin');
