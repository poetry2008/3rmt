...
define('TABLE_HEADING_DATE_PURCHASED', '订单日期');
define('TABLE_HEADING_STATUS', '状态');
define('TABLE_HEADING_ACTION', '操作');
define('TABLE_HEADING_QUANTITY', '数量');
define('TABLE_HEADING_PRODUCTS_MODEL', '型号');
define('TABLE_HEADING_PRODUCTS', '数量 / 商品名称');
...
define('TABLE_HEADING_DATE_ADDED', '受理日期');

define('ENTRY_CUSTOMER', '顾客名:');
define('ENTRY_SOLD_TO', '订购人姓名:');
!defined('ENTRY_STREET_ADDRESS') && define('ENTRY_STREET_ADDRESS', '地址１:');
!defined('ENTRY_SUBURB')          && define('ENTRY_SUBURB', '地址２:');
!defined('ENTRY_CITY')            && define('ENTRY_CITY', '省市县:');
!defined('ENTRY_POST_CODE')       && define('ENTRY_POST_CODE', '邮政编码:');
!defined('ENTRY_STATE')           && define('ENTRY_STATE', '省市区:');
!defined('ENTRY_COUNTRY')         && define('ENTRY_COUNTRY', '国家名:');
!defined('ENTRY_TELEPHONE')       && define('ENTRY_TELEPHONE', '电话号码:');
!defined('ENTRY_EMAIL_ADDRESS')   && define('ENTRY_EMAIL_ADDRESS', '邮箱地址:');
define('ENTRY_DELIVERY_TO', '配送地址:');
define('ENTRY_SHIP_TO', '配送地址:');
define('ENTRY_SHIPPING_ADDRESS', '配送地址:');
define('ENTRY_BILLING_ADDRESS', '顾客地址:');
...
define('ENTRY_CREDIT_CARD_EXPIRES', '信用卡有限期限:');
...
define('EMAIL_TEXT_INVOICE_URL', '订单信息在下面的url中显示。' . "\n");
...
define('TEXT_CAN_NOT_SHOW','担保变为完成时显示');
define('TEXT_NOT_SHOW','不显示吗？');
define('TEXT_TELECOM_FINISH','完成');
define('TEXT_TELECOM_UNFINISH','未完成');
define('TEXT_TELECOM_SUCCESS','成功');
define('TEXT_TELECOM_UNSUCCESS','失败');
define('TEXT_PAYPAL','PAYPAL');
define('TEXT_TELECOM','TELECOM');
