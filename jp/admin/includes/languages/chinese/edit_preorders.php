...
define('EDIT_ORDERS_PAYMENT_METHOD_READ', '<table><tr class="smalltext"><td><font color="red">※</font>&nbsp;更改:</td><td>银行转账</td><td>信用卡结算</td><td>银行转账(买入)</td><td>邮政银行（邮局）</td><td>便利店结算</td></tr></table>');
