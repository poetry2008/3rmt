...
define('TEXT_DELETE_INTRO', '确定要删除这个顾客?');
define('TEXT_DELETE_REVIEWS', '评论也删除（投稿数: %s ）');
define('TEXT_INFO_HEADING_DELETE_CUSTOMER', '删除顾客');
define('TYPE_BELOW', '请在下面输入');
define('PLEASE_SELECT', '请选择');

//Add Point System
define('CATEGORY_POINT', '点数');
define('ENTRY_POINT', '现在的点数');

define('TABLE_HEADING_MEMBER_TYPE', '会员类型');
define('TABLE_HEADING_MEMBER_TYPE_GUEST', '非会员');
define('TABLE_HEADING_MEMBER_TYPE_MEMBER', '会员');

define('ERROR_EMAIL_EXISTS', '邮箱地址已经存在。');
define('BUTTON_CUSTOMERS_PRODUCTS_TEXT', '商品历史记录');
define('CUSTOMER_COMMUNITY_TEXT', '该公司使用栏');
define('CUSTOMER_COMMUNITY_SEARCH_TEXT', '信用调查');
...
define('TEXT_ONCE_AGAIN_PASSWORD','再次输入密码');
...
define('CUSTOMERS_SEARCH_FRONT_TEXT', '字符串1');
define('CUSTOMERS_SEARCH_END_TEXT', '字符串2');
define('CUSTOMERS_SEARCH_OPTION_TEXT', '搜索对象');
define('CUSTOMERS_SEARCH_OPTION_NAME', '顾客名');
define('CUSTOMERS_SEARCH_OPTION_MAIL', '邮箱地址');
define('CUSTOMERS_SEARCH_OTHER_TEXT', '其他');
define('CUSTOMERS_SEARCH_TYPE_TEXT', '不区分大小写');
define('CUSTOMERS_SEARCH_CHARACTER_TEXT', '不区分全角半角');
define('CUSTOMERS_SEARCH_BLANK_TEXT', '过滤空白或换行');
define('CUSTOMERS_SEARCH_CONDITION_TEXT', '选择条件');
define('CUSTOMERS_SEARCH_OR_TEXT', '或者');
...
define('TEXT_CUSTOMERS_CSV_OUTPUT','导出');
define('TEXT_DOWNLOAD_INFO','将要下载顾客信息。');
define('TEXT_DOWNLOAD','下载了顾客信息。');
define('TEXT_HANDLE','该操作已经被记录了。 如果要继续，请点击【OK】');
define('TEXT_ONE_PASSWORD','权限的一次性密码:%s。下载了顾客信息。');
