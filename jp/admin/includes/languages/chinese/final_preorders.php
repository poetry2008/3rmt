...
define('EDIT_ORDERS_FINAL_CONFIRM_TEMPLATE', '<table cellspacing="0" cellpadding="2" width="100%"><tr class="smalltext"><td valign="top" colspan="3"><font color="red">※</font>&nbsp;复制粘贴用的短语。可以点三下或全选。</td></tr> <tr bgcolor="#999999" class="smalltext"><td>商品的更改</td><td>支付方式的更改（出售用）</td><td>支付方式的更改（出售用）</td></tr> <tr bgcolor="#cccccc" class="smalltext"> <td valign="top">交易人物名为【】。</td> <td valign="top"> 请转入下述的金融机构。<br> ------------------------------------------<br> 银行名称　　：　日本网上银行<br> 分店名　　：　总店销售部<br> 账户类别　：　普通<br> 账户名　　：　1,2,3,4,5,6）iimy<br> 账户号　：　1164394<br> ------------------------------------------<br> 银行名称　　：　Ebank银行<br> 分店名　　：　华尔兹分店<br> 分店号　：　204<br> 账户名　　：　1,2,3,4,5,6）iimy<br> 账户号　：　7003965<br> ------------------------------------------<br> ※ 请务必存入到预约时所填写账户姓名里。<br> ※ 转账手续费由客户承担。<br> ※ 转账需要在预约后7日内进行。<br> ※ iimy有限公司确认到款后合同生效。 </td> <td valign="top"> 约10分钟后，会通过邮件和您联系，将客户专用的信用卡结算URL发送到您的邮箱里<br> <br> 请点击邮件正文里的URL，完成信用卡结算<br>  </td> </tr> </table>');
