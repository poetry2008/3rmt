...
define('TEXT_PW_MANAGER_SELECT_ACTION','请选择');
define('TEXT_PW_MANAGER_DELETE_ACTION', '删除勾选项目');
define('TEXT_PW_MANAGER_MUST_SELECT','请至少选择一项');
define('TEXT_DEL_PW_MANAGER','确定要删除吗？');
