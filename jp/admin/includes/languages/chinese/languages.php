...
define('HEADING_TITLE', '语言设置');

define('TABLE_HEADING_LANGUAGE_NAME', '语言');
define('TABLE_HEADING_LANGUAGE_CODE', '代码');
define('TABLE_HEADING_ACTION', '操作');

define('TEXT_INFO_EDIT_INTRO', '请加上必要的变更');
define('TEXT_INFO_LANGUAGE_NAME', '语言名:');
...
define('TEXT_INFO_INSERT_INTRO', '请输入新语言及数据');
define('TEXT_INFO_DELETE_INTRO', '确定要删除这个语言吗?');
...
define('ERROR_REMOVE_DEFAULT_LANGUAGE', '错误:不能删除默认语言。把其他的语言设为默认再操作一遍。');
?>
