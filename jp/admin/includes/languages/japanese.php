...
define('TEXT_DISPLAY_NUMBER_OF_SEARCH', '<b>%d</b> &sim; <b>%d</b> 番目を表示 (<b>%d</b> の顧客情報のうち)');
...
define('TEXT_IMAGE_MAX','アップロードされた画像が最大値を超えました。再度アップロードしてください。');
define('TEXT_IMAGE_TYPE_WRONG','無効なファイル形式です。');
define('WARNING_LOSING_INFO_TEXT', 'データが不完全な為、エラーが発生しました。再度操作をしてください。');
define('TEXT_ERROR_NULL','&nbsp;&nbsp;<font color=\'red\'>入力してください。</font>');
define('TEXT_DATA_MANAGEMENT','データ管理');
...
define('ERROR_AVG_MESSAGE_PRODUCT','%sが現在庫の平均原価（%s円）を下回っています。<br> ');
define('ERROR_AVG_MESSAGE_END','<br>%s<br>何が起きていて何が問題なのか理解できているのであれば、上記チェックボックスを選択し、[ OK ]をクリック してください。<br><br>');
...
define('TEXT_PAYMENT_NAME_ERROR','本注文書に使用されている支払方法（#PAYMENT_METHOD）は、このシステムから削除されました。');
...
define('TEXT_INFO_STATUS_IN', 'a:認証,e:DBエラー,p:Passwordエラー,n:失敗,r:IP制限');
