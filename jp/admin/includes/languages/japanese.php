...
define('IMAGE_NEW_MANUFACTURERS','新規作成');
define('IMAGE_NEW_ORDERS_STATUS','新規作成');
define('IMAGE_NEW_PREORDERS_STATUS','新規作成');
define('IMAGE_CONTENTS_NEW','新規作成');
define('IMAGE_NEW_POINT_EMAIL','新規作成');
define('IMAGE_NEW_BANNER', '新規作成');
...
define('IMAGE_NEW_NEWSLETTER', '新規作成');
