...
define('ERROR_CACHE_DIRECTORY_NOT_WRITEABLE', 'エラー: キャッシュ・ディレクトリに書き込みができません。正しいユーザー権限を設定してください。');
define('CSS_RANDOM_STRING','cssランダム化可：');
define('CSS_RANDOM_INFO','（説明：この拡張子を添加して各サイトのcss文書を1つのパラメータは、更新CSSファイルの目的を達成する。）');
