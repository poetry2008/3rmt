...
define('ERROR_FILE_NOT_WRITEABLE', 'エラー: このファイルに書き込みできません。正しいユーザー権限を %s に設定してください。');
define('ERROR_DIRECTORY_NOT_REMOVEABLE', 'エラー: このディレクトリを削除できません。正しいユーザー権限を %s に設定してください。');
define('ERROR_FILE_NOT_REMOVEABLE', 'エラー: このファイルを削除できません。正しいユーザー権限を %s に設定してください。');
