...
define('HEADING_TITLE', 'オンラインユーザー');
...
define('TABLE_HEADING_LAST_CLICK', '最終のクリック');
define('TABLE_HEADING_LAST_PAGE_URL', '最終のURL');
define('TABLE_HEADING_ACTION', '操作');
define('TABLE_HEADING_SHOPPING_CART', 'ユーザーのショッピングカート');
