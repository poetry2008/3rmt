...
define('TEXT_INFO_EDIT_ZONE_INTRO', '必要な変更を加えてください');

define('TEXT_INFO_HEADING_DELETE_ZONE', '地域を削除');
define('TEXT_INFO_DELETE_ZONE_INTRO', '本当にこの地域を削除しますか?');

define('TEXT_INFO_HEADING_NEW_SUB_ZONE', '新しい副地域');
define('TEXT_INFO_NEW_SUB_ZONE_INTRO', '新しい副地域の情報を入力してください');

define('TEXT_INFO_HEADING_EDIT_SUB_ZONE', '副地域を編集');
define('TEXT_INFO_EDIT_SUB_ZONE_INTRO', '必要な変更を加えてください');

define('TEXT_INFO_HEADING_DELETE_SUB_ZONE', '副地域を削除');
define('TEXT_INFO_DELETE_SUB_ZONE_INTRO', '本当にこの副地域を削除しますか?');
...
define('TEXT_ALL_COUNTRIES', '全ての国名');
?>
