...
define('USER_INFO_NO_ONETIME_PWD_READ', 'ワンタイムパスワード作成可能数の上限に達しました。<br>このユーザーに追加したい場合は、既存のワンタイムパスワードのいずれかを削除してください。');
define('USER_INFO_IP_LIMIT_TEXT', 'IP制限されない設置');
define('USER_INFO_IP_WARN_EMAIL_TEXT', '警告メール除外リスト');
