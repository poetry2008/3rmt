...
define('TEXT_PREORDERS_TRANSACTION_FINISH', '予約終了');
...
define('TEXT_ORDER_FIND_MAIL_ADD','メールアドレスからの検索');
...
define('TEXT_ORDER_ORDER_DATE','有効期限');
...
define('PREORDERS_PAYMENT_METHOD_PRE', '支払方法「');
