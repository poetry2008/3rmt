...
define('HEADING_TITLE', 'メーカー登録');

define('TABLE_HEADING_MANUFACTURERS', 'メーカー名');
...
define('TEXT_DELETE_PRODUCTS', 'このメーカーから商品を削除しますか？（商品レビュー、特価商品、入荷予定商品も含みます。）');
define('TEXT_DELETE_WARNING_PRODUCTS', '<b>警告:</b> このメーカーにリンクされている商品が %s 個あります。');
...
define('TEXT_PLEASE_MANUFACTURERS_NAME','&nbsp;&nbsp;<font color=\'red\'>メーカー名を入力してください。</font>');
