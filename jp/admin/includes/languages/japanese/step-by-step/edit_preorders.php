...
//define('HEADING_TITLE', '予約の編集・詳細');
define('HEADING_TITLE_NUMBER', '予約番号:');
define('HEADING_TITLE_DATE', ' - ');
define('HEADING_SUBTITLE', '編集したい部分の内容を入力し、更新ボタンをクリックしてください。');
//define('HEADING_TITLE_SEARCH', '予約 ID:');
...
//define('TEXT_INFO_HEADING_DELETE_ORDER', '予約を削除');
//define('TEXT_INFO_DELETE_INTRO', '本当に予約を削除しますか？');
...
//define('TEXT_ALL_ORDERS', '全ての予約');
//define('TEXT_NO_ORDER_HISTORY', '予約は存在しません。');
...
//define('EMAIL_TEXT_DATE_ORDERED', '予約日:');
...
define('MENUE_TITLE_ORDER', '3. 予約商品');
