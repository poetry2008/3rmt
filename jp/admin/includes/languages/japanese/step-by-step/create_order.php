...
define('ADDPRODUCT_TEXT_CATEGORY_SELECTION', ' &laquo; カテゴリ選択. ');
define('ADDPRODUCT_TEXT_PRODUCT_SELECTION', ' &laquo; 商品選択. ');
...
define('PRODUCTS_WEIGHT_ERROR_TOTAL_WEIGHT','総重量が（');
define('PRODUCTS_WEIGHT_ERROR_EXCESS_WEIGHT','）の規定の重量を超えました。');
define('PRODUCTS_WEIGHT_ERROR_DELETE_OR_NUMBER','商品を削除するか、または個数を変更して（');
define('PRODUCTS_WEIGHT_ERROR_PLEASE_SET_KG','）kg以内にしてください。');
