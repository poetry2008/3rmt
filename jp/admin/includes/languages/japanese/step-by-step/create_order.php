...
define('CREATE_ORDER_BANK_KAMOKU_TEXT', '口座種別:');
define('CREATE_ORDER_BANK_KOUZA_NUM_TEXT', '口座番号:');
...
define('CREATE_ORDER_FETCH_TIME_TITLE_TEXT', '届け時間');
define('CREATE_ORDER_FETCH_DATE_TEXT', '届け日時:');
