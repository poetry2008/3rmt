...
define('TEXT_DISPLAY_NUMBER_OF_BULLETIN_BOARD', '<b>%d</b> &sim; <b>%d</b>番目を表示(<b>%d</b>の掲示のうち)');
define('TEXT_DISPLAY_NUMBER_OF_BULLETIN_BOARD_REPLY', '<b>%d</b> &sim; <b>%d</b>番目を表示(<b>%d</b>の書込みのうち)');
define('TEXT_BACK','戻る');
define('TEXT_CREATE_BULLETIN','掲示作成');
