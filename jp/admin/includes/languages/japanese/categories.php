...
define('TEXT_PRODUCTS_REAL_QUANTITY', '在庫数');
...
define('TEXT_INFO_HEADING_NEW_CATEGORY', 'カテゴリ作成');
...
define('TEXT_CATEGORIES_IMAGE', 'カテゴリバナー画像');
...
define('TEXT_ROMAN_EXISTS', ' ローマ字が存在しています');
define('TEXT_PRODUCTS_ROMAN', 'url words');
define('TEXT_ROMAN_ERROR', 'ローマ字の格式が正しくないです!');
define('TEXT_ROMAN_NOT_NULL', 'ローマ字を書いてください!');
...
define('TEXT_PRODUCT_DESC_HTML_READ','HTMLによる入力可<br>パラメータ　サイト名：${SITE_NAME}');
...
define('CATEGORY_SEO_TITLE_TEXT', 'メタのタイトル');
define('CATEGORY_SEO_DES_TEXT', 'メタの説明文');
define('CATEGORY_HEADER_TEXT', 'カテゴリ内の商品リスト<br>の説明文上');
define('CATEGORY_FOOTER_TEXT', 'カテゴリ内の商品リスト<br>の説明文下');
define('CATEGORY_TEXT_INFO_TEXT', 'カテゴリ説明文内容');
...
define('CATEGORY_ROMAN_ERROR_NOTICE', 'ローマ字に登録できない半角記号があります。削除するか半角ハイフンに置き換えてください。');
...
define('CATEGORY_CHARACTER_ROMAN', 'カタカナ');
