...
define('TEXT_PRODUCTS_LETTERS', 'ローマ字:');
define('TEXT_LETTERS_ERROR', 'ローマ字の格式が正しくないです!');
define('TEXT_LETTERS_NOT_NULL', 'ローマ字を書いてください!');
...
define('CATEGORY_LETTERS_ERROR_NOTICE', 'ローマ字に登録できない半角記号があります。削除するか半角ハイフンに置き換えてください。');
...
define('CATEGORY_PHONETIC_LETTERS', 'カタカナ:');
...
define('TEXT_CATEGORY_LETTERS', 'ローマ字:');
