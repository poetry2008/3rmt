...
define('TEXT_ROMAJI_EXISTS', ' URL_WORDSが存在しています');
define('TEXT_ROMAJI_ERROR', 'URL_WORDSの格式が正しくないです!');
define('TEXT_ROMAJI_NOT_NULL', 'URL_WORDSを書いてください!');
...
define('TEXT_PRODUCT_DESC_HTML_READ','HTMLによる入力可<br>パラメータ　サイト名：#STORE_NAME#');
...
define('CATEGORY_BUTTON_XIEYE_PRICE', '卸業者単価設定');
