...
define('TEXT_PRODUCTS_AVERAGE_RATING', '顧客評価の平均点');
define('TEXT_PRODUCTS_QUANTITY_INFO', '数量:');
define('TEXT_PRODUCTS_REAL_QUANTITY', '実在庫:');
define('TEXT_PRODUCTS_VIRTUAL_QUANTITY_TEXT', '架空在庫:');
define('TEXT_PRODUCTS_REAL_QUANTITY_TEXT', '実在庫');
define('TEXT_PRODUCTS_QUANTITY_TEXT', '在庫');
...
define('TEXT_ROMAN_CHARACTERS_EXISTS', ' ローマ字が存在しています');
define('TEXT_PRODUCTS_URL_WORD', 'ローマ字:');
define('TEXT_ROMAN_CHARACTERS_ERROR', 'ローマ字の格式が正しくないです!');
define('TEXT_ROMANIZATION_NOT_NULL', 'ローマ字を書いてください!');
define('TEXT_MAX','在庫最大');
define('TEXT_MIN','在庫最小');
define('TEXT_PRODUCT_RATE','商品レート');
...
define('TEXT_PRODUCT_ADDORSUB_VALUE', '増減');
...
define('TABLE_HEADING_PRICE_TEXT', '価格');
define('TABLE_HEADING_NUM_TEXT', '数量');
define('CATEGORY_PRO_NO_STOCK_TEXT', '在庫切れ');
...
define('CATEGORY_INSERT_IMAGE_READ', '<font color="red">画像がない場合はテキスト表示されます</font>');
define('CATEGORY_META_TAG_TEXT', 'METAタグ');
define('CATEGORY_META_TAG_READ_TEXT', '（この説明文はトップページのカテゴリバナーの下に表示される文章としても使用されます。2行にするにはカンマ「,」区切りで文章を記述してください。)');
...
define('CATEGORY_ROMAN_CHARACTER_ERROR', 'ローマ字に登録できない半角記号があります。削除するか半角ハイフンに置き換えてください。');
define('CATEGORY_PIC_DEL_SUCCESS_NOTICE', '画像削除に成功しました');
define('IMAGE_REVIEWS', 'レビュー');
define('CATEGORY_PRICE_TEXT', '価&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格');
define('URL_WORD_DOUBLE_CHECK','重複チェック');
define('IS_SET_ERROR_CHAR','文字列チェック');
define('CATEGORY_PHONETIC_CHARACTERS', 'カタカナ:');
...
define('TEXT_CATEGORY_ROMAN', 'ローマ字:');
...
define('TEXT_NO_ASSOCIATION','関連付けなし');
define('TEXT_ASSOCIATION','（関連付け）');
define('TEXT_LANGUAGE_JAPAN','日本語');
define('TEXT_LANGUAGE_CHINA','中国語(+400円)');
define('TEXT_LANGUAGE_KOREA','韓国語(-100円)');
define('TEXT_TEXT','テキスト：');
define('TEXT_WITH','関連付け: ');
define('TEXT_GOOGLE_SEARCH','はGOOGLEで%sがキーワードとしての検索結果');
define('TEXT_RENAME','リネーム');
define('TEXT_INFO_KEYWORD','キーワードを変更する');
define('TEXT_NO_SET_KEYWORD','キーワードを設置しない');
...
define('TEXT_FIND_DATA_STOP','%sをさがしましたが、表示を停止します。');
define('TEXT_NOT_ENOUGH_DATA','前からの&nbsp;50&nbsp;件検索結果に不重複な結果は&nbsp;%s&nbsp;件があります');
define('TABLE_HEADING_CATEGORIES_ORDER_NUM', '注文');
define('TABLE_HEADING_CATEGORIES_PREORDER_NUM', '予約');
define('TABLE_HEADING_CATEGORIES_PRODUCT_VIRTUAL_STORE', '入荷');
define('TABLE_HEADING_CATEGORIES_PRODUCT_REAL_QUANTITY', '在庫');
define('TABLE_HEADING_CATEGORIES_PRODUCT_BUYING', '仕入');
define('TABLE_HEADING_CATEGORIES_PRODUCT_NOW_PRICE', '単価');
define('TABLE_HEADING_CATEGORIES_PRODUCT_SETTING_PRICE', '単価設定');
define('TABLE_HEADING_CATEGORIES_PEER_PERSON_NO_SETTING', '同業者未設定');
define('PIC_MAE_ALT_TEXT_NODATA','注文履歴なし');
define('PIC_MAE_ALT_TEXT', '日前に注文有');
define('CATEGORY_BUTTON_CAL_SETTING', '計算設定');
define('CATEGORY_BUTTON_LOGIN', '担当者登録');
define('CATEGORY_BUTTON_WHOLESALER_PRICE', '卸業者単価設定');
define('CATEGORY_SHOW_SINGLE_PRICE_TEXT', '単価ルール:');
define('CATEGORY_INFORMATION_TITLE', 'カテゴリーの基本情報');
define('CATEGORY_BUTTON_ALL_UPDATE', '一括更新');
define('CATEGORY_PIC_TITLE', 'カテゴリーの画像');
...
define('TEXT_PRODUCTS_TAGS_SELECT','選択したものを');
define('TEXT_PRODUCTS_TO_TAGS','タグ関連を編集する');
define('TEXT_PRODUCTS_TAGS_DELETE','削除する');
define('TEXT_TAGS_MUST_SELECT', '少なくとも1つの選択肢を選んでください。');
define('TEXT_TAGS_DELETE_CONFIRM', '本当に選択した項目を削除しますか？');
...
define('TEXT_PRODUCT_ORDER_HISTORY','直近の流通数');
define('TEXT_PRODUCTS_ORDER_INFO','注文情報');
define('TABLE_HEADING_UNIVALENT_TEXT','単価（円）');
...
define('TEXT_PRODUCT_INVENTORY_INFO','<table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td colspan="2">使える計算式：+　-　*　/　()</td></tr><tr><td colspan="2">使えるパラメータ：</td></tr><tr><td width="52%">単価：$unit_price</td><td>関連商品単価：$related_unit_price</td></tr><tr><td>現在庫の平均原価：$stocks_average_cost</td><td>商品直近の流通数：$recent_ordered_number_of_unit</td></tr><tr><td>関連商品直近の流通数：$recent_ordered_number_of_related_unit</td><td>関連商品の在庫数：$related_unit_quantity</td></tr></table>');
define('JS_TEXT_C_ADMIN_RESET_DIFFERENCE','%の差額があります。再設定してください');
define('TEXT_INVENTORY_OR','または');
define('TEXT_INVENTORY_LINK','の');
define('TEXT_INVENTORY_SELECT_MAX','大きい方を値とする。');
define('TEXT_INVENTORY_SELECT_MIN','小さい方を値とする。');
