...
define('TEXT_ORDERS_SELECT_DATE','注文日');
define('TEXT_ORDERS_SELECT_STATUS','ステータス');
define('TEXT_SELECT_ASC','昇順');
define('TEXT_SELECT_DESC','降順');
define('TEXT_SAVE','保存');
define('TEXT_PREORDERS_SELECT_CUSTOMER','顧客名');
...
define('TEXT_PERSONAL_SETTING_LANGUAGE_OPTION','言語設定');
define('TEXT_PERSONAL_SETTING_SHOW_TRANSACTION_FINISH', '取引完了を表示');
define('TEXT_PERSONAL_SETTING_HIDE_TRANSACTION_FINISH', '取引完了を非表示');
?>
