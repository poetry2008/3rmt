...
define('TEXT_BUTTON_DELETE_ALL','全履歴削除');
define('TEXT_BUTTON_SHOW','プレビュー');
define('TEXT_BUTTON_BACK','戻る');
define('TEXT_NEXTDAT','スケジュール');
define('PW_MANAGER_SELECT_NONE', '--選択してください--');
define('PW_MANAGER_SELECT_ONE', '重');
define('PW_MANAGER_SELECT_TWO', 'LoginURL');
define('PW_MANAGER_SELECT_THREE', 'タイトル');
