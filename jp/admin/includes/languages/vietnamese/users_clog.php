<?php
// 页面标题
define('HEADING_TITLE', Log mật khẩu sử dụng một lần');

// 访问表错误信息
define('TEXT_ERRINFO_DB_NO_LOGINFO', 'Bạn đã không có được thông tin truy cập');
...
define('TEXT_INFO_STATUS_IN', 'a:Xác thực,e:DBLỗi,p:PasswordLỗi,n:Thất bại');
...
define('BUTTON_NEXT_PAGE', 'Trang sau');
...
define('TABLE_HEADING_ADDRESS', 'Đại chỉ');
