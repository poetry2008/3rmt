...
define('ENTRY_FIRST_NAME_F', '名(拼音):');
define('ENTRY_LAST_NAME_F', '姓(拼音):');
...
define('TELECOM_UNKNOW_TABLE_CAL', '支付');
define('TELECOM_UNKNOW_TABLE_DISPLAY','整体不显示');
//==================================================================
define('TELECOM_UNKNOW_TABLE_YIN', '关联');
...
define('TEXT_ORDER_ALARM_LINK', '提醒');
define('HOUR_TEXT', '时');
define('MINUTE_TEXT', '分');
define('NOTICE_EXTEND_TITLE', '备忘录');
define('NOTICE_ALARM_TITLE', '提醒');
...
define('BOX_CREATE_ADDRESS', '配送国别地区设置');
...
define('SIGNAL_RED', '红');
define('NOW_TIME_TEXT', '和现在时间比');
define('NOW_TIME_LINK_TEXT', '小时前');
...
define('TEXT_HEADER_NOTICE_ACCIDENT_HAPPEN', '发生线路故障： ');
define('TEXT_HEADER_NOTICE_CLICK_CONFIRM_LINK', '这里');
define('TEXT_HEADER_NOTICE_CLICK_CONFIRM', '点击后确认。');
define('TEXT_HEADER_NOTICE_ACCIDENT_HAPPEN_FINAL_DAY', '发生线路故障的最后一天： ');
define('TEXT_HEADER_NOTICE_SYSTEM_CONDITION', '系统运行情况：正常');
...
define('JS_TEXT_NOTICE_INPUT_TITLE','请输入标题');
...
define('TEXT_MONTH_JANUARY','1月');
define('TEXT_MONTH_FEBRUARY','2月');
define('TEXT_MONTH_MARCH','3月');
define('TEXT_MONTH_APRIL','4月');
define('TEXT_MONTH_MAY','5月');
define('TEXT_MONTH_JUNE','6月');
define('TEXT_MONTH_JULY','7月');
define('TEXT_MONTH_AUGUST','8月');
define('TEXT_MONTH_SEPTEMBER','9月');
...
define('TEXT_INFO_STATUS_IN', 'a:认证,e:DB错误,p:Password错误,n:已阻止,r:限制IP');
