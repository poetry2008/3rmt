...
define('CL_TEXT_DATE_MONDAY', 'Thứ hai');
define('CL_TEXT_DATE_TUESDAY', 'Thứ ba');
define('CL_TEXT_DATE_WEDNESDAY', 'Thứ tư');
define('CL_TEXT_DATE_THURSDAY', 'Thứ năm');
define('CL_TEXT_DATE_FRIDAY', 'Thứ sáu');
define('CL_TEXT_DATE_STATURDAY', 'Thứ bảy');
define('CL_TEXT_DATE_SUNDAY', 'Chủ nhật');
