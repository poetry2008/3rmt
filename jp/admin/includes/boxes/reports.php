...
?>
    ...
    <?php 
    if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link('cal_info.php', '', 'NONSSL')){
    ...
    if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link(FILENAME_STATS_SALES_REPORT2, '', 'NONSSL')){
    ...
    if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link(FILENAME_ASSETS, '', 'NONSSL')){
   ...
   if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, '', 'NONSSL')){
   ...
   if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link(FILENAME_STATS_PRODUCTS_PURCHASED, '', 'NONSSL')){
   ...
   if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link(FILENAME_STATS_CUSTOMERS, '', 'NONSSL')){
   ...
   if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link('referer.php')){
   ...
   if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link('keywords.php')){
   ...
   if(HTTP_SERVER.$_SERVER['PHP_SELF'] == tep_href_link(FILENAME_NEW_CUSTOMERS, '', 'NONSSL')){
