...
?>
    ...
    <?php 
    echo '<span class="menuBoxContent_image">'.tep_image(DIR_WS_MENU_ICON . 'icon_category.gif').'</span><span class="menuBoxContent_span"><a href="' . tep_href_link(FILENAME_CATEGORIES, '', 'NONSSL') . '" class="menuBoxContent_Link">' . BOX_CATALOG_CATEGORIES_PRODUCTS . '</a></span><br><span class="menuBoxContent_image">' .
			tep_image(DIR_WS_MENU_ICON . 'icon_delete_option.gif').'</span><span class="menuBoxContent_span"><a href="' . tep_href_link(FILENAME_SHOW_USELESS_OPTION, '', 'NONSSL') . '" class="menuBoxContent_Link">' . BOX_CATALOG_SHOW_USELESS_OPTION . '</a></span><br><span class="menuBoxContent_image">' .
                                   ...
                                   tep_image(DIR_WS_MENU_ICON . 'icon_products_tags.gif').'</span><span class="menuBoxContent_span"><a href="' . tep_href_link('products_tags.php', '', 'NONSSL') . '" class="menuBoxContent_Link">'.FILENAME_PRODUCTS_TAGS_TEXT.'</a></span><br><span class="menuBoxContent_image">' .
																	 tep_image(DIR_WS_MENU_ICON . 'icon_maker.gif').'</span><span class="menuBoxContent_span"><a href="' . tep_href_link(FILENAME_MANUFACTURERS, '', 'NONSSL') . '" class="menuBoxContent_Link">' . BOX_CATALOG_MANUFACTURERS . '</a></span><br><span class="menuBoxContent_image">'.
                                    (isset($_color_l)?$_color_l:'') .
                                  ...
                                  // tep_href_link(FILENAME_PRODUCTS_EXPECTED, '',
                                   //  'NONSSL') . '" class="menuBoxContent_Link">' .
                                   //BOX_CATALOG_PRODUCTS_EXPECTED . '</a><br>'.
                                   tep_image(DIR_WS_MENU_ICON . 'icon_wholesaler.gif').'</span><span class="menuBoxContent_span"><a href="'.tep_href_link('cleate_oroshi.php', '', 'NONSSL').'"
																	 class="menuBoxContent_Link">'.FILENAME_CLEATE_OROSHI_TEXT.'</a></span><br><span class="menuBoxContent_image">'.
																		 tep_image(DIR_WS_MENU_ICON . 'icon_peer.gif').'</span><span class="menuBoxContent_span"><a href="'.tep_href_link('cleate_dougyousya.php', '', 'NONSSL').
                                   '"class="menuBoxContent_Link">'.FILENAME_CLEATE_DOUGYOUSYA_TEXT.'</a></span><br><span class="menuBoxContent_image">'.
                                   tep_image(DIR_WS_MENU_ICON . 'icon_price.gif').'</span><span class="menuBoxContent_span"><a href="'.tep_href_link(FILENAME_CATEGORIES_ADMIN,'','NONSSL').'"
                                   class="menuBoxContent_Link">'.FILENAME_CATEGORIES_ADMIN_TEXT.
                                     '</a></span><br><span class="menuBoxContent_image">'.
                                   tep_image(DIR_WS_MENU_ICON . 'icon_address.gif').'</span><span class="menuBoxContent_span"><a href="'.tep_href_link('address.php','','NONSSL').'"
                                   class="menuBoxContent_Link">'.BOX_CREATE_ADDRESS.'</a></span><br><span class="menuBoxContent_image">
                                   '.tep_image(DIR_WS_MENU_ICON . 'icon_charge.gif').'</span><span class="menuBoxContent_span"><a href="'.tep_href_link('country_fee.php','','NONSSL').'"
                                   class="menuBoxContent_Link">'.BOX_COUNTRY_FEE.'</a></span><br><span class="menuBoxContent_image">
                                   '.tep_image(DIR_WS_MENU_ICON . 'icon_delivery_time.gif').'</span><span class="menuBoxContent_span"><a href="'.tep_href_link('products_shipping_time.php','','NONSSL').'"
