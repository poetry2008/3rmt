...
<!-- catalog -->
          <tr>
            ...
            <table cellspacing="0" cellpadding="2" border="0" width="150"> 
              ...
              &nbsp;<span><?php echo tep_image(DIR_WS_MENU_ICON . 'icon_catalog.gif'); ?></span><span><a class="menuBoxHeading_Link" href="javascript:void(0);" onclick="toggle_lan('col2');"><?php echo BOX_HEADING_CATALOG;?></a></span>
              &nbsp; 
              </td>
              </tr>
            </table> 
