...
?>
     ...
     tep_image(DIR_WS_MENU_ICON . 'icon_pic_manager.gif').'</span><span class="menuBoxContent_span" ><a class="menuBoxContent_Link" href="' .  tep_href_link(FILENAME_PIC_MANAGER_LIST) . '">' . BOX_TOOLS_PIC_MANAGER . '</a></span><br><span class="menuBoxContent_image">' . 
