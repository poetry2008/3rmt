...
?>
     ...
     tep_image(DIR_WS_MENU_ICON . 'icon_mark.gif').'</span><span class="menuBoxContent_span" ><a class="menuBoxContent_Link" href="' .  tep_href_link(FILENAME_MARKS) . '">' . BOX_TOOLS_MARKS_MANAGER . '</a></span><br><span class="menuBoxContent_image">' . 
