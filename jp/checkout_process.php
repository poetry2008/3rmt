...
//------insert customer choosen option eof ----
	...
	/*
	$add_products_query = tep_db_query("select products_description from ".TABLE_PRODUCTS_DESCRIPTION." where products_id = '".$order->products[$i]['id']."' and language_id = '" . $languages_id . "'");
	if(tep_db_num_rows($add_products_query)) {
	  ...
	  $description = $add_products['products_description'];
