<?php
/*
  $Id: tax_rates.php,v 1.3 2003/03/03 16:10:29 hawk Exp $
...
define('TEXT_INFO_LAST_MODIFIED', '変更日:');
...
define('TEXT_INFO_TAX_RATE_PRIORITY', '優先順位:');
define('TEXT_INFO_RATE_DESCRIPTION', '説明:');
define('TEXT_INFO_INSERT_INTRO', '新しい税率とそれに関連するデータを入力してください');
define('TEXT_INFO_DELETE_INTRO', '本当にこの税率を削除しますか?');
