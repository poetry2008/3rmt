<?php
/*
  $Id: reviews.php,v 1.3 2003/03/03 16:10:29 hawk Exp $
...
define('TEXT_PRODUCTS_STATUS', 'ステータス:');
define('TEXT_PRODUCT_AVAILABLE', '掲載する');
define('TEXT_PRODUCT_NOT_AVAILABLE', '掲載しない');
