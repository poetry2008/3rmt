<?php
/*
  $Id: configuration.php,v 1.1.1.1 2003/02/20 01:03:52 ptosh Exp $
...
<?php
  ...
  if ($selected_box == 'configuration_ds') {
    $cfg_groups = '';
    $configuration_groups_query = tep_db_query("select configuration_group_id as cgID, configuration_group_title as cgTitle from " . TABLE_CONFIGURATION_DS_GROUP . " where visible = '1' order by sort_order");
