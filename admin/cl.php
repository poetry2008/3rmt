...
if($_POST['updata'] == 'on') {
	...
	tep_db_query("update ".TABLE_CALENDER." set cl_value='".$mm_1."' where cl_ym = '".$_POST['ymd']."'");
	
	$mm_2 = "";
	for($j=101; $j<132; $j++) {
	  $mm_2 .= $_POST[$j];
	}
	tep_db_query("update ".TABLE_CALENDER." set cl_value='".$mm_2."' where cl_ym = '".$_POST['ymd2']."'");
...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
		...
		//月のデータ取得
		$ymd = date("Ym", time());
		$calen_query = tep_db_query("select cl_value from ".TABLE_CALENDER." where cl_ym = '".$ymd."'");
		...
		$calen_query2 = tep_db_query("select cl_value from ".TABLE_CALENDER." where cl_ym = '".$ymd2."'");
