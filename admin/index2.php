...
*/
  ...
  $cat = array(array('title' => BOX_HEADING_CONFIGURATION,
			   ...
			   array('title' => 'サポート',
                     ...
                     'children' => array(array('title' => 'お問合せ', 'link' => tep_href_link('support_contact.php', 'selected_box=support')),
                                         array('title' => 'ログイン', 'link' => tep_href_link('support_login.php', 'selected_box=support')))));
...
<table width="700" height="100%" border="0" align="center" cellpadding="0" cellspacing="0" valign="middle">
  <tr>
    <td><table border="0" width="700" height="390" cellspacing="0" cellpadding="1" align="center" valign="middle">
      <tr bgcolor="#000000">
        <td><table border="0" width="100%" height="390" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td colspan="2" bgcolor="#F4FCFF"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
...
<?php
  ...
  $contents[] = array('params' => 'class="infoBox"',
                      'text'  => '<a href="https://www.designload.jp/_support/" target="_blank">' . BOX_ENTRY_SUPPORT_SITE . '</a><br>' .
                                 '<a href="https://www.designload.jp/_support/forum/" target="_blank">' . BOX_ENTRY_SUPPORT_FORUMS . '</a><br>' .
