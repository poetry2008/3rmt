...
?>
<table cellspacing="0" cellpadding="3" border="0" width="100%" class="infoBoxContents" summary="table">
  <tr>
    <td><img width="100%" height="1" alt="" src="images/pixel_trans.gif"></td>
  </tr>
  <tr>
    <td class="boxText_new01"><input type="text" class="input_text" style="width: 100% ! important;" value="" name="keywords"></td>
  </tr>
  <tr>
    <td align="right" class="boxText_new01"><input type="checkbox" style="text-align: right;" name="search_in_description" value="1"><?php echo TEXT_SEARCH_IN_DESCRIPTION;?></td>
  </tr>
  <tr>
    <td><img width="100%" height="1" alt="" src="images/pixel_trans.gif"></td>
  </tr>
...
?> </td> 
         	...
         	<h2 class="pageHeading"><span class="game_t"><?php echo HEADING_SEARCH_HELP; ?></span></h2>
            <div class="comment">
