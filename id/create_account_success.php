  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
	  ...
	  <span class="game_t"><?php echo HEADING_TITLE ; ?></span>
        ...
        <tr>
          <td align="right"><?php echo '<a href="' . $origin_href . '">' . tep_image_button('button_continue_02.gif', IMAGE_BUTTON_CONTINUE1) . '</a>'; ?></td>
        </tr>
            <tr> 
        ...
        <tr>
          <td align="right"><br><?php echo '<a href="' . $origin_href . '">' . tep_image_button('button_continue_02.gif', IMAGE_BUTTON_CONTINUE1) . '</a>'; ?></td>
        </tr>
      </table>
      </div>
      </td> 
