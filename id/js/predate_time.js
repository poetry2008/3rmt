...
function selectHour(start_time,end_time,hour,min_num,ele){
        ...
        for(h = 0;h < 24;h++){
          ...
          if(flag == true && h != hour){
              $("#hour"+h).css("background-color","#666666"); 
...
function check_out(num){
  ...
  if(style != 'none' && document.getElementById('shipping_time_id')){
      ...
      hour.style.backgroundColor = '#666666';
