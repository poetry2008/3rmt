    ...
    if (isset($_POST['hour'])){
      ...
      //} else if ($date && $hour && $minute && ($time < (time() - MINUTES * 60) or $time > (time() + (7*86400)))) {
        ...
        tep_order_status_change($order_id,17);
          ...
          // ccdd
          tep_db_query($sql);
        echo '<div class="comment">'.TEXT_CHANGE_ORDER_CONFIRM_EMAIL.' <div align="right"><a href="'.tep_href_link(FILENAME_DEFAULT).'"><img src="includes/languages/japanese/images/buttons/button_back_home.gif" width="62" height="21" alt="'.TEXT_BACK_TO_TOP.'" title="'.TEXT_BACK_TO_TOP.'"></a></div></div>';
...
<table class="information_box" summary="table" border="0" cellpadding="0" cellspacing="1">
 <tr>
 <th width="30%" bgcolor="#eeeeee"><?php echo TEXT_REORDER_OID_TITLE;?></th>
  <td bgcolor="#FFFFFF"><?php echo $order['orders_id']?></td>
 </tr>
 <tr>
 ...
 <th bgcolor="#eeeeee"><?php echo TEXT_REORDER_EMAIL_TITLE;?></th>
  <td bgcolor="#FFFFFF"><?php echo $order['customers_email_address']?></td>
 </tr>
 <tr>
...
?>
 <tr>
 <th bgcolor="#eeeeee" width="30%"><?php echo TEXT_REORDER_TRADE_CHANGE;?></th>
  <td bgcolor="#FFFFFF">
...
<?php foreach($o->products as $key => $value){
  ...
  ?>
<br>
<table background="0" cellpadding="0" cellspacing="1" class="information_table" id='product_<?php echo $value['id'];?>' summary="table">
 <tr>
 <th width="30%" bgcolor="#eeeeee"><?php echo TEXT_REORDER_P_PRODUCT_NAME;?></th>
...
<tr>
<th width="30%" bgcolor="#eeeeee"><?php echo TEXT_REORDER_COMMENT_TITLE;?></th>
...
<table class="information_table" summary="table" cellpadding="0" cellspacing="1">
 ...
 <th align="left"><b><?php echo TEXT_REORDER_OID_TITLE;?></b></th>
  ...
  <a href="<?php echo tep_href_link('reorder2.php');?>"><?php echo TEXT_REORDER_OID_FORGET;?></a><br >
  <font color='red' style='font-size:12px'><?php echo TEXT_REORDER_OID_TEXT_INFO;?></font>
  </td>
 </tr>
 <tr>
 <th align="left"><b><?php echo TEXT_REORDER_EMAIL_TITLE;?></b></th>
