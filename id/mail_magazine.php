...
<div class="body_shadow" align="center"> 
  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border" summary="box"> 
    <tr> 
      ...
      <div class="comment">
      <table border="0" align="center" cellpadding="0" cellspacing="0" summary="table" width="100%"> 
          <tr> 
            <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td> 
          </tr> 
          <tr> 
            <td>
            		<table border="0" cellspacing="0" cellpadding="2" align="center" summary="table" width="100%"> 
                      <tr> 
