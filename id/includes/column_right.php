...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 5px;" summary="reviews">
  <tr>
  <td align="center">
  <img width="171" height="27" alt="<?php echo TAKE_DAY;?>" src="images/design/reorder_right.gif" >
  <?php echo '<a href="'.tep_href_link('reorder.php').'"><img width="171"  alt="'.DELIVER_GOODS_FORM.'" src="images/design/reorder_right02.gif" ></a>';?>
  </td>
  </tr>
  </table>
  ...
  <tr>
  <td align="center">
  <a href="<?php echo tep_href_link(FILENAME_CONTACT_US,'','SSL') ;?>"><?php echo  tep_image(DIR_WS_IMAGES.'contact_us_img.gif',FOOTER_CONSULTATION) ?></a>
  </td>
  </tr>
  </table>
<?php
