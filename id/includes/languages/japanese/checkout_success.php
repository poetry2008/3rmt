...
define('TEXT_HEADER_INFO','<table width="100%" cellspacing="0" cellpadding="0" border="0"> <tbody><tr> <td width="20%"> <table width="100%" cellspacing="0" cellpadding="0" border="0"> <tbody><tr> <td width="50%" align="right"><img width="1" height="5" src="images/pixel_silver.gif" alt=""></td> <td width="50%"><img width="100%" height="1" src="images/pixel_silver.gif" alt=""></td> </tr> </tbody></table> </td> <td width="20%"><img width="100%" height="1" src="images/pixel_silver.gif" alt=""></td> <td width="20%"><img width="100%" height="1" src="images/pixel_silver.gif" alt=""></td> <td width="20%"><img width="100%" height="1" src="images/pixel_silver.gif" alt=""></td> <td width="20%"> <table width="100%" cellspacing="0" cellpadding="0" border="0"> <tbody><tr> <td width="50%"><img width="100%" height="1" src="images/pixel_silver.gif" alt=""></td> <td width="50%"><img src="images/checkout_bullet.gif" alt=""></td> </tr> </tbody></table> </td> </tr> <tr> <td width="20%" align="center" class="checkoutBarFrom">商品オプション</td> <td width="20%" align="center" class="checkoutBarFrom">配送方法</td> <td width="20%" align="center" class="checkoutBarFrom">支払方法</td> <td width="20%" align="center" class="checkoutBarFrom">最終確認</td> <td width="20%" align="center" class="checkoutBarCurrent">手続完了!</td> </tr> </tbody></table>');
