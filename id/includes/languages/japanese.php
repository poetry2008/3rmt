...
define('ENTRY_FIRST_NAME_TEXT', '&nbsp;<small>(例. 太郎) <font color="#A85E5E">必須</font></small>');
...
define('ENTRY_LAST_NAME_TEXT', '&nbsp;<small>(例. 田中) <font color="#A85E5E">必須</font></small>');
...
define('ENTRY_EMAIL_ADDRESS_TEXT', '&nbsp;<small>(例. sample@example.com) <font color="#A85E5E">必須</font></small>');
...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;<small>' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上&nbsp;(例. abcdef) <font color="#A85E5E">必須</font></small>');
define('ENTRY_PASSWORD_ERROR', '&nbsp;<small><font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;<small>' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上&nbsp;(例. abcdef) <font color="#A85E5E">必須</font></small>');
...
define('SENDMAIL_SUCCESS_TEXT', 'メールが送信されました。RMTアイテムデポからの受信をご確認ください。');
