...
*/
  ...
  if (isset($_GET['products_id'])) {
    ...
    $orders_sql = "
        select * from (select o.date_purchased, p.products_id, pd.site_id, pd.products_status  from " .  TABLE_ORDERS_PRODUCTS . " opa, " . TABLE_ORDERS_PRODUCTS . " opb, " .  TABLE_ORDERS . " o, " . TABLE_PRODUCTS . " p, ".TABLE_PRODUCTS_DESCRIPTION." pd where opa.products_id = '" .  (int)$_GET['products_id'] . "' 
