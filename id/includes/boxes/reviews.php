...
<?php
  if(basename($PHP_SELF) == FILENAME_PRODUCT_INFO){
    ...
    if(tep_db_num_rows($reviews_query)) {
      echo  '<div class="pageHeading_long02"><span class="game_im"><img width="26" height="26" src="images/design/title_img08.gif" alt=""></span><span class="game_t">'.$product_info['products_name'] .'のレビュー</span></div>'."\n" . '<div class="comment_long02">'."\n" ;
