...
<div class="login_inc_warpper">
    ...
    <table cellspacing="0" cellpadding="0"  border="0" class="open_login" align="center">
         <tr> 
            <td valign="top" class="open_login_info"><span>メールアドレス</span><input class="input_text" type="text" name="lemail" size="25" value="<?=$e?>"></td>
         </tr>
         <tr>   
            <td class="open_login_info"><span>お問い合わせ番号</span><input class="input_text" type="text" name="lticket" size="10" value="<?=$t?>"></td>
         </tr>
