      ...
      <td id="contents" valign="top">
        ...
        <?php if($_POST){
          ...
          if ($date && $hour && $minute && ($time < (time() - MINUTES * 60) or $time > (time() + (7*86400)))) {
            ...
            echo '<div class="comment">'.TEXT_CHANGE_ORDER_CONFIRM_EMAIL.' <div align="right"><a href="'.tep_href_link(FILENAME_DEFAULT).'"><img src="includes/languages/japanese/images/buttons/button_back_home.gif" width="62" height="21" alt="'.TEXT_TOP_CON.'" title="'.TEXT_TOP_CON.'"></a></div></div>';
