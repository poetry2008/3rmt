...
if(($url_array[$game][$flag][$site_array['site_id']]==$_GET['error_url'] && isset($_GET['error_url'])) || strpos($url_array[$game][$flag][$site_array['site_id']],$url_arr['host'])){
    ...
    if($site_array['site_id'] == 6 && in_array($game,array('FF11','DQ10','RS','L2'))){
