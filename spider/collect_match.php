...
$search_array_match = array(
	'buy'=> array(
        ...
        'www.iimy.co.jp'=> array('products_name'=>'<name>(.*?)の.*?<\/name>',
            ...
            'RO' => array(
				  'www.mugenrmt.com'=>array('border03 border04products_name'=>'<td height=\'24\' class=\'border03 border04\'>([a-zA-Z]+?)<\/td>',
                ...
                'rmtrank.com'=>array('products_name'=>'<td class="col0"><a href=".*?">(.*?)<\/a><\/td>',
        ...
        'RS'=>array(
            ...
            'www.asahi-rmt-service.com'=>  array('products_name'=>'<td class="left" style=".*?"><a href=".*?">(.*?)<\/a><\/td>',
              ...
              'www.rmt-king'=> array('products_name'=>'<tr .*?>.*?<td class="center" rowspan="4">(.*?)<\/td>',
      ...
      'FF11' =>  array(  
               ...
               'www.rmt-king'=>array('products_name'=>'<tr .*?>.*?<td class="center" rowspan="4">(.*?)<\/td>.*?<td class="center" rowspan="4" nowrap="nowrap">.*?<\/td>.*?<td class="center" nowrap="nowrap">.*?<\/td>',
	  ...
	  'FNO'=>array(
        'www.mugenrmt.com'=>array('products_name'=>'<td height=\'24\' class=\'border03 border04\'>.*?_(.*?)<\/td>',
         ...
         'rmtrank.com'=>array('products_name'=>'<td class="col0"><a href=".*?">.*?_(.*?)<\/a><\/td>',
                      'price'=>'<td class="col0"><a href=".*?">.*?<\/a><\/td>.*?<td class="col2">([0-9,.]*?) 円 .*?<\/td>',
                      'inventory'=>'<td class="col2">[0-9,.]*? WM .*?<\/td>.*?<td class="col2">([0-9,.]*?) 口 .*?<\/td>' 
                    ),
           'rmt.kakaran.jp'=>array( 'products_name'=>'<td><a href=".*?">(.*?)<\/a><\/td>.*?<td>[0-9,.]*?円<\/td>', 
...
'sell' => array(
	   ...
	   'RO'=>array(
              ...
              'rmtrank.com'=> array( 'products_name'=>'<td><a href=".*?">([a-zA-Z]+).*?<\/a><\/td>.*?<td>[0-9,.]*?円<\/td>',
                    'price'=>'<td class="price"><a href=".*?">.*?([0-9,.]+)<\/a>.*?<\/td>',
                    'inventory'=>'<td class="price"><a href=".*?">.*?<\/a><\/td>.*?<td>([0-9,.]+)<\/span>口<\/td>' 
                    ),
              'rmt.kakaran.jp'=> array('products_name'=>'<td><a href=".*?">(.*?)<\/a><\/td>.*?<td>[0-9,.]*?円<\/td>',
        ...
        'RS'=>array(
             ...
             'www.asahi-rmt-service.com'=>array('products_name'=>'<td class="left"><a href=".*?">(.*?)<\/a><\/td>',
              ...
              'www.rmt-king'=> array('products_name'=>'<tr .*?>.*?<td class="center">(.*?)<\/td>',
    ...
    'FF11'=>array(
          ...
          'www.asahi-rmt-service.com'=> array('products_name'=>'<td class="left"><a href=".*?">([a-zA-Z]+)<br \/>.*?<\/a>.*?<\/td>',
           ...
           'www.rmt-king'=> array('products_name'=>'<tr .*?>.*?<td class="center">.*?([a-zA-Z]+).*?<\/td>.*?<td class="center" nowrap="nowrap">.*?銀行振込<br \/>',
