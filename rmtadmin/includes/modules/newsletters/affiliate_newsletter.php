  ...
  class affiliate_newsletter {
    ...
    function send($affiliate_newsletter_id) {
      ...
      while ($mail = tep_db_fetch_array($mail_query)) {
        $mimemessage->send($mail['affiliate_lastname'] . ' ' . $mail['affiliate_firstname'], $mail['affiliate_email_address'], '', EMAIL_FROM, $this->title);
      }
      ...
      tep_db_query("update " . TABLE_NEWSLETTERS . " set date_sent = now(), status = '1' where newsletters_id = '" . tep_db_input($affiliate_newsletter_id) . "'");
	}
  }
?>