  ...
  while($c = mysql_fetch_array($query)){
    ...
    while($o = mysql_fetch_array($oquery)){
      ...
      while($op = mysql_fetch_array($opquery)){
        ...
        $opaquery = rq("select * from ".table_prefix($s)."orders_products_attributes where orders_id=".$o['orders_id']." and orders_products_id=".$o['orders_products_id']);
        ...
        $opdquery = rq("select * from ".table_prefix($s)."orders_products_download where orders_id=".$o['orders_id']." and orders_products_id=".$o['orders_products_id']);
  ...
  while($os = mysql_fetch_array($osquery)){
    $sql = "insert into orders_mail (
      ...
      orders_status_mail
        ...
        '".$os['language_id']."',
        '".site_id($s)."',
        '".$os['orders_status_title']."',
        '".$os['orders_status_mail']."'
      )";
    r3q($sql);
  }
}
