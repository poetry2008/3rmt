...
// * DIR_WS_* = Webserver directories (virtual/URL)
  define('HTTP_SERVER', 'http://3rk.maker.200.com'); // eg, http://localhost - should not be empty for productive servers
  ...
  define('DIR_FS_DOCUMENT_ROOT', '/home/maker/project/3rmt/rk/');
  define('DIR_FS_CATALOG', DIR_FS_DOCUMENT_ROOT);
  define('DIR_FS_DOWNLOAD', DIR_FS_CATALOG . 'download/');
  define('DIR_FS_DOWNLOAD_PUBLIC', DIR_FS_CATALOG . 'pub/');
  
  define('DIR_FS_3RMTLIB', '/home/maker/project/3rmt/jp/3rmtlib/');
