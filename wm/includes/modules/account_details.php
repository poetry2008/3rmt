...
*/
  ...
  if ($is_read_only == true) {
    ...
    if (!isset($account['customers_firstname'])) $account['customers_firstname'] = NULL; //del notice
  ...
  if ($is_read_only == true) {
    ...
    if (!isset($account['customers_lastname'])) $account['customers_lastname'] = NULL; //del notice
...
*/
  ...
  if ($is_read_only == true) {
    ...
    if (!isset($account['customers_email_address'])) $account['customers_email_address'] = NULL; //del notice
...
<?php
if (!isset($guestchk)) $guestchk = NULL; //delnotice
  if($guestchk == '1') {
