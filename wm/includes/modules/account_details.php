...
?>		  
		  <tr>
		    ...
		    <td class="main">&nbsp;<?php echo tep_draw_pull_down_menu('guestchk', $guestchk_array, $guestchk, 'onchange="pass_hidd()"'); ?>&nbsp;&nbsp;<small><span class="red">¢¨</span>&nbsp;²ñ°÷ÅÐÏ¿¤ò¤·¤Ê¤¤¤Ç¹ØÆþ¤¹¤ë¤³¤È¤â¤Ç¤­¤Þ¤¹¡£</small></td>
		  </tr>
<?php
    } else {
