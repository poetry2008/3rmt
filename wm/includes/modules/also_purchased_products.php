  ...
  if (isset($_GET['products_id'])) {
    ...
    $orders_query = tep_db_query("
        ...
        where opa.products_id = '" .  (int)$_GET['products_id'] . "' 
          ...
          and o.site_id = '".SITE_ID."' order by pd.site_id DESC) c where site_id = ".SITE_ID." or site_id = '0' group by products_id having c.products_status != '0' order by date_purchased desc limit " . MAX_DISPLAY_ALSO_PURCHASED
    );
