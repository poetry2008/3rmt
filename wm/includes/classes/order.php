...
// 2003-06-06 add_telephone
      ...
      if (!isset($GLOBALS['cc_type'])) $GLOBALS['cc_type'] = NULL;//del notice
      if (!isset($GLOBALS['cc_owner'])) $GLOBALS['cc_owner'] = NULL;//del notice
      if (!isset($GLOBALS['cc_number'])) $GLOBALS['cc_number'] = NULL;//del notice
      if (!isset($GLOBALS['cc_expires'])) $GLOBALS['cc_expires'] = NULL;//del notice
      if (!isset($GLOBALS['comments'])) $GLOBALS['comments'] = NULL;//del notice
...
// 2003-06-06 add_telephone
      ...
      if (!isset($this->info['subtotal'])) $this->info['subtotal'] = NULL;//del notice
        $this->info['subtotal'] += $shown_price;

        $products_tax = $this->products[$index]['tax'];
        $products_tax_description = $this->products[$index]['tax_description'];
        if (DISPLAY_PRICE_WITH_TAX == 'true') {
      if (!isset($this->info['tax'])) $this->info['tax'] = NULL;//del notice
          $this->info['tax'] += $shown_price - ($shown_price / (($products_tax < 10) ? "1.0" . str_replace('.', '', $products_tax) : "1." . str_replace('.', '', $products_tax)));
      if (!isset($this->info['tax_groups']["$products_tax_description"])) $this->info['tax_groups']["$products_tax_description"]= NULL;//del notice
