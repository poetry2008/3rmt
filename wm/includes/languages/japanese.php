...
define('MYACCOUNT_EDIT', 'アカウント編集');
define('MYACCOUNT_ADDRESS', 'アドレス帳');
define('MYACCOUNT_HISTORY', '注文履歴');
define('MYACCOUNT_NOTIFICATION', '商品のお知らせ');
...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;<small>' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上&nbsp;(例. abcdef) <font color="#AABBDD">必須</font></small>');
define('ENTRY_PASSWORD_ERROR', '&nbsp;<small><font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;<small>' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上&nbsp;(例. abcdef) <font color="#AABBDD">必須</font></small>');
...
define('IMAGE_BUTTON_EDIT_ACCOUNT', 'アカウント編集');
