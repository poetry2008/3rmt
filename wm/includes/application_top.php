...
// define the database table names used in the project
  ...
  define('TABLE_COUNTER', 'wm_counter');
  define('TABLE_COUNTER_HISTORY', 'wm_counter_history');
  ...
  define('TABLE_CL', 'wm_calendar'); //add calendar

  define('TABLE_CONFIGURATION_DS', 'wm_configuration_ds');
  define('TABLE_CONFIGURATION_GROUP_DS', 'wm_configuration_group_ds');
...
// customization for the design layout
  define('BOX_WIDTH', 172); // how wide the boxes should be in pixels (default: 125)
