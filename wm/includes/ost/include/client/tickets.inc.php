 ...
 <table border="0" cellspacing="1" cellpadding="0" width="100%">
    <tr><td>
     <table width="100%" border="0" cellspacing="1" cellpadding="2" class="tickets" align="center">
        <tr>
          <th nowrap width="80"><a href="view.php?sort=ID&order=<?=$negorder?><?=$qstr?>" title="番号順に表示 <?=$_negorder?>">問合番号</a></th>
          <th width="80"><a href="view.php?sort=date&order=<?=$negorder?><?=$qstr?>" title="作成日順に表示 <?=$_negorder?>">作成日</a></th>
          <th>件名</th>
        </tr>
        <?
        $class = "row1";
