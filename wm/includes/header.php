...
?>
                <table style="margin-top: 3px;" cellpadding="2" cellspacing="2" summary="search">
                  <tr>
                    <td><img class="middle" src="images/design/button/search_text.gif" width="76" height="25" alt="<?php echo TEXT_HEADER_SEARCH_IMAGE_ALT;?>"></td>
                    <td>
                      <?php
                ...
                <table summary="menu">
                  <tr>
                    <td>
                      ...
                      <a href="<?php echo tep_href_link(FILENAME_CHECKOUT_ATTRIBUTES,'','SSL') ; ?>" class="header_menu_3">
