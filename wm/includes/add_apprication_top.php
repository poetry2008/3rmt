...
*/
   ...
   if (!isset($HTTP_GET_VARS['manufacturers_id'])) $HTTP_GET_VARS['manufacturers_id'] = NULL;// del notice 
...
// Get Categories_image & subcategories_name
  function ds_tep_get_categories($products_id, $return) {
	...
	if($return == 1) {
	  ...
	  //中カテゴリ名を返す
    if (!isset($categories_path_array[1])) $categories_path_array[1] = NULL;
...
// SESSION REGISTER
   if (!isset($HTTP_GET_VARS['ajax'])) $HTTP_GET_VARS['ajax'] = NULL;// del notice 
