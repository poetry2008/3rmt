...
*/
  ...
  $email_order .= '▼ポイント割引　　：' . strip_tags($discount['text']) . "\n";
  */
...
/*
  if(tep_not_null($bbbank)) { //Sell
	$email_order .= '※ 弊社キャラクター名は、後ほど電子メールにてお知らせいたします。' . "\n\n";
  } else { //Buy
	$email_order .= '※ 弊社キャラクター名は、お支払い確認後に電子メールにてお知らせいたします。' . "\n\n";
  }
*/
  //$email_order .= '━━━━━━━━━━━━━━━━━━━━━' . "\n";
