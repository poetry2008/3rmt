...
// class methods
    ...
    function confirmation() {
      ...
      $s_result = !isset($_POST['codt_fee_error']) || !$_POST['codt_fee_error'];
      $s_message = $s_result
    ...
    function process_button() {
      ...
      $s_message = (isset($_POST['codt_fee_error']) && $_POST['codt_fee_error'])
	  ...
	  return tep_draw_hidden_field('codt_message', $s_message)
           . tep_draw_hidden_field('codt_fee', isset($_POST['codt_fee']) ? $_POST['codt_fee'] : '') // for ot_codt
