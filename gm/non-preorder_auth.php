          ...
          <td>
            <table class="box_des">
              ...
              <tr>
                ...
                <?php echo sprintf(PREORDER_NOTICE_SEND_TO_EMAIL_TEXT, (isset($_POST['pemail'])?$_POST['pemail']:$pe_email));?> 
                </td>
              </tr>
              <tr>
                <td colspan="3">
                <br><?php echo PREORDER_ACTIVE_INFO_FRONT_COMMENT;?><br><br> 
                </td>
              </tr>
              <tr>
