  ...
  if ($preorder) {
    ...
    if ($_POST['action'] == 'send') {
      ...
      if ($preorder['is_active']) {
        ...
        $pre_replace_info_arr = array($pre_name, $pre_num, $pre_date, $preorder['payment_method'], $preorder['customers_name'], STORE_NAME, HTTP_SERVER, $preorder_id, $preorder['comment_msg']);
