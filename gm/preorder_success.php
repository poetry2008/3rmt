...
<div id="main">
 ...
 <?php include('includes/search_include.php');?>
 	<div id="main-content"><?php echo tep_draw_form('order', tep_href_link(FILENAME_PREORDER_SUCCESS, 'action=update', 'SSL')); ?>
        <?php 
         $preorder_info = '
  ...
  if ($global['global_product_notifications'] != '1') {
    ...
    $info_notify = TEXT_SEE_ORDERS . '<br><br>' . TEXT_CONTACT_STORE_OWNER;
          ...
          echo str_replace('${PRODUCTS_INFO}',$preorder_info,str_replace('${PRODUCTS_SUBSCRIPTION}','<br><br>'.$info_notify,str_replace('${PROCEDURE}',TEXT_HEADER_INFO,str_replace('${NEXT}',tep_image_submit('button_continue_hover.gif', IMAGE_BUTTON_CONTINUE),$info_page['text_information']))));
            ?>
    </form> 
    </div>
    </div>
