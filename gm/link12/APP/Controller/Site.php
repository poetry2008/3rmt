...
function getBreadcrumb()
{
  ...
  function replace_seo($bread,$seo){
    ...
    $breadcrumb_str = $bread->trail_title(' <img src="images/point.gif"> ');
    $breadcrumb_lat = '';
    $breadcrumb_second = ''; 
    $breadcrumb_arr = explode('<img src="images/point.gif">', $breadcrumb_str);
    ...
    $breadcrumb_str = implode(' <img src="images/point.gif"> ',$breadcrumb_arr);
    
    $breadcrumb_keywords = str_replace(' <img src="images/point.gif"> ', ',', trim($breadcrumb_str)); 
    ...
    $seo['title'] = str_replace(' <img src="images/point.gif"> ', ' ', $seo['title']); 
    $seo['keywords'] = str_replace(' <img src="images/point.gif"> ', ' ', $seo['keywords']); 
    $seo['description'] = str_replace(' <img src="images/point.gif"> ', ' ', $seo['description']); 
    $seo['robots'] = str_replace(' <img src="images/point.gif"> ', ' ', $seo['robots']); 
    $seo['copyright'] = str_replace(' <img src="images/point.gif"> ', ' ', $seo['copyright']);
