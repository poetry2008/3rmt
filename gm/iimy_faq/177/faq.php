...
if($q_id == "" || $q_id == "index") {
	...
	$faq_meta_d = 'PSU RMTのよくある質問一覧ページです。ファンタシースターユニバースのメセタ販売・メセタ買取について';
	$faq_meta_k = 'PSU,ファンタシースターユニバース,質問,一覧,RMT,FAQ,メセタ,販売,買取';
	...
	$faq_meta_k = 'PSU,ファンタシースターユニバース,質問,回答,RMT,FAQ,メセタ,販売,買取';
