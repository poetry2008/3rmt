...
if($q_id == "" || $q_id == "index") {
	...
	$faq_meta_d = 'TW RMTのよくある質問一覧ページです。テイルズウィーバーのSeed販売・シード買取。魔法師の石の販売について';
	$faq_meta_k = 'TW,テイルズウィーバー,Seed,シード,魔法師の石,質問,一覧,RMT,FAQ,販売,買取';
	...
	$faq_meta_k = 'TW,テイルズウィーバー,Seed,シード,魔法師の石,質問,回答,RMT,FAQ,販売,買取';
