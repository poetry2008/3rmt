...
if($q_id == "" || $q_id == "index") {
	...
	$faq_meta_d = 'RO RMTのよくある質問一覧ページです。ROのゼニー販売・ゼニー買取について';
	$faq_meta_k = 'RO,ラグナロク,Ragnarok,質問,一覧,RMT,FAQ,ゼニー,Zeny,販売,買取';
	...
	$faq_meta_k = 'RO,ラグナロク,Ragnarok,質問,回答,RMT,FAQ,ゼニー,Zeny,販売,買取';
