...
<body>
  ...
  <div id="main"> 
      <!-- body_text //--> 
      <div id="layout" class="yui3-u"><?php echo tep_draw_form('order', tep_href_link('change_preorder_success.php', 'action=update', 'SSL')); ?> 
...
if ($global['global_product_notifications'] != '1') {
  ...
  echo str_replace('${PRODUCTS_INFO}','',str_replace('${PRODUCTS_SUBSCRIPTION}','<br><br>'.$info_notify,str_replace('${PROCEDURE}',TEXT_HEADER_INFO,str_replace('${NEXT}','<a href="' .tep_href_link(FILENAME_DEFAULT). '">' .  tep_image_button('button_continue_02_hover.gif', IMAGE_BUTTON_CONTINUE) .  '</a>',$info_page['text_information']))));?> 
      </form>
      </div> 
      <!-- body_text_eof //--> 
  <!-- body_eof //--> 
