...
<div id="main">
  ...
  <div id="current" ><?php echo $breadcrumb->trail(' <img  src="images/point.gif"> '); ?></div>
 	<div id="main-content"> 
    <h2><?php echo NAVBAR_CHANGE_PREORDER_TITLE;?></h2>      <!-- body_text //--> 
      <div class="frame_content">
          <table border="0" cellspacing="0" cellpadding="0" border="0" width="100%" align="center" class="checkout_s_link">
            ...
            <tr>
              <td align="center" width="33%" class="preorderBarcurrent"><?php echo NAVBAR_CHANGE_PREORDER_TITLE;?></td> 
          ...
          <h3><?php echo CHANGE_ORDER_CUSTOMER_DETAILS?></h3> 
          ...
          ?> 
          <h3><?php echo CHANGE_ORDER_PRODUCT_DETAILS;?></h3> 
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formArea">
            <tr>
              <td class="main" width="20%">
  ...
  $work_end_exit = $min_time_end_str;
        ...
        if($billing_address_show == 'true'){
          ...
          tep_db_free_result($quest_query);
        ?>
        <p class="formBoxTitle"><h3><?php echo TEXT_BILLING_SELECT;?></h3></p>
