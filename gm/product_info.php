...
?>
      ...
      <h1 class="pageHeading"><?php echo ds_tep_get_categories((int)$HTTP_GET_VARS['products_id'],1) ; ?></h1>
      <div class="line">
        <?php echo ds_tep_get_categories((int)$HTTP_GET_VARS['products_id'],2) ; ?>
      </div>
    ...
    ?>
              ...
              <tr class="header">
                <td height="40" align="right" valign="bottom" class="smallText">
                  ...
                  <a href="<?php echo tep_href_link(FILENAME_TELL_A_FRIEND,'products_id='.(int)$HTTP_GET_VARS['products_id']) ;  ?>"><?php echo tep_image(DIR_WS_IMAGES.'design/button/button_tellafriend.jpg',BOX_HEADING_TELL_A_FRIEND);?></a>
                  &nbsp;
                  <a href="<?php echo tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE,'products_id='.(int)$HTTP_GET_VARS['products_id']) ; ?>"><?php echo tep_image(DIR_WS_IMAGES.'design/button/button_review.jpg',BOX_REVIEWS_WRITE_REVIEW);?></a>
                  &nbsp;
                  <a href="<?php echo tep_href_link(FILENAME_CONTACT_US,'products_id='.(int)$HTTP_GET_VARS['products_id']) ; ?>"><?php echo tep_image(DIR_WS_IMAGES.'design/button/botton_question.jpg',IMAGE_BUTTON_QUT);?></a>
                </td>
              </tr>
            </table>
          </td>
