...
// * DIR_WS_* = Webserver directories (virtual/URL)
  define('HTTP_SERVER', 'http://gm.maker.200.com'); // eg, http://localhost - should not be empty for productive servers
  define('HTTPS_SERVER', 'https://gm.maker.200.com'); // eg, https://localhost - should not be empty for productive servers
