...
if($_POST['updata'] == 'on') {
  ...
  tep_db_query("
      update calendar 
      set cl_value='".$mm_2."' 
      where cl_ym = '".$_POST['ymd2']."' 
        and site_id = '".SITE_ID."'
  ");
  
  tep_redirect(tep_href_link(FILENAME_CL, 'action=success'));
}
?>
<?php
...
if($_GET['action'] == 'success') {
  ...
  echo '<tr>' . "\n";
  echo '<td class="messageStackSuccess" height="20" align="center"><strong>Â˘¥ÊÀË··Œ‰!æ„°˜°¶ﬁ‰ °¶/strong></td>' . "\n";
  echo '</tr>' . "\n";
  echo '</table><br>' . "\n";
}
?>
...
<!-- body_text //-->
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo '°¶°¶•Ê·„≥„•‡°¶ºÁ∑®°¶°¶; ?></td>
    ...
    $d_num = $today[mday];
    $year = $today[year];
    // 1Âı•Á’Á··°¶’¸Âı¶¨    $f_today = getdate(mktime(0,0,0,$m_num,1,$year));
    $wday = $f_today[wday];
    // Â˙∞Ê›‰È‚é∏
    ...
    echo '
      ...
      <tr bgcolor=#000000>
      <td nowrap colspan=3>&nbsp;&nbsp;<font size=2 color=#FFFFFF>'.$year.'Âπ°¶.$m_num.'Â˙°¶/font></td>
      <td nowrap colspan=4 align=right>&nbsp;&nbsp;<font size=2 color=#FFFFFF>&nbsp;&nbsp;·Ù†<img src="images/point.gif">°¶‘ÂW∏ÂÀÎÁ„L&nbsp;&nbsp;<font color="'.CL_COLOR_01.'">·Ù†</font><img src="images/point.gif">Â∫ŒÊ°¶‰º¬Âé£°¶nbsp;&nbsp;<font color="'.CL_COLOR_02.'">·Ù†</font><img src="images/point.gif">°¶°„•Ó·„°¶°¶‰ø°‰ªÔÊ•°¶nbsp;&nbsp;</td>
      </tr>
      <tr bgcolor=ffffff>
        <td align=middle height=15><font size="2" color="#cc0000">Âı°¶/font></td>
        <td align=middle height=15><font size="2">Â˙°¶/font></td>
        <td align=middle height=15><font size="2">°¶°¶/font></td>
        <td align=middle height=15><font size="2">Ê∞°¶/font></td>
        <td align=middle height=15><font size="2">Â˙°¶/font></td>
        <td align=middle height=15><font size="2">°¶°¶/font></td>
    ...
    while(checkdate($m_num,$day,$year)){
      ...
      elseif($array[$day] == '1'){
      //°¶¥ÂYŒ‰!°¶ªÔÊ•≠ÊÕ„é™      echo "<td align=center bgcolor=".CL_COLOR_01."><font size=2>$day<br>".$option."</font></td>\n";
      }
      elseif($array[$day] == '2'){
      //°¶°„•Ó·„°¶°¶‰ø°‰ªÔÊ•≠ÊÕ„é™      echo "<td align=center bgcolor=".CL_COLOR_02."><font size=2>$day<br>".$option."</font></td>\n";  
      }  
      elseif($wday == 0){ 
      //  Sunday
    ...
    $d_num2 = $today2[mday];
    $year2 = $today2[year];
    // 1Âı•Á’Á··°¶’¸Âı¶¨    $f_today2 = getdate(mktime(0,0,0,$m_num2,1,$year2));
    $wday2 = $f_today2[wday];
    // Â˙∞Ê›‰È‚é∏
    $m_name2 = "$year ".substr($today2[month],0,3);
    
    //Â˙∞‰!°¶•Á°¶º„£°¶ÃÂ]°¶    $ymd2 = date("Ym", mktime(0,0,0,$m_num2,1,$year2));
    ...
    echo '
      <table border=1 cellspacing=0 cellpadding=2 width=100%>
      <tr bgcolor=#000000>
      <td nowrap colspan=3>&nbsp;&nbsp;<font size=2 color=#FFFFFF>'.$year2.'Âπ°¶.$m_num2.'Â˙°¶/font></td>
      <td nowrap colspan=4 align=right>&nbsp;&nbsp;<font size=2 color=#FFFFFF>&nbsp;&nbsp;·Ù†<img src="images/point.gif">°¶‘ÂW∏ÂÀÎÁ„L&nbsp;&nbsp;<font color="'.CL_COLOR_01.'">·Ù†</font><img src="images/point.gif">Â∫ŒÊ°¶‰º¬Âé£°¶nbsp;&nbsp;<font color="'.CL_COLOR_02.'">·Ù†</font><img src="images/point.png">°¶°„•Ó·„°¶°¶‰ø°‰ªÔÊ•°¶nbsp;&nbsp;</td>
      </tr>
      <tr bgcolor=ffffff>
        <td align=middle height=15><font size="2" color="#cc0000">Âı°¶/font></td>
        <td align=middle height=15><font size="2">Â˙°¶/font></td>
    ...
    while(checkdate($m_num2,$day2,$year2)){
      ...
      if($array2['1'.str_pad($day2, 2, 0, STR_PAD_LEFT)] == '1'){
      //°¶¥ÂYŒ‰!°¶ªÔÊ•≠ÊÕ„é™      echo "<td align=center bgcolor=".CL_COLOR_01."><font size=2>$day2<br>".$option2."</font></td>\n";
      }
      elseif($array2['1'.str_pad($day2, 2, 0, STR_PAD_LEFT)] == '2'){
      //°¶°„•Ó·„°¶°¶‰ø°‰ªÔÊ•≠ÊÕ„é™      echo "<td align=center bgcolor=".CL_COLOR_02."><font size=2>$day2<br>".$option2."</font></td>\n";  
      }  
      elseif($wday == 0){ 
      //  Sunday
