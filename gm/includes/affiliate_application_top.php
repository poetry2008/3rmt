...
// define the database table names used in the contribution
  define('TABLE_AFFILIATE', 'gm_affiliate_affiliate');
  define('TABLE_AFFILIATE_NEWS', 'gm_affiliate_news');

// if you change this -> affiliate_show_banner must be changed too
  define('TABLE_AFFILIATE_BANNERS', 'gm_affiliate_banners');
  define('TABLE_AFFILIATE_BANNERS_HISTORY', 'gm_affiliate_banners_history');
  define('TABLE_AFFILIATE_CLICKTHROUGHS', 'gm_affiliate_clickthroughs');
  define('TABLE_AFFILIATE_SALES', 'gm_affiliate_sales');
  define('TABLE_AFFILIATE_PAYMENT', 'gm_affiliate_payment');
  define('TABLE_AFFILIATE_PAYMENT_STATUS', 'gm_affiliate_payment_status');
  define('TABLE_AFFILIATE_PAYMENT_STATUS_HISTORY', 'gm_affiliate_payment_status_history');
