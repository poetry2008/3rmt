<?php
/*
  $Id: boxes.php,v 1.1.1.1 2003/02/20 01:03:53 ptosh Exp $
...
if (!isset($contents[$i][0])) $contents[$i][0]= NULL;
  ...
  class infoBoxHeading extends tableBox {
    function infoBoxHeading($contents, $left_corner = true, $right_corner = true, $right_arrow = false) {
      ...
      $info_box_contents = array();
      $info_box_contents[] = array(array('params' => 'height="20" class="box_des"',
                                         'text' => $left_corner),
                                   array('params' => 'width="100%" height="20" class="box_des"',
                                         'text' => $contents[0]['text']),
                                   array('params' => 'height="20" class="box_des" nowrap',
                                         'text' => $right_corner));
