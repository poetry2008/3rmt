...
define('BOX_HEADING_SPECIALS', '特価販売一覧');
...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;<small>英数字' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上&nbsp;(例. abcdef) <font color="#AABBDD">必須</font></small>');
define('ENTRY_PASSWORD_ERROR', '&nbsp;<small><font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;<small>英数字' . ENTRY_PASSWORD_MIN_LENGTH . '文字以上&nbsp;(例. abcdef) <font color="#AABBDD">必須</font></small>');
...
define('SENDMAIL_SUCCESS_TEXT', 'メールが送信されました。RMTゲームマネーからの受信をご確認ください。');
