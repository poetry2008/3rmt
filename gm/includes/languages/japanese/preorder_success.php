...
define('TEXT_HEADER_INFO','<table width="100%" cellspacing="0" cellpadding="0"
    border="0" class="checkout_s_link"> <tbody><tr> <td width="20%"><table width="100%" cellspacing="0"
    ...
    src="images/pixel_silver.gif"></td> </tr> </tbody></table></td> <td width="20%"><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td><img width="100%"
    height="1" alt="" src="images/pixel_silver.gif"></td></tr></table></td> <td width="20%"><table
