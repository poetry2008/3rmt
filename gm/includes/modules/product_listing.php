...
<td><a class="product_listing_link" <?php echo (!isset($_COOKIE['sort']) or $_COOKIE['sort'] == '100a' or $_COOKIE['sort'] == '100d') ? 'style="background:url(images/design/box/product_listing_sort_02.gif)"' : 'style="background:url(images/design/box/product_listing_sort_01.gif)"' ; ?> href="javascript:void(0)"
    <?php echo $onmouse; ?>onclick="change_sort_type('100<?php echo $sort_default_str;?>');"><?php echo PRE_SORT_DEFAULT;?><img class="middle" src="images/design/box/sort<?php if(empty($_COOKIE['sort'])){ echo $sort_default_str=='d' ? '_link' : '_hover';} else {if($tmp_sort_str=='100'){echo $sort_default_str=='d' ? '_link' : '_hover';}else{echo  '_link';}}?>.png" hspace="3" alt=""></a></td>
    ...
    onclick="change_sort_type('4<?php echo $sort_name_str ?>');"><?php echo PRE_SORT_A;?><img class="middle" src="images/design/box/sort<?php if($tmp_sort_str=='4'){echo $sort_name_str=='d'  ? '_link' : '_hover';}else{echo '_link';}?>.png" hspace="3" alt=""></a></td>
    ...
    <td colspan="2">
      <table border="0" width="100%" cellspacing="0" cellpadding="2">
        <tr>
          ...
          <?php echo $listing_split->display_links($listing_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $_GET['page'], tep_get_all_get_params(array('sort', 'page', 'info', 'x', 'y'))); ?>&nbsp;</td>
        </tr>
      </table></td>
  </tr>
<?php
