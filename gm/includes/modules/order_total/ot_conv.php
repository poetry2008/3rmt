<?php
/*
  $Id: ot_conv.php,v 1.2 2003/05/09 07:14:35 ptosh Exp $
  ...
  class ot_conv {
    ...
    function check() {
      if (!isset($this->_check)) {
        $check_query = tep_db_query("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_ORDER_TOTAL_CONV_STATUS'");
