              ...
              for(m in arr_time_d){
                ...
                for(k in arr_time_t){
                  ...
                  if(k != arr_time_t.length-1){
                    string +=  '<li><div class="time_radio"><input type="radio" id="m'+m+'" name="min" value="'+m+'"'+checked+' onclick="change_time('+m+',\''+array_end[n]+'\');"></div><div class="time_label"><label for="m'+m+'"><a href="javascript:void(0);"onclick="change_new_time('+m+',\''+array_end[n]+'\');" >'+arr_time_m[0]+'時'+arr_time_m[1]+'分～';
                  }else{
