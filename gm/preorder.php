  ...
  <select name="predate">
    ...
    if (sizeof($selection) > 1) { 
      ...
      <table width="100%" cellpadding="2" cellspacing="0" border="0" class="formArea">
        ...
        <tr>
          <td>
          <table border="0" width="95%" cellspacing="0" cellpadding="0" class="box_des02" align="center">
          <?php
          if ($n == 1) {
...
?> 
      ...
      <table width="100%" cellpadding="2" cellspacing="0" border="0" class="formArea">
        <tr><td class="main"><?php echo tep_draw_textarea_field('yourmessage', 'soft', 50, 5);?></td></tr>
      </table>
      <br>
