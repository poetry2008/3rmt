...
if (!isset($_GET['firstname'])) $_GET['firstname'] = NULL; //del notice
        ...
        if ($lastname_error == true) {
          ...
          $last_name_prompt .= '&nbsp;<span class="errorText"><br>' .  sprintf(ERROR_FIRST_ITEM_TEXT_NUM_MAX,$customers_strlen['customers_lastname']) . '</span>';
        }
        if ($firstname_error == true){ 
          ...
          $first_name_prompt .= '&nbsp;<span class="errorText"><br>' .  sprintf(ERROR_FIRST_ITEM_TEXT_NUM_MAX,$customers_strlen['customers_firstname']) . '</span>';
        }
...
?>
      ...
      <table width="100%" cellpadding="2" cellspacing="2" border="0">
        ...
        <tr>  
          <td><?php echo FORM_FIELD_CUSTOMER_FIRSTNAME; ?></td>
      ...
      <table width="100%" cellpadding="2" cellspacing="2" border="0">
        <tr>
        <td valign="top" width="20%"><?php echo PREORDER_PRODUCTS_NAME;?></td>
          <td>
          <strong>
          <?php 
          if ($product_info['products_status'] == 0 || $product_info['products_status'] == 3)  {
...
if (!isset($_GET['quantity'])) $_GET['quantity'] = NULL; //del notice
            echo tep_draw_input_field('quantity', (($quantity_error == true) ? $_POST['quantity'] : $_POST['quantity']) , 'size="7" maxlength="15" id="text_input" style="text-align:right;" onchange="change_num(this.value);"');
