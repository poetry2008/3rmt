              ...
              <td class="main">
                <table class="box_des" border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="main">
                    <?php 
                    if (!isset($HTTP_GET_VARS['friendname'])) $HTTP_GET_VARS['friendname'] = NULL; 
                    echo tep_draw_input_field('friendname', (($friendname_error == true) ? $HTTP_POST_VARS['friendname'] : $HTTP_GET_VARS['friendname'])); if ($friendname_error == true) echo '&nbsp;<span class="errorText">' . TEXT_REQUIRED . '</span>';
                    ?>
                    </td>
                  </tr>
                  <tr>
                    ...
                    echo tep_draw_input_field('friendemail', (($friendemail_error == true) ? $HTTP_POST_VARS['friendemail'] : $HTTP_GET_VARS['send_to'])); if ($friendemail_error == true) echo ENTRY_EMAIL_ADDRESS_CHECK_ERROR; 
                    ?>
                    </td>
                  </tr>
                </table>
