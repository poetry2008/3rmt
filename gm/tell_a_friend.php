  ...
  IMAGE_BUTTON_CONTINUE,' onmouseout="this.src=\'includes/languages/japanese/images/buttons/button_continue.gif\'"  onmouseover="this.src=\'includes/languages/japanese/images/buttons/button_continue_hover.gif\'"') . '</a>'; ?>
    ...
    <?php
      ...
      if (tep_session_is_registered('customer_id')) {
        ...
        $your_email_address_prompt .= '<br><span id="from_error" class="error_information">';
...
?>
    ...
    <table id="detail-table-noframe" width="100%" cellpadding="0" cellspacing="0" border="0">
      ...
      <tr>
                    ...
                    if (!isset($_POST['friendname'])) $_POST['friendname'] = NULL; 
                    echo tep_draw_input_field('friendname', (($friendname_error == true) ? $_POST['friendname'] : $_GET['friendname']), 'style="width:35%"'); 
                  ...
                  <tr>
                    ...
                    <td>
                    <?php 
                      echo tep_draw_input_field('friendemail', (($friendemail_error == true) ? $_POST['friendemail'] : $_GET['send_to']), 'style="width:35%"'); 
                      echo '<br><span id="friendemail_error" class="error_information">';
                  ...
                  <tr>
                    ...
                    <td>
                    <div class="img_box"><img src="<?php echo 'random_code.php?t='.tep_create_random_value(3).time();?>" border="0" align="left"></div>&nbsp;&nbsp;<input type="text" name="random_code" size="7" value=""> 
                    <?php
                  ...
                  <tr>
                      <td width="100%" colspan="2"><?php echo tep_draw_textarea_field('yourmessage', 'soft', 40,8,'','style="width:100%"')?></td>
                 </tr>
                 <tr>
                   <td><br><?php echo '<a href="' .  tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' .  $_GET['products_id']) . '">' .  tep_image_button('button_back.gif', IMAGE_BUTTON_BACK,' onmouseout="this.src=\'includes/languages/japanese/images/buttons/button_back.gif\'"  onmouseover="this.src=\'includes/languages/japanese/images/buttons/button_back_hover.gif\'"') . '</a>'; ?></td>
                   <td align="right"><br><a href="javascript:void(0);" onclick="check_form_error();"><?php echo tep_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE,' onmouseout="this.src=\'includes/languages/japanese/images/buttons/button_continue.gif\'" onmouseover="this.src=\'includes/languages/japanese/images/buttons/button_continue_hover.gif\'"'); ?></a></td>
                 </tr>
    </table>
    </form>
    <?php
