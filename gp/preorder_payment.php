...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
            <tr> 
              <td><table border="0" width="100%" cellspacing="0" cellpadding="0" class="rg_pay_info"> 
                  <tr> 
                    ...
                    <td class="main" align="right"><a href="javascript:void(0);" onclick="check_pre_products('<?php echo $op_info_tmp_str;?>', '<?php echo $product_info['products_id'];?>');"><?php echo tep_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE);?></a></td> 
                  </tr> 
                </table></td> 
            </tr> 
            <tr> 
    ...
    if (sizeof($selection) > 0) { 
      ...
      <table width="100%" cellpadding="2" cellspacing="0" border="0" class="formArea">
        <tr><td class="main"><?php echo tep_draw_textarea_field('yourmessage', 'soft', 40, 8, stripslashes($_POST['yourmessage']));?></td></tr>
      </table>
      <br>
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
            <?php
