...
if (!isset($_GET['quantity'])) $_GET['quantity'] = NULL; //del notice
            ...
            if($products_weight_error == true){ 
              echo '<span class="markProductOutOfStock"><a style="color:#CC0033" href="'.tep_href_link('open.php', 'products_name='.urlencode($product_info['products_name']), 'SSL').'">' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . '</a></span>';
            }
