          ...
          <tr> 
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0" class="rg_pay_info"> 
                <tr> 
                  ...
                  <td class="main" align="right"><a href="javascript:void(0);" onClick="check_option_change();"><?php echo tep_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></a>
<?php
          //触发弹出层的条件
          $check_products_info = tep_check_less_product_option(); 
          if (!empty($check_products_info)) {
...
<table border="0" cellpadding="2" cellspacing="0" style=" position:absolute; width:500px; *width:498px;">
