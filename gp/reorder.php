...
<table border="0" cellpadding="0" cellspacing="0" style=" position:absolute; width:518px; *width:515px;">
<tr id="shipping_list_min" style="display:none;">
 <td class="main" width="144">&nbsp;<input type="hidden" id="ele_id" name="ele" value=""></td>
