...
?> 
      ...
      <div class="pageHeading"><h1><?php echo HEADING_TITLE_ERROR; ?></h1></div> 
      <div class="comment"><?php echo ERROR_INVALID_PRODUCT; ?></div>
      <?php
  } else {
    $product_info = tep_db_fetch_array($product_info_query);
?> 
      <div class="pageHeading"><h1><?php echo sprintf(HEADING_TITLE, $product_info['products_name']); ?></h1></div> 
            ...
            <tr> 
              <td class="main"><table border="0" cellspacing="0" summary="table" cellpadding="2" width="100%"> 
                <tr> 
                  ...
                  <?php 
                    echo tep_draw_input_field('friendname', (($friendname_error == true) ? $_POST['friendname'] : $_GET['friendname']),'class="input_text"');
                ...
                <tr> 
                  ...
                  <td class="main">
                  <?php 
                    echo tep_draw_input_field('friendemail', (($friendemail_error == true) ? $_POST['friendemail'] : $_GET['send_to']),'class="input_text"');
                ...
                <table border="0" cellspacing="0" summary="table" cellpadding="2" width="100%">
                  <tr>
                    ...
                    <td class="main">
                      ...
                      <?php
                       echo '&nbsp;<span id="code_error" class="errorText">'; 
        ...
        <tr> 
          ...
          <table border="0" width="100%" cellspacing="0" cellpadding="0" summary="table"> 
            <tr> 
              ...
              <td align="right" class="main"><a href="javascript:void(0);" onclick="check_form_error();"><?php echo tep_image_button('button_continue02.gif', IMAGE_BUTTON_CONTINUE); ?></a></td> 
            </tr> 
          </table></td> 
        </tr> 
      </table> 
