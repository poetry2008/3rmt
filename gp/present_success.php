  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
      ...
      <td valign="top" id="contents">
          ...
          echo str_replace('${PRODUCTS_INFO}','',str_replace('${PROCEDURE}',TEXT_HEADER_INFO,str_replace('${NEXT}','<a href="' .  tep_href_link(FILENAME_DEFAULT) . '">' .  tep_image_button('button_continue02.gif', IMAGE_BUTTON_CONTINUE) .  '</a>',$info_page['text_information'])));
          ?>
        </td> 
      <!-- body_text_eof --> 
