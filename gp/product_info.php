                ...
                <td valign="top">
                    ...
                    <tr>
                      ...
                      <table summary="info_box_contents"  border="0" cellpadding="3" cellspacing="1">
                          <tr>
                          <td class="main" width="85"><b><font color="#2864B4"><?php echo TEXT_PRODUCT_MODEL;?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#2864B4"><?php echo $product_info['products_attention_1_1'] ; ?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#2864B4"><?php echo $data1[0] ; ?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#2864B4"><?php echo $data2[0] ; ?></font></b></td>
                            <td class="main"><?php echo $data2[1] ; ?></td>
                          </tr>
                          <?php } ?>
                          <tr>
                          <td class="main"><b><font color="#2864B4"><?php echo TEXT_PRODUCT_MANUFACTURER_NAME;?></font></b></td>
                            <td class="main"><?php include(DIR_WS_BOXES.'manufacturer_info.php') ; ?></td>
                          </tr>
                          <tr>
                          <td class="main"><b><font color="#2864B4"><?php echo TEXT_PRODUCT_PRICE;?></font></b></td>
                            <td class="main">
                                <?php
                                  # 添加开始 ---------------------------------------
                                  # -- 订单数量和单价列表 --------------------------
                          ...
                          <tr>
                          <td class="main"><b><font color="#2864B4"><?php echo TEXT_ORDERS_NUM;?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#2864B4"><?php echo $data3[0] ; ?></font></b></td>
                      ...
                      ?>
                          ...
                          <tr>
                          <td class="main"><b><font color="#2864B4"><?php echo TEXT_POINT;?></font></b></td>
...
");
                        ...
                        ?>
                        <tr> 
                        <td class="main"><?php echo TEXT_TAG;?></td> 
                          <td class="main">
...
<?php
    ...
    ?>
                        <table width="100%"  border="0" cellpadding="3" cellspacing="1" summary="rmt_text">
                          <tr>
...
if(tep_db_num_rows($tag_query)){
?>
<div class="pageHeading_long"><h3><?php echo $product_info['products_name'].TEXT_KEYWORD;?></h3></div>        
<div class="comment_long">
<div class="comment_long_text">
<?php
$tnum = 0;
