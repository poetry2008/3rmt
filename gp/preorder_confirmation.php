...
<table class="preorder_info_box" border="0" width="100%" cellspacing="0" cellpadding="0"> 
<tr> 
  <td>
<?php
//提交表单处理
...
if (tep_not_null($_POST['yourmessage'])) {
  ?>  
    ...
    <td><table border="0" width="100%" cellspacing="0" cellpadding="2"> 
    <tr> 
    <td class="main"><div class="payment_comment"><?php echo nl2br(htmlspecialchars(stripslashes($_POST['yourmessage']))); ?></div></td> 
    </tr> 
    </table></td> 
    </tr> 
    </table></td> 
