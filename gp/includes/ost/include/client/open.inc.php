...
<table cellpadding="2" cellspacing="1" width="100%" class="open_users">
    ...
    <tr>
        <th>件名</th>
        <td>
            <input type="text" class="input_text" name="subject" size="35" value="<?=isset($info['subject'])?$info['subject']:(isset($_GET['products_name'])?$_GET['products_name'].'について':(isset($_GET['pname'])?$_GET['pname'].'の確保期限について':''))?>">
    ...
    <tr>
        ...
        <img src="captcha.php" border="0" alt="img">&nbsp;&nbsp;<input type="text" name="captcha" size="7" value="">&nbsp;<i class="captcha_comment">認証画像の内容をご入力ください.</i>
