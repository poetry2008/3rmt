...
while ($category = tep_db_fetch_array($categories_query))  {
    $ca_romaji_arr = explode(',', tep_replace_all_full_character(strtolower($category['character_romaji'])));  
    $al_romaji_arr = explode(',', tep_replace_all_full_character(strtolower($category['alpha_romaji']))); 
