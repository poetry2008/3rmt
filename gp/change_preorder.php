  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
      ...
      <td valign="top" id="contents"> 
          ...
          <div class="comment">
          <table class="product_info_box" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td>
        ...
        $products_options_query = tep_db_query("
          ...
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formArea">
            <tr>
              ...
              <td class="main">
              <input type="text" name="preorder_point" size="20" value="<?php echo isset($_POST['preorder_campaign_info'])?$_POST['preorder_campaign_info']:(isset($_POST['preorder_point'])?$_POST['preorder_point']:'0');?>" style="text-align:right;">&nbsp;&nbsp;<?php echo $preorder_point;?> 
              <?php 
