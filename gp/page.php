...
<body><div class="body_shadow" align="center"> 
  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    ...
    ?>
    <div class="pageHeading"><img align="top" alt="" src="images/menu_ico.gif"><h1><?php echo PAGE_HEADING_TITLE ; ?></h1></div> 
        <div class="comment">
     ...
     <?php
          ...
          ?>
          <div class="pageHeading"><img align="top" alt="" src="images/menu_ico.gif"><h1><?php echo PAGE_NAVBAR_TITLE;?></h1></div> 
          <div class="comment">
