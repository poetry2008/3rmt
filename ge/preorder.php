...
if (!isset($_GET['from'])) $_GET['from'] = NULL; //del notice
        $your_email_address_prompt = tep_draw_input_field('from', $_POST['from'] , 'size="30" class="input_text"') .'<br><span>'. TEXT_PHONE_EMAIL_ADDRESS.'</span>';
...
<div id="main">
    ...
    <div id="content">
      ...
      <div class="red"><b><?php echo TEXT_PREORDER_BOOK_TEXT_END;?></b></div>
<?php
      if($error == true) {
...
?>
      ...
      <table width="100%" cellpadding="2" cellspacing="1" border="0" class="formArea">
        <tr>
        <td class="main" valign="top" width="130"><?php echo PREORDER_PRODUCTS_NAME;?></td>
        ...
        <tr>
          <td class="main" width="130"><?php echo FORM_FIELD_FRIEND_NAME; ?></td>
          <td class="formArea_td_info">
<?php
