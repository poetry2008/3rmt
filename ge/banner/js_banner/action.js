...
function right(){
	...
	img[1].style.height = "50px";
	img[1].style.left = (img1L - 5).toString() + "px";
	img[1].style.width =  "50px";
	
	img[2].style.height = (img2H - 2.5).toString() + "px"; 
	img[2].style.left = (img2L - 5).toString() + "px";
	img[2].style.width =  (img2W - 4.5).toString() + "px";
	
	img[3].style.height = (img3H + 3).toString() + "px"; 
	img[3].style.left = (img3L - 10.5).toString() + "px";
	img[3].style.width =  (img3W + 5).toString() + "px";
	
	img[4].style.height = "50px";
	img[4].style.left = (img4L - 6.5).toString() + "px";
	img[4].style.width =  "50px";
	
	img[5].style.height =  "50px";
	img[5].style.left = (img5L - 5).toString() + "px";
	img[5].style.width =  "50px";
...
function left(){
	...
	img[1].style.height = (img1H + 2).toString() + "px"; 
	img[1].style.left = (img1L + 5.5).toString() + "px";
	img[1].style.width =  (img1W + 4).toString() + "px";
	
	img[2].style.height = (img2H - 3.5).toString() + "px"; 
	img[2].style.left = (img2L + 8.5).toString() + "px";
	img[2].style.width =  (img2W - 5.5).toString() + "px";
	
	img[3].style.height =  "50px";
	img[3].style.left = (img3L + 6.5).toString() + "px";
	img[3].style.width =  "50px";
