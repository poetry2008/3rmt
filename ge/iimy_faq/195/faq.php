<?php
/*
  $Id$game_name = 'レッドストーン';

// IF USER HAS CLICKED ON A QUESTION
if($q_id == "" || $q_id == "index") {
	// IF USER IS LOOKING AT THE MAIN PAGE
	$faq_meta_d = 'レッドストーン RMTのよくある質問一覧ページです。REDSTONEのゴールド販売・Gold買取について';
	$faq_meta_k = 'レッドストーン,REDSTONE,ゴールド,質問,一覧,RMT,FAQ,Gold,販売,買取';
	...
	$faq_meta_k = 'レッドストーン,REDSTONE,ゴールド,質問,回答,RMT,FAQ,Gold,販売,買取';
