    ...
    <div id="reply">
        <form action="<?php echo tep_href_link('view.php','id='.$id.'#reply','SSL');?>" name="reply" method="post" enctype="multipart/form-data">
            ...
            <div align="left"  style="padding:10px 0 10px 0;">
                ...
                style="padding:0;background:none;border:none;" value="キャンセル" onClick='window.location.href="<?php echo tep_href_link('view.php','','SSL');?>";'><img src="includes/languages/japanese/images/buttons/open_users02.gif" /></button>
