...
define('TEXT_SUCCESS', '<h3 class="redtext">「注文受付」メールをお送りしましたのでご確認ください。</h3>
...
<h3 class="redtext">お取り引きの際の注意点</h3>
...
お客様ご指定のお届け日時にログインをお願いいたします。10分経過しましても弊社キャラクターが現れない場合は、サポートセンターへお問い合わせください。<br>
<div class="dot">&nbsp;</div>
<img src="images/preorder.gif" alt="取り寄せアイコン" width="50" height="50"><b>「取り寄せ」商品について</b><br>
ご注文いただいた商品は、通常１～５営業日でお届けしております。<br>
<div class="dot">&nbsp;</div>
...
define('TEXT_HEADER_INFO','<table border="0" width="100%" cellspacing="0" cellpadding="0" class="checkout_s_link"> <tr><td width="20%"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tr><td width="50%" align="right"><img src="images/pixel_silver.gif" alt="" width="1" height="5"></td><td width="50%"><img src="images/pixel_silver.gif" alt="" width="100%" height="1"></td></tr></table></td><td width="20%"><img src="images/pixel_silver.gif" alt="" width="100%" height="1"></td><td width="20%"><img src="images/pixel_silver.gif" alt="" width="100%" height="1"></td><td width="20%"><img src="images/pixel_silver.gif" alt="" width="100%" height="1"></td><td width="20%"><table border="0" width="100%" cellspacing="0" cellpadding="0"><tr><td width="50%"><img src="images/pixel_silver.gif" alt="" width="100%" height="1"></td><td width="50%"><img src="images/checkout_bullet.gif" alt=""></td></tr></table></td></tr><tr class="box_des"><td align="center" nowrap="nowrap" width="20%" class="checkoutBarFrom">商品オプション</td><td align="center" nowrap="nowrap" width="20%" class="checkoutBarFrom">配送方法</td> <td align="center" nowrap="nowrap" width="20%" class="checkoutBarFrom">支払方法</td><td align="center" nowrap="nowrap" width="20%" class="checkoutBarFrom">最終確認</td><td align="center" nowrap="nowrap" width="20%" class="checkoutBarCurrent">手続完了!</td> </tr> </table>');
?>
