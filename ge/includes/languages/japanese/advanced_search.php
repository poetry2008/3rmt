...
define('TEXT_SEARCH_HELP', '詳細検索では、単語や文字列を AND や OR で区切ることができます。<br><br>例えば、マイクロソフト AND マウスと入力すると、両方の単語をふくんだ商品を探します。それに対して、<u>マウス OR キーボード</u>と入力すると、どちらかの単語をふくんだ商品を探します。<br><br>いくつかの単語を引用符で囲んで検索すると、入力した文字列に正確に一致するものを探します。<br><br>例えば、"ノート パソコン"として検索すると、そのままの文字列をふくんだ商品を探すことができます。<br><br>括弧を使用して、論理的な組み合わせを指定することができます。<br><br>例えば、<u>マイクロソフト AND (キーボード OR マウス OR "visual basic")</u>として検索すると、"マイクロソフト" + "キーボード"か"マウス"か（正確に!）"visual basic"というキーワードをふくんだ商品を探します。');
