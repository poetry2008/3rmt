...
<?php
    while ($new_products = tep_db_fetch_array($new_products_query)) {
      ...
      if (tep_get_special_price($new_products['products_price'], $new_products['products_price_offset'], $new_products['products_small_sum'])) {
        ...
        $p = $currencies->display_price(tep_get_price($new_products['products_price'], $new_products['products_price_offset'], $new_products['products_small_sum'], $new_products['products_bflag'],$new_products['price_type']), tep_get_tax_rate($new_products['products_tax_class_id']));
      }
      //获取商品图片 
