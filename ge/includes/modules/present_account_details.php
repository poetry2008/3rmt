...
*/
  ...
  if ($is_read_only == true) {
      ...
      //未满18岁禁止处理
          ...
          $a_value = tep_draw_input_field('dob') . '&nbsp;' . ENTRY_REGISTERED_AGE_ERROR;
    } else {
  ...
  <tr>
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2" class="box_des">
          <tr>
            <td class="main" width="104"><?php echo ENTRY_TELEPHONE_NUMBER; ?></td>
            <td class="main">
<?php
  if ($is_read_only == true) {
  ...
  <tr>
    <td class="main"><table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea">
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="2" class="box_des">
          <tr>
            <td class="main" width="104"><?php echo ENTRY_PASSWORD; ?></td>
            <td class="main">
<?php
