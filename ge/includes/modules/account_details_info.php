...
//如果没有设置 只读，则为否
  ...
  if ($is_read_only == true) {
      ...
      if ($entry_email_address_error == true) {
          $a_value = tep_draw_input_field('email_address','','class="input_text"') .  '&nbsp;<div>' . ENTRY_EMAIL_ADDRESS_ERROR.'</div>';
      } elseif ($entry_email_address_check_error == true) {
          $a_value = tep_draw_input_field('email_address','','class="input_text"') .  '&nbsp;<div>' . ENTRY_EMAIL_ADDRESS_CHECK_ERROR.'</div>';
      } elseif ($entry_email_address_exists == true) {
          $a_value = tep_draw_input_field('email_address','','class="input_text"') .  '&nbsp;<div>' . ENTRY_EMAIL_ADDRESS_ERROR_EXISTS.'</div>';
...
<?php if (!isset($guestchk)) $guestchk = NULL;?>
        <td class="main" width="93">&nbsp;<?php echo tep_draw_pull_down_menu('guestchk', $guestchk_array, $guestchk, 'onchange="pass_hidd()"'); ?>&nbsp;&nbsp;<span class="red">※</span>&nbsp;<?php echo TEXT_ACCOUNT_GUEST_INFO;?></td>
      </tr>
<?php
    } else {
...
?>
  ...
  <tr id="trpass2">
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2" class="formArea" summary="table"> 
      <tr>
        <td class="main"> 
          <table border="0" cellspacing="0" cellpadding="2" summary="table" class="box_des" width="100%"> 
          <tr>
...
?> 
  ...
  ?> 
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2" summary="table"> 
      ...
      <tr><td align="right"><input type="image" src="images/design/button/save.gif"></td></tr>
    </table></form></td>
  </tr>  
<?php
  }
