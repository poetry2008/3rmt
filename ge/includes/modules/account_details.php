...
//如果没有设置 只读，则为否
  ...
  if ($is_read_only == true) {
      ...
      $a_value = tep_draw_input_field('firstname',tep_db_output($account['customers_firstname']),'class="input_text"') . ENTRY_FIRST_NAME_TEXT;
  }
  ...
  if ($is_read_only == true) {
      ...
      $a_value = tep_draw_input_field('lastname', tep_db_output($account['customers_lastname']),'class="input_text"') . ENTRY_LAST_NAME_TEXT;
  }
...
<?php if (!isset($guestchk)) $guestchk = NULL;?>
        ...
        ?>
        <br>
        <div class="input_both"><span class="redtext">※</span>&nbsp;会員登録をしないで購入することもできます。</div></td>
      </tr>
              <?php
    } else {
...
?>
  ...
  <table border="0" cellspacing="0" cellpadding="2" width="100%" summary="table">
      <tr>
