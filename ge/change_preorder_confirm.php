...
foreach($all_show_option_id as $t_item_id){
  if(isset($all_show_option[$t_item_id]['option_info'])&&
    ...
    echo '&nbsp;<i> -'.$all_attr_info['title'].':'.str_replace(array("<br>", "<BR>"), '', htmlspecialchars($all_attr_info['value']));
    ...
    echo '&nbsp;<i> -'.$all_show_option[$t_item_id]['front_title'].':'.str_replace(array("<br>", "<BR>"), '', htmlspecialchars($all_show_option[$t_item_id]['of_value'])); 
    }
