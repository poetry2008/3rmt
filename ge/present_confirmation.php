                      ...
                      <tr> 
                        <td><table border="0" width="100%" height="100%" cellspacing="0" cellpadding="2" class="box_des"> 
                            ...
                            <tr> 
                              ...
                              <td class="main"><?php echo tep_draw_input_field('email_address', $email_address); ?> <?php if(!tep_validate_email($email_address)){ echo TEXT_EMAIL_ADDRESS;} if(!$email_address) {?><font color="red"><?php echo TEXT_PRESENT_CON_MUST;?></font><?php }?></td> 
                            </tr> 
                            <tr> 
                              <td class="main"><?php echo TEXT_PRESENT_CON_MAIL;?></td> 
