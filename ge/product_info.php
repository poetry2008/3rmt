...
document.write('<?php echo '<a href="'.DIR_WS_IMAGES . 'products/' . $product_info['products_image'].'" rel="lightbox[products]">' . tep_image2(DIR_WS_IMAGES . 'products/'. $product_info['products_image'], addslashes($product_info['products_name']), PRODUCT_INFO_IMAGE_WIDTH, PRODUCT_INFO_IMAGE_HEIGHT, 'name="lrgproduct" id="lrgproduct"') . '<br>' . TEXT_CLICK_TO_ENLARGE . '<\'+\'/a>'; ?>');
                  ...
                  <noscript>
                  <?php echo '<a href="' . tep_href_link(DIR_WS_IMAGES .  urlencode($product_info['products_image'])) . '">' . tep_image2(DIR_WS_IMAGES . $product_info['products_image'], $product_info['products_name'], PRODUCT_INFO_IMAGE_WIDTH, PRODUCT_INFO_IMAGE_HEIGHT, 'hspace="5" vspace="5"') . '<br>' . TEXT_CLICK_TO_ENLARGE . '</a>'; ?>
                  </noscript>
                </td>
              </tr>
              <tr>
      ...
      ?>
         <table class="box_des_size" width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <td width="90"><?php echo TEXT_PRODUCTS_QTY;?></td>
              ...
              <td align="left"><?php echo TEXT_UNIT;?></td>
              </tr></table>
            </td>
...
?>
      <h1><?php echo TEXT_ADVERTISING_TAG; ?>
      </h1>
        <p class="box_des"><b><?php echo TEXT_ADVERTISING_NO_REGISTER;?></b><br>
        <?php echo TEXT_BOX_DES;?>
        </p>
...
<p align="center" class="box_des"><?php echo TEXT_ACTUALLY_DISPLAYED_IMAGE;?><br>
