...
if($q_id == "" || $q_id == "index") {
	...
	$faq_meta_d = 'リネージュ2 RMTのよくある質問一覧ページです。リネ2のアデナ販売・アデナ買取について';
	$faq_meta_k = 'リネージュ2,リネ2,Lineage2,質問,一覧,RMT,FAQ,アデナ,販売,買取';
	...
	$faq_meta_k = 'リネージュ2,リネ2,Lineage2,質問,回答,RMT,FAQ,アデナ,販売,買取';
