...
if($q_id == "" || $q_id == "index") {
	...
	$faq_meta_d = 'マビノギ RMTのよくある質問一覧ページです。Mabinogiのゴールド販売・Gold買取について';
	$faq_meta_k = 'マビノギ,Mabinogi,ゴールド,質問,一覧,RMT,FAQ,Gold,販売,買取';
	...
	$faq_meta_k = 'マビノギ,Mabinogi,ゴールド,質問,回答,RMT,FAQ,Gold,販売,買取';
