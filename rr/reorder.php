...
<table class="information_table" summary="table">
 ...
 <td bgcolor="#333333"><?php echo TEXT_REORDER_TRADE_NO_CHANGE;?></td>
  <td bgcolor="#333333" id='old_time'><?php echo tep_date_long(strtotime($order['torihiki_date']))?> <?php echo date('H:i', strtotime($order['torihiki_date']));?>～<?php echo date('H:i', strtotime($order['torihiki_date_end']));?></td>
 </tr>
<?php
//根据订单中的商品来生成取引时间
...
<table class="information_table" id='product_<?php echo $value['id'];?>' summary="table">
 <tr>
 <td width="30%" bgcolor="#333333"><?php echo TEXT_REORDER_P_PRODUCT_NAME;?></td>
  <td bgcolor="#333333" name='products_names'><?php echo $value['name'];?></td>
 </tr>
<?php if($value['character']) {?>
 <tr>
 <td bgcolor="#333333"><?php echo TEXT_REORDER_P_PRODUCT_CHARACTER;?></td>
...
<?php if(isset($value['attributes']) && $value['attributes'])foreach ($value['attributes'] as $att) {?>
 <tr>
  <td bgcolor="#333333"><?php echo $att['option'].TEXT_REORDER_NO_CHANGE;?></td>
  ...
  // ccdd
        ...
        if (false) {
          ...
          while ($products_options_name = tep_db_fetch_array($products_options_name_query)) {
            ...
            echo '<tr><td bgcolor="#333333">' . $products_options_name['products_options_name'] . TEXT_REORDER_CHANGE .'</td><td bgcolor="#333333">' . "\n";
            // ccdd
...
<?php }?>
  ...
  for(i in productName){
    text += "<table class='information_table' summary='table'>\n";
    text += "<tr><td width='130' bgcolor='#333333'><?php echo TEXT_REORDER_P_PRODUCT_NAME;?></td><td>\n";
    text += productName[i] + "\n";
    text += "</td></tr>";
