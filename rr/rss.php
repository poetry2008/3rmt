...
if ($_GET['cPath'] != "") {
  $sql = "SELECT p.products_id, products_model, products_price, products_tax_class_id FROM products p, products_to_categories pc WHERE p.products_id = pc.products_id AND pc.categories_id = '" . $_GET['cPath'] . "' ORDER BY p.products_id DESC";
} else {
  ...
  $sql = "SELECT p.products_id, products_model, products_price, products_tax_class_id FROM products p, products_to_categories pc WHERE p.products_id = pc.products_id AND pc.categories_id IN (".implode(',', $ca_list_array).") ORDER BY p.products_id DESC";
}
