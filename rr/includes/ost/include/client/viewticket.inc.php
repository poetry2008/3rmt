    ...
    <div id="reply">
        <form action="view.php?id=<?=$id?>#reply" name="reply" method="post" enctype="multipart/form-data">
            ...
            <div align="left" style="font-size:12px;">
                ...
                <div style="padding:5px;margin-top:5px;color:#BC3436;font-size:12px;">許可されているファイル形式は、拡張子が<?php echo $allow_file_show;?>のいずれかとなるものです。<br>ファイル名に「.(ドット)」を2つ以上含むファイルは添付できません。</div>
