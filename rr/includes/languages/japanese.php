...
define('ENTRY_STREET_ADDRESS_TEXT', '&nbsp;<small>(例. 1-15-6) <font color="red">必須</font></small>');
...
define('ENTRY_POST_CODE_TEXT', '&nbsp;<small>(例. 331-0814) <font color="red">必須</font></small>');
define('ENTRY_CITY', '市区町村:');
define('ENTRY_CITY_ERROR', '&nbsp;<small><font color="#FF0000">少なくても ' . ENTRY_CITY_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_CITY_TEXT', '&nbsp;<small>(例. さいたま市) <font color="red">必須</font></small>');
...
define('ENTRY_TELEPHONE_NUMBER_TEXT', '&nbsp;<small>(例. 012-345-6789) <font color="red">必須</font></small>');
...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;<small>(例. abcd1234) <font color="#FC0000">必須</font></small>');
define('ENTRY_PASSWORD_ERROR', '<small><font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;<small>(例. abcd1234) <font color="#FC0000">必須</font></small>');
...
define('TEXT_HEADER_PRODUCT_TITLE', '総合サイト '.STORE_NAME.'お気に入りに追加して下さい！');
