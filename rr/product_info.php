...
<?php 
    ...
    <?php if (tep_show_warning(tep_get_products_categories_id($product_info['products_id'])) or $product_info['products_status'] != '1') {
      echo '<div class="waring_product">'.WARN_PRODUCT_STATUS_TEXT.'</div>'; 
         ...
         <table width="708" border="0" cellpadding="0" cellspacing="0" summary="rmt">
          <tr>
                            <td valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" summary="info_box">
                    <tr>
                      <td>
                      <table summary="info_box_contents" cellpadding="3" cellspacing="1" border="0">
                          <tr>
                          <td class="main" width="100"><b><font color="#BC3436"><?php echo TEXT_PRODUCT_MODEL;?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#BC3436"><?php echo $product_info['products_attention_1_1'] ; ?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#BC3436"><?php echo $data1[0] ; ?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#BC3436"><?php echo $data2[0] ; ?></font></b></td>
                            <td class="main"><?php echo $data2[1] ; ?></td>
                          </tr>
                          <?php } ?>
                          <tr>
                          <td class="main"><b><font color="#BC3436"><?php echo TEXT_PRODUCT_MANUFACTURER_NAME;?></font></b></td>
                            <td class="main"><div class="product_name"><?php include(DIR_WS_BOXES.'manufacturer_info.php') ; ?></div></td>
                          </tr>
                          <tr>
                          <td class="main"><b><font color="#BC3436"><?php echo TEXT_PRODUCT_PRICE;?></font></b></td>
                            <td class="main">
                                <?php
                                  # 添加开始 ---------------------------------------
                                  # -- 订单数量和单价列表 --------------------------
                          ...
                          <tr>
                          <td class="main"><b><font color="#BC3436"><?php echo TEXT_ORDERS_NUM;?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#BC3436"><?php echo $data3[0] ; ?></font></b></td>
                      ...
                      ?>
                          ...
                          <tr>
                          <td class="main"><b><font color="#BC3436"><?php echo TEXT_POINT;?></font></b></td>
...
");
                        ...
                        ?>
                        <tr> 
                        <td class="main"><b><font color="#BC3436"><?php echo TEXT_TAG;?></font></b></td> 
                          <td class="main">
