        ...
        <tr>
          <td><table border="0" width="100%" cellspacing="0" cellpadding="2" summary="table">
            <tr>
              ...
              <td align="center" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL') . '">' . tep_image_button('button_edit_account_news.gif', IMAGE_BUTTON_EDIT_ACCOUNT) . '</a>'; ?></td>
            </tr>
          </table></td>
        </tr>
      </table>
