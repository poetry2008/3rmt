...
if ($global['global_product_notifications'] != '1') {
    ...
    $info_notify = TEXT_SEE_ORDERS . '<br><br>' . TEXT_CONTACT_STORE_OWNER;
        ...
        echo str_replace('${PRODUCTS_INFO}','',str_replace('${PRODUCTS_SUBSCRIPTION}','<br><br>'.$info_notify,str_replace('${PROCEDURE}',TEXT_HEADER_INFO,str_replace('${NEXT}','<a href="' .tep_href_link(FILENAME_DEFAULT).  '">' .  tep_image_button('button_continue02.gif', IMAGE_BUTTON_CONTINUE) .  '</a>',$info_page['text_information']))));
?> 
      </form>
      </td> 
      <!-- body_text_eof --> 
