  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
      ...
      <td valign="top" id="contents"> 
          ...
          <div class="comment">
          <table  class="product_info_box">
          <tr><td>
          <table border="0" cellspacing="0" cellpadding="0" border="0" width="100%" align="center">
            <tr>
              <td width="20%">
...
<table border="0" cellpadding="2" cellspacing="2" style=" position:absolute; width:498px; *width:508px;">
<tr id="shipping_list_min" style="display:none;">
          ...
          if ($is_member_single && MODULE_ORDER_TOTAL_POINT_STATUS == 'true' && ($preorder_total > 0)) { 
            ?>
          <?php echo TEXT_PREORDER_POINT_TEXT;?>
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formArea">
            <tr>
              <td class="main" valign="top">
              <input type="text" name="preorder_point" size="24" value="<?php echo isset($_POST['preorder_campaign_info'])?$_POST['preorder_campaign_info']:(isset($_POST['preorder_point'])?$_POST['preorder_point']:(isset($_SESSION['preorder_information']['preorder_point'])?$_SESSION['preorder_information']['preorder_point']:'0'));?>" style="text-align:right; float:left;">
              <?php if (isset($point_error)) { echo '<div style="float:left;margin:2px 0 0 0"><font color="#ff0000">&nbsp;&nbsp;&nbsp;&nbsp;'.$point_error.'</font></div>'; } ?>
              <div style=" float:right; width:150px;  line-height:20px;"><?php echo $preorder_point;?> 
              <?php 
