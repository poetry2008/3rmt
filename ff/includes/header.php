...
{window.sidebar.addPanel(document.title, location.href, null)}">RMT総合サイト '.STORE_NAME.'お気に入りに追加して下さい！</a>' . "\n";
  }  
?>
  </div>
