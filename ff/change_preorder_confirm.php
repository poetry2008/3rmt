  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border"> 
    <tr> 
      ...
      <td valign="top" id="contents"> 
          ...
          <div class="comment">
          <table  class="product_info_box" width="100%">
          <tr><td>
          <table border="0" cellspacing="0" cellpadding="0" border="0" width="90%" align="center">
            ...
            <tr>
              <td align="left" width="20%" class="preorderBarFrom"><?php echo '<a href="'.tep_href_link('change_preorder.php', 'pid='.$preorder_res['check_preorder_str'], 'SSL').'" class="preorderBarFrom">'.PREORDER_TRADER_LINE_TITLE.'</a>';?></td> 
...
?>
          ...
          <tr> 
          <td  style="color: #000; font-size: 12px; padding: 10px 10px 10px 8px; background: url(images/design/box/dot.gif) bottom repeat-x;">
...
if (is_array($payment_modules->modules)) {
  ...
  if ($confirmation = $payment_modules->confirmation(payment::changeRomaji($preorder_res['payment_method'],PAYMENT_RETURN_TYPE_CODE))) {
    ?> 
      ...
      <tr> 
      <td class="main" style="color: #000; font-size: 12px; padding: 10px 10px 10px 8px; background: url(images/design/box/dot.gif) bottom repeat-x;">&nbsp;<b><?php echo HEADING_PAYMENT_INFORMATION; ?></b></td> 
      </tr> 
      <tr> 
      <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td> 
      </tr> 
