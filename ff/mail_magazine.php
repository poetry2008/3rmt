...
<div class="body_shadow" align="center"> 
  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border" summary="box"> 
    <tr> 
      ...
      <div class="comment">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" summary="table" class="product_info_box"> 
                <tr> 
                  <td><table width="100%"  border="0" cellspacing="2" cellpadding="2" summary="table"> 
                      <tr> 
