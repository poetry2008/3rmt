...
define('NAVBAR_TITLE_SECOND', 'お客様情報の編集');
define('HEADING_TITLE', 'お客様情報の編集');
define('BUTTON_SAVE','保存');
define('BUTTON_NEW','新規作成');
define('BUTTON_DEL','削除');
...
define('ERROR_FIRST_ITEM_TEXT_NUM_MAX','<small><font color="red">文字数は%sを超えてはいけません。</font></small>');
