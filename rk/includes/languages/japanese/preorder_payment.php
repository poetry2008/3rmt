...
define('PREORDER_EXPECT_CTITLE', 'ご予約についてのコメント');
...
define('TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'ご予約の手続きを進めてください。');
define('TEXT_CONTINUE_CHECKOUT_PROCEDURE', '「次へ進む」をクリックして予約内容の最終確認へ。');
