...
define('EMAIL_SUBJECT', '会員登録が完了いたしました【RMTワールドマネー】');
...
define('EMAIL_WELCOME', 'RMTワールドマネーへの会員登録が完了いたしました。' . "\n"
. '誠にありがとうございます。' . "\n\n");
define('EMAIL_TEXT',
'-----------------------------------------------------------------------' . "\n"
. '□　ご利用案内' . "\n"
...
. '□　会員様限定の特典' . "\n"
. '-----------------------------------------------------------------------' . "\n"
. 'RMTワールドマネーは、会員様に次のようなサービスをご提供いたします。' . "\n\n"
. '■お買い物に使えるポイントサービス' . "\n"
...
'ご不明な点がございましたら「RMTワールドマネー」までお問い合わせください。' . "\n\n\n\n");
