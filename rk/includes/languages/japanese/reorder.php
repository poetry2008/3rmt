...
define('TEXT_BACK_TO_HISTORY','前に戻る');
...
define('TEXT_REORDER_CHANGE_TRADE_SELECT','【取引日時（変更後）】を選択してください。');
...
define('TEXT_REORDER_TRADE_DATE','▼取引日時　　　　：');
...
define('TEXT_REORDER_TRADE_NO_CHANGE','取引日時（変更前）');
define('TEXT_REORDER_TRADE_CHANGE','取引日時（変更後）');
define('TEXT_REORDER_TRADE_TEXT','ご希望のお時間に添えない場合は、弊社より「取引時間」をご連絡させていただきます。');
define('TEXT_REORDER_P_PRODUCT_NAME','商品名');
define('TEXT_REORDER_P_PRODUCT_CHARACTER','キャラクター名');
...
define('TEXT_REORDER_CONFRIM_INFO','確定する');
