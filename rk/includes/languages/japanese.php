...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;英数字' .  ENTRY_PASSWORD_MIN_LENGTH . '文字以上&nbsp;(例. 01abcdef) <font color="#FC0000">必須</font>');
define('ENTRY_PASSWORD_ERROR', '&nbsp;<small><font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;英数字' . ENTRY_PASSWORD_MIN_LENGTH .  '文字以上&nbsp;(例. 01abcdef) <font color="#FC0000">必須</font>');
