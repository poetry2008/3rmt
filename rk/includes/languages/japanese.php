...
define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '&nbsp;(例. abcd1234) <font color="#FC0000">必須</font>');
define('ENTRY_PASSWORD_ERROR', '<small><font color="#FF0000">少なくても ' . ENTRY_PASSWORD_MIN_LENGTH . ' 文字</font></small>');
define('ENTRY_PASSWORD_TEXT', '&nbsp;(例. abcd1234) <font color="#FC0000">必須</font>');
...
define('TEXT_HEADER_CATEGORY_TITLE', 'RMT総合サイト カメズをお気に入りに追加して下さい！');
define('TEXT_HEADER_PRODUCT_TITLE', '総合サイト カメズをお気に入りに追加して下さい！');
