...
*/
  ...
  if (isset($_GET['products_id'])) {
    ...
    $orders_sql = "
        select * from (select pd.products_status, pd.site_id, o.date_purchased,p.products_id, pd.products_image from " .  TABLE_ORDERS_PRODUCTS . " opa, " . TABLE_ORDERS_PRODUCTS . " opb, " .  TABLE_ORDERS . " o, " . TABLE_PRODUCTS . " p, ".TABLE_PRODUCTS_DESCRIPTION." pd 
        ...
        order by pd.site_id DESC) c where site_id = '".SITE_ID."' or site_id = '0' group by products_id having c.products_status != '3' order by date_purchased desc limit " . MAX_DISPLAY_ALSO_PURCHASED
    ;
