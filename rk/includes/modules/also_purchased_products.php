...
*/
  ...
  if (isset($_GET['products_id'])) {
    ...
    $orders_sql = "
        select * from (select pd.products_status, pd.site_id, o.date_purchased,p.products_id from " .  TABLE_ORDERS_PRODUCTS . " opa, " . TABLE_ORDERS_PRODUCTS . " opb, " .  TABLE_ORDERS . " o, " . TABLE_PRODUCTS . " p, ".TABLE_PRODUCTS_DESCRIPTION." pd 
