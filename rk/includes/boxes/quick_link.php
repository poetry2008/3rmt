...
<div id='quick_link'>
            ...
            <?php if (isset($quick_category) && $quick_category && !$quick_category['categories_status']){?>
                <a href='<?php echo tep_href_link(FILENAME_DEFAULT, 'cPath=' . $quick_category['categories_id']);?>' title="<?php echo $quick_category['categories_name'];?>"><img src='/images/categories/<?php echo $quick_category['categories_image2'];?>' width="<?php echo CATEGORY_IMAGE_WIDTH;?>" height="<?php echo CATEGORY_IMAGE_HEIGHT;?>" alt="<?php echo $quick_category['categories_name'];?>" ></a>
            <?php } ?>
</div>
<?php }?>
<!-- quick_link_eof //-->
