...
<?php
  ...
  //if ($banner = tep_banner_exists('dynamic', 'left2')) { echo '<div class="link_banner">'.tep_display_banner('static', $banner).'</div>'."\n"; }
  //if ($banner = tep_banner_exists('dynamic', 'left3')) { echo '<div class="link_banner">'.tep_display_banner('static', $banner).'</div>'."\n"; }
