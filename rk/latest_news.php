  ...
  <table width="900" border="0" cellpadding="0" cellspacing="0" class="side_border">
    <tr>
      ...
      <td valign="top" id="contents">
        <h1 class="pageHeading"><img align="top" alt="" src="images/menu_ico.gif">&nbsp;<?php if ($_GET['news_id']) { echo replace_store_name($latest_news['headline']); } else { echo HEADING_TITLE; } ?></h1>
                <div class="comment">
