        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0" summary="table"> 
          <tr> 
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0" summary="table">
                  <tr>
                    <td width="33%"><table border="0" width="100%" cellspacing="0" cellpadding="0" summary="table">
                        <tr>
                  ...
                  <tr>
                    ...
                    <td class="main"><b><?php echo HEADING_RETURNING_CUSTOMER; ?></b>
                      <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBox" summary="table">
                        <tr>
                          <td><table style="border: solid 1px #ddd;" summary="table">
                              <tr>
                                <td class="main"><?php echo TEXT_RETURNING_CUSTOMER; ?></td>
                              </tr>
                              <tr>
                                <td class="main" style="padding-left: 15px;">
                                <b><?php echo ENTRY_EMAIL_ADDRESS; ?></b><br>
                <?php echo tep_draw_input_field('email_address', '', 'class="input_text"'); ?></td>
                              </tr>
                              <tr>
                                <td class="main" style="padding-left: 15px;"><b><?php echo ENTRY_PASSWORD; ?></b><br>
                <?php echo tep_draw_password_field('password', '', 'class="input_text"'); ?></td>
                              </tr>
                              <tr>
