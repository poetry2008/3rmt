                  ...
                  <tr> 
                     <td>
                      ...
                      <tr> 
                        ...
                        <tr> 
                          <td align="right"> 
                          <form method="post" action="<?php echo tep_href_link(FILENAME_MAGAZINE, 'action=stop', 'NONSSL'); ?>"><table width="100%" border="0" cellpadding="2" cellspacing="0" class="infoBoxContents" summary="table"> 
                                    <tr> 
