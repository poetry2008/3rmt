...
<?php
    ...
    ?>
                        <table width="100%" summary="rmt_text">
                          <tr>
                          <td class="main" valign="middle" width="58" style="padding:0 10px;"><?php echo TEXT_PRODUCTS_QTY;?></td>
                            <td colspan="2">
              ...
              <?php $p_a_quan = $product_info['products_quantity'];?>
                          ...
                          <tr>
                            <td class="main" width="58" style="padding-left:10px;">
...
<?php echo tep_draw_hidden_field('products_id', $product_info['products_id']) ; ?></form>
            ...
            <tr class="header2">
                      <td align="right" valign="bottom" class="smallText">
                          <div class="option_dot">
                        <a href="<?php echo tep_href_link(FILENAME_TELL_A_FRIEND,'products_id='.(int)$_GET['products_id']) ;  ?>"><?php echo tep_image(DIR_WS_IMAGES.'design/button/button_tellafriend.jpg',BOX_HEADING_TELL_A_FRIEND);?></a>&nbsp; <a href="<?php echo tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE,'products_id='.(int)$_GET['products_id']) ; ?>"><?php echo tep_image(DIR_WS_IMAGES.'design/button/button_review.jpg',BOX_REVIEWS_WRITE_REVIEW);?></a>&nbsp; <?php echo tep_draw_form('open',tep_href_link('open.php', '', 'SSL'),'get');?><input type="image" style="vertical-align:bottom;" alt="img" src="<?php echo DIR_WS_IMAGES;?>design/button/botton_question.jpg"><?php echo tep_draw_hidden_field('products', $product_info['products_name']) ; ?></form> </div></td>
                    </tr>
            </table>
            <?php
                    //サブ画像
