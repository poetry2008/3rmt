...
?>
    <?php if (tep_show_warning(tep_get_products_categories_id($product_info['products_id'])) or $product_info['products_status'] != '1') {
      echo '<div class="waring_product">'.WARN_PRODUCT_STATUS_TEXT.'</div>'; 
         ...
         <table width="684"  border="0" cellpadding="0" cellspacing="0" summary="rmt">
          <tr>
                ...
                <td valign="top">
                    ...
                    <tr>
                      ...
                      <table summary="info_box_contents" border="0" cellpadding="3" cellspacing="1" class="product_info_table">
                          <tr>
                          <td class="main" width="85"><b><font color="#336600"><?php echo TEXT_PRODUCT_MODEL;?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#336600"><?php echo $product_info['products_attention_1_1'] ; ?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#336600"><?php echo $data1[0] ; ?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#336600"><?php echo $data2[0] ; ?></font></b></td>
                            <td class="main"><?php echo $data2[1] ; ?></td>
                          </tr>
                          <?php } ?>
                          <tr>
                          <td class="main"><b><font color="#336600"><?php echo TEXT_PRODUCT_MANUFACTURER_NAME;?></font></b></td>
                          ...
                          <tr>
                          <td class="main"><b><font color="#336600"><?php echo TEXT_ORDERS_NUM;?></font></b></td>
                      ...
                      ?>
                          <tr>
                            <td class="main"><b><font color="#336600"><?php echo $data3[0] ; ?></font></b></td>
                      ...
                      ?>
                          ...
                          <tr>
                          <td class="main"><b><font color="#336600"><?php echo TEXT_POINT;?></font></b></td>
...
");
                        ...
                        ?>
                        <tr> 
                        <td class="main"><b><font color="#336600"><?php echo TEXT_TAG;?></font></b></td> 
                          <td class="main">
...
<?php
    ...
    ?>
                        <table width="100%" summary="rmt_text" cellspacing="1" cellpadding="3" border="0" class="product_info_table">
                          <tr>
