...
<td colspan="2" id="shiping_box">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr id="shipping_list" style="display:none;">
  <td class="main" width="30%" style="border-right:1px solid #eee;"><?php echo TEXT_EXPECT_TRADE_TIME; ?></td>
  <td class="main" id="shipping_list_show"></td>
  </tr>
</table>

<table border="0" cellpadding="0" cellspacing="0" style=" position:absolute; width:497px;">
