...
<tr id="shipping_list_min" style="display:none;">
          ...
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formArea">
            <tr>
              ...
              <?php if (isset($point_error)) { echo '&nbsp;&nbsp;<div style="float:left;margin:4px 0 0 0"><font color="#ff0000">&nbsp;&nbsp;&nbsp;&nbsp;'.$point_error.'</font></div>'; }?>
              <div style=" float:right; width:150px; line-height:25px;"><?php echo $preorder_point;?> 
              <?php 
