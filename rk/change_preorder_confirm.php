              ...
              <td class="main">
                <table width="100%"> 
                  ...
                  <tr>
                    ...
                    <td class="main" align="center" valign="top" width="120">
...
<?php
                    foreach($_POST as $ad_key=>$ad_value){
                      ...
                      if(substr($ad_key,0,3)=='ad_' && $_POST[substr($ad_key,3)] != ''){
                        ...
                        echo '<tr>';
                        echo '<td class="main" width="120">'. $_POST[substr($ad_key,3)] .':</td>';                  
                        echo '<td class="main">';
                        echo $_POST[$ad_key];
          ...
          <table width="100%" cellpadding="2" cellspacing="2" border="0" class="formArea">
            ...
            <tr>
              <td class="main">
                <table width="100%">  
                  <tr>
                    <td class="main" width="120"><?php echo PREORDER_CONFIRM_FETCH_TIME_DAY;?></td>                  
                    <td class="main">
                    <?php
                      if (!empty($_POST['date'])) {
