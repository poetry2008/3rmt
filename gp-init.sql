...
VALUES (
'9', 'gp', 'gp', 'http://3gp.maker.200.com', '0'
);
...
VALUES (
NULL , 'フッターコピーライト', 'C_FOOTER_COPY_RIGHT', '当ウェブサイトに記載されている会社名・製品名・システム名などは、各社の登録商標、もしくは商標です。', 'ホームページのフッターに表示されるコピーライトを入力してください。', '901', '11', '2010-12-03 15:34:57', '2010-12-03 15:34:57', '', 'tep_cfg_textarea(', '9'
);
