...
?></h1>
    <div class="comment_long"><font color="#FFffff"><?php echo str_replace('#STORE_NAME#', STORE_NAME, $seo_category['categories_header_text']); //seo phrase?></font>
       <?php
          $has_ca_single = false; 
        ?>
...
?></h2>
      ...
      if (isset($_GET['cPath'])) {
       ...
       echo '<p><font color="#ffffff">'.str_replace('#STORE_NAME#', STORE_NAME, $seo_category['categories_footer_text']).'</font></p></div>';
      if (isset($_GET['cPath'])) {
  ...
  <?php
      if (isset($cPath_array)) {
        if ($seo_category['seo_description']) {
          echo '<h2 class="pageHeading_long">'.str_replace('#STORE_NAME#', STORE_NAME, $seo_category['seo_name']).TEXT_ABOUT.'</h2>'; 
          echo '<div class="comment_long"><div class="product_list_info"><div class="product_listing_content"><p><font color="#888888">'.str_replace('#STORE_NAME#', STORE_NAME, $seo_category['seo_description']).'</font></p></div></div></div>'; 
        }
